...
'$Logfile: /AAMS/Components/bizMaster/bzEquipmentGroup.vb $
'$Workfile: bzEquipmentGroup.vb $
'$Revision: 1 $
'$Archive: /AAMS/Components/bizMaster/bzEquipmentGroup.vb $
'$Modtime: 25/03/08 10:27a $
Imports System.Xml
Imports System.Data.SqlClient
Imports AAMS.bizShared
Namespace bizMaster
    Public Class bzEquipmentGroup
        Implements bizInterface.BizLayerI
        Const strClass_NAME = "bzEquipmentGroup"
        Const srtLIST_OUTPUT = "<MS_LISTEQUIPMENTGROUP_OUTPUT><EQUIPMENTGROUP GROUP_CODE='' DESCRIPTION='' /><Errors Status=''><Error Code='' Description='' /></Errors></MS_LISTEQUIPMENTGROUP_OUTPUT>"
        Const srtVIEW_OUTPUT = ""
        Const strSEARCH_OUTPUT = ""
        Const StrADD_OUTPUT = ""
        Const strDELETE_OUTPUT = ""
        Const strUPDATE_OUTPUT = ""
        ...
        Public Function List() As System.Xml.XmlDocument
            ...
            'Input  : 
            'Output :  
            '<MS_LISTEQUIPMENTGROUP_OUTPUT><EQUIPMENTGROUP GROUP_CODE='' DESCRIPTION='' /><Errors Status=''><Error Code='' Description='' /></Errors></MS_LISTEQUIPMENTGROUP_OUTPUT>
            '************************************************************************
            ...
            Try
                With objSqlCommand
                    ...
                    .CommandText = "UP_LST_MS_EQUIPMENT_GROUP"
                ...
                objAptNode = objOutputXml.DocumentElement.SelectSingleNode("EQUIPMENTGROUP")
                objAptNodeClone = objAptNode.CloneNode(True)
                objOutputXml.DocumentElement.RemoveChild(objAptNode)
                Do While objSqlReader.Read
                    blnRecordFound = True
                    objAptNodeClone.Attributes("GROUP_CODE").InnerText = Trim(objSqlReader.GetValue(objSqlReader.GetOrdinal("GROUP_CODE")) & "")
