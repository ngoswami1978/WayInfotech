<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MSUP_Style.aspx.vb" Inherits="Setup_MSUP_Style" %>
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">Setup-></span><span class="sub_menu">Item Master</span>
                            </td>
                        </tr>
                        <tr>
                        <tr>
                            <td class="heading" align="center" valign="top" style="height: 10px">
                                Manage Item Master&nbsp;</td>
                        </tr>
                        <tr>
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 2px; width: 312px;">
                                                                    <span class="textbold"><span style="font-size: 9pt; color: #000000; font-family: Tahoma">
                                                                        <asp:TextBox ID="txtBarCode" runat="server" CssClass="textfield" MaxLength="200"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 2px" width="15%">
                                                                    StyleName<strong><span style="font-size: 8pt; color: #de2418; font-family: Verdana">*</span></strong></td>
