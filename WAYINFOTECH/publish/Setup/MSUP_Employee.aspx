<%@ page language="VB" autoeventwireup="false" inherits="Setup_MSUP_Employee, App_Web_msup_employee.aspx.4cd3357d" enableeventvalidation="false" %>
                                                        ...
                                                        <asp:Panel ID="pnlEmployee" runat="server" Width="100%">
                                                            <table width="100%" border="0" align="left" cellpadding="2" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Button ID="btnSave" runat="server" TabIndex="2" CssClass="button" Text="Save"
                                                                            AccessKey="S" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtMobileNumber" MaxLength="30" TabIndex="1" CssClass="textbox"
                                                                            runat="server" Width="269px"></asp:TextBox></td>
                                                                    <td class="textbold" style="width: 10px">
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <asp:Button ID="btnNew" runat="server" TabIndex="2" CssClass="button" Text="New"
                                                                            AccessKey="N" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtEmail" CssClass="textbox" MaxLength="100" TabIndex="1" runat="server" Width="269px"></asp:TextBox></td>
                                                                    <td class="textbold" style="width: 10px">
                                                                    </td>
                                                                    <td>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Button ID="btnReset" runat="server" TabIndex="2" CssClass="button" Text="Reset"
                                                                            AccessKey="R" /></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td style="height: 26px">
                                                                        <asp:TextBox ID="txtLogin" MaxLength="20" CssClass="textbox" TabIndex="1" runat="server" Width="269px"></asp:TextBox></td>
                                                                    <td class="textbold" style="height: 26px; width: 10px;">
                                                                    </td>
                                                                    <td style="height: 26px">
                                                                    </td>
                                                                    <td style="height: 26px">
                                                                        <asp:Button ID="btnHistory" runat="server" TabIndex="2" CssClass="button" Text="History"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtPassword" MaxLength="15" CssClass="textbox" TextMode="Password"
                                                                            TabIndex="1" runat="server" Width="269px"></asp:TextBox></td>
                                                                    <td class="textbold" style="width: 10px">
                                                                    </td>
                                                                    <td>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtRetypePassword" MaxLength="15" TabIndex="1" TextMode="Password"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:CheckBox ID="chkChangePass" runat="server" Checked="True" TabIndex="1"  Visible="false"/></td>
                                                                    <td class="textbold" style="width: 10px">
