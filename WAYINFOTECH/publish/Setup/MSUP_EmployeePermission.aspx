<%@ page language="VB" autoeventwireup="false" inherits="Setup_MSUP_EmployeePermission, App_Web_msup_employeepermission.aspx.4cd3357d" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>AAMS: User</title>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td valign="top" align="left">
                                            <span class="menu">Setup-></span><span class="sub_menu">User Permission</span></td>
                                    </tr>
                                    <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="textbold">
                                                                    <asp:RadioButton ID="rdCopyPermissionDesignation" runat="server" CssClass="textfield"
                                                                        GroupName="Copy" Checked="true" Text="Copy Permission from Designation" Width="216px" Visible="False" /></td>
                                                                <td>
                                                                    <asp:DropDownList onkeyup="gotop(this.id)" ID="drpDesignation" runat="server" Width="137px"
                                                                        CssClass="dropdown" Visible="False">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 35%;">
                                                                    <asp:RadioButton ID="rdCopyPermissionEmployee" CssClass="textfield" runat="server"
                                                                        GroupName="Copy" Text="Copy Permission from User" Width="216px" /></td>
                                                                <td style="width: 25%;">
