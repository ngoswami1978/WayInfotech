    ...
    Protected Sub imgLogin_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgLogin.Click
        Try
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                'ClientScript.RegisterStartupScript(Me.GetType(), "Open1", "<script language='javascript'>window.open('Main.aspx',null,'toolbar=0,status=1,resizable=yes');window.location.href='login.aspx';</script>")
