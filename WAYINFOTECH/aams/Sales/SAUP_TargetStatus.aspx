<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SAUP_TargetStatus.aspx.vb" Inherits="Sales_SAUP_TargetStatus" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>AAMS::Sales::Manage Target Status</title>
...
<body>
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Sales-&gt;</span><span class="sub_menu">Manage Target Status</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage Target Status</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="textbold">
                                                                                Target Status<span class="Mandatory" >*</span></td>
    ...
    function ValidateForm()
    {
     ...
     if(document.getElementById('<%=txtStatus.ClientId%>').value =='')
        {
            document.getElementById('<%=lblError.ClientId%>').innerText='Target status is mandatory.'
