<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SAUP_RetentionStatus.aspx.vb" Inherits="Sales_SAUP_RetentionStatus" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>AAMS::Sales::Manage Retention Status</title>
...
<body>
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Sales-&gt;</span><span class="sub_menu">Manage Retention Status</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage Retention Status</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="textbold">
                                                                                Retention Status<span class="Mandatory" >*</span></td>
    ...
    function ValidateForm()
    {
     ...
     if(document.getElementById('<%=txtStatus.ClientId%>').value =='')
        {
            document.getElementById('<%=lblError.ClientId%>').innerText='Retention status is mandatory.'
