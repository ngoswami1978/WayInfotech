...
Partial Class Sales_SASR_RetentionReason
...
#Region "btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click"
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Response.Redirect("../Sales/SAUP_RetentionReason.aspx?Action=I")
    End Sub
#End Region
...
#Region "BindData()"
    Private Sub BindData(ByVal Operation As Integer)
        ...
        Try
            objInputXml.LoadXml("<SL_SEARCH_STRATEGIC_VISIT_RETENTION_REASON_INPUT><SVR_REASON_NAME /><PAGE_NO></PAGE_NO><PAGE_SIZE></PAGE_SIZE><SORT_BY></SORT_BY><DESC></DESC></SL_SEARCH_STRATEGIC_VISIT_RETENTION_REASON_INPUT>")
            objInputXml.DocumentElement.SelectSingleNode("SVR_REASON_NAME").InnerText = txtSrvCallStatus.Text.Trim()
            ...
            If Operation = PageOperation.Search Then
                ...
                If ViewState("SortName") Is Nothing Then
                    ViewState("SortName") = "SVR_REASON_NAME"
                    objInputXml.DocumentElement.SelectSingleNode("SORT_BY").InnerText = "SVR_REASON_NAME"
                Else
...
#Region "DeleteRecords()"
    Private Sub DeleteRecords()
        ...
        Dim objCallStatus As New AAMS.bizSales.bzStrategicVisitRetentionReason
        Try
            objInputXml.LoadXml("<SL_DELETE_STRATEGIC_VISIT_RETENTION_REASON_INPUT><SVR_STATUSID /></SL_DELETE_STRATEGIC_VISIT_RETENTION_REASON_INPUT>")
...
#End Region
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Response.Redirect("SASR_RetentionReason.aspx")
    End Sub
...
#End Region
    ...
    Sub Export(ByVal objOutputXml As XmlDocument)
        ...
        Dim strArray() As String = {"Retention Reason"}
        Dim intArray() As Integer = {1}
        objExport.ExportDetails(objOutputXml, "STRATEGIC_VISIT_RETENTION", intArray, strArray, ExportExcel.ExportFormat.Excel, "RetentionReason.xls")
    End Sub
