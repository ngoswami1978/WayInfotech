...
Partial Class Sales_SASR_SRV_Call_Status
...
#Region "btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click"
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Response.Redirect("../Sales/SAUP_SRV_Call_Status.aspx?Action=I")
    End Sub
#End Region
...
#Region "BindData()"
    Private Sub BindData(ByVal Operation As Integer)
        ...
        Try
            objInputXml.LoadXml("<SL_SEARCH_SERVICE_CALL_STATUS_INPUT><SC_STATUS_NAME /><PAGE_NO></PAGE_NO><PAGE_SIZE></PAGE_SIZE><SORT_BY></SORT_BY><DESC></DESC></SL_SEARCH_SERVICE_CALL_STATUS_INPUT>")
            objInputXml.DocumentElement.SelectSingleNode("SC_STATUS_NAME").InnerText = txtStatus.Text.Trim()
            ...
            If Operation = PageOperation.Search Then
                ...
                If ViewState("SortName") Is Nothing Then
                    ViewState("SortName") = "SC_STATUS_NAME"
                    objInputXml.DocumentElement.SelectSingleNode("SORT_BY").InnerText = "SC_STATUS_NAME"
                Else
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                If ds.Tables("SERVICE_CALL_STATUS").Rows.Count <> 0 Then
                    gvServiceCallStatus.DataSource = ds.Tables("SERVICE_CALL_STATUS")
                    ...
                    Else
                        lnkPrev.Visible = True
                    End If
                    hdRecordOnCurrentPage.Value = ds.Tables("SERVICE_CALL_STATUS").Rows.Count.ToString
...
#Region "DeleteRecords()"
    Private Sub DeleteRecords()
        ...
        Dim objCallStatus As New AAMS.bizSales.bzServiceCallStatus
        Try
            objInputXml.LoadXml("<SL_DELETED_SERVICE_CALL_STATUS_INPUT><SC_STATUSID /></SL_DELETED_SERVICE_CALL_STATUS_INPUT>")
...
#End Region
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Response.Redirect("SASR_SRV_Call_Status.aspx")
    End Sub
...
#End Region
    ...
    Sub Export(ByVal objOutputXml As XmlDocument)
        ...
        Dim strArray() As String = {"Service Call Status", "Close"}
        Dim intArray() As Integer = {1, 2}
        objExport.ExportDetails(objOutputXml, "SERVICE_CALL_STATUS", intArray, strArray, ExportExcel.ExportFormat.Excel, "ServiceCallStatus.xls")
    End Sub
