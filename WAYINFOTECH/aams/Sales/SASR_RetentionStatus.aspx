<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SASR_RetentionStatus.aspx.vb" Inherits="Sales_SASR_RetentionStatus" %>
...
<link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <title>AAMS::Sales::Search Retention Status</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(StatusID)
			{
				 window.location.href="SAUP_RetentionStatus.aspx?Action=U&SVR_STATUSID=" +StatusID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Sales-&gt;</span><span class="sub_menu">Search Retention Status</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Search Retention Status</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                        ...
                                        <tr>
                                            ...
                                            <td class="textbold" colspan="3" >
                                                                                ...
                                                                                <Columns>
                                                                                   <asp:BoundField DataField="SVR_STATUS_NAME" HeaderText="Retention Status" SortExpression="SVR_STATUS_NAME" />
                                                                                   <asp:BoundField DataField="SVR_STATUS_CLOSE" HeaderText="Close" SortExpression="SVR_STATUS_CLOSE" />                                                                                                                                                                                                             
                                                            ...
                                                            <asp:LinkButton ID="lnkEdit" runat="server" CommandName ="EditX" Text ="Edit" CssClass ="LinkButtons"></asp:LinkButton>&nbsp;
                                                               <asp:LinkButton ID="lnkDelete" runat="server" CommandName ="DeleteX" Text ="Delete" CssClass ="LinkButtons"></asp:LinkButton> 
                                                                ...
                                                                <asp:HiddenField ID="hdStatusID" runat="server" Value='<%#Eval("SVR_STATUSID")%>' />   
                                                             </ItemTemplate>
                                                           </asp:TemplateField>
     ...
     if(document.getElementById('<%=txtStatus.ClientId%>').value !='')
        {
            ...
            {
                document.getElementById('<%=lblError.ClientId%>').innerText ='Retention status should contain only alphabets.'
                return false;
