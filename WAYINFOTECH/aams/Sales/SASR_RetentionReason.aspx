<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SASR_RetentionReason.aspx.vb" Inherits="Sales_SASR_RetentionReason" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <title>AAMS::Sales::Search Retention Reason</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(StatusID)
			{
				 window.location.href="SAUP_RetentionReason.aspx?Action=U&SVR_REASONID=" +StatusID
				 return false;
			}
...
<body>
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Sales-&gt;</span><span class="sub_menu">Search Retention Reason</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Search Retention Reason</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                        <tr>
                                            ...
                                            <td>
                                                                    ...
                                                                    <asp:TextBox ID="txtSrvCallStatus" runat="server" CssClass="textbox" Width="208px" MaxLength="1000" TabIndex="1"></asp:TextBox>
                                                                    </td>
                                                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="textbold" colspan="3" >
                                                                                ...
                                                                                <Columns>
                                                                                   <asp:BoundField DataField="SVR_REASON_NAME" HeaderText="Retention Reason" SortExpression="SVR_REASON_NAME" />
                                                            ...
                                                            <asp:LinkButton ID="lnkEdit" runat="server" CommandName ="EditX" Text ="Edit" CssClass ="LinkButtons"></asp:LinkButton>&nbsp;
                                                               <asp:LinkButton ID="lnkDelete" runat="server" CommandName ="DeleteX" Text ="Delete" CssClass ="LinkButtons"></asp:LinkButton> 
                                                                ...
                                                                <asp:HiddenField ID="hdStatusID" runat="server" Value='<%#Eval("SVR_REASONID")%>' />   
                                                             </ItemTemplate>
                                                           </asp:TemplateField>
 ...
 <script language="javascript" type="text/javascript">
    function ValidateForm()
    {
     ...
     if(document.getElementById('<%=txtSrvCallStatus.ClientId%>').value !='')
        {
            var strValue = document.getElementById('<%=txtSrvCallStatus.ClientId%>').value
            reg = new RegExp("^[a-zA-Z ]+$"); 

            if(reg.test(strValue) == false) 
            {
                document.getElementById('<%=lblError.ClientId%>').innerText ='Retention reason should contain only alphabets.'
                return false;
    ...
    {
        document.getElementById('<%=txtSrvCallStatus.ClientId%>').value=''
