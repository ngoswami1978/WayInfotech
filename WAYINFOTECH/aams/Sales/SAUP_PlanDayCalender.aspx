<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SAUP_PlanDayCalender.aspx.vb"
    EnableEventValidation="false" ValidateRequest="false" Inherits="Sales_SAUP_PlanDayCalender" %>
                                                        ...
                                                        <table border="0" cellpadding="2" cellspacing="1" class="left" width="100%">
                                                            ...
                                                            <tr>
                                                                <td colspan="7">
                                                                    ...
                                                                    <asp:HiddenField ID="HdUserDefinedVisitDays" runat="server" /><asp:HiddenField ID="hdchk_VisitTarget" runat="server" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <asp:UpdatePanel ID="UpdPnl" runat="server">
                                                                        <ContentTemplate>
                                                                            ...
                                                                            <asp:Calendar ID="ClnPlanDay" runat="server" SelectionMode="Day" TitleStyle-CssClass="Title"
                                                                                SelectorStyle-Font-Bold="True" Font-Size="12" ShowNextPrevMonth="false" DayHeaderStyle-Font-Underline="false"
