<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SASR_SRV_Call_Status.aspx.vb"
    Inherits="Sales_SASR_SRV_Call_Status" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <title>AAMS::Sales::Search Service Call Status</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    ...
    function Edit(StatusID)
			{
				 window.location.href="SAUP_SRV_Call_Status.aspx?Action=U&SC_STATUSID=" +StatusID
				 return false;
			}
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">Sales-&gt;</span><span class="sub_menu">Search Service Call Status</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Search Service Call Status</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                        ...
                                        <td class="redborder center">
                                            <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="textbold">
                                                        Service Call Status</td>
                                                    <td style="width: 308px">
                                                        <asp:TextBox ID="txtStatus" runat="server" CssClass="textbox" Width="208px" MaxLength="1000"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnNew" CssClass="button" runat="server" Text="New" TabIndex="4"
                                                            AccessKey="n" /></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="textbold" colspan="3">
                                                        <asp:GridView EnableViewState="False" ID="gvServiceCallStatus" runat="server" AutoGenerateColumns="False"
                                                            TabIndex="6" Width="80%" AllowSorting="True">
                                                            <Columns>
                                                                <asp:BoundField DataField="SC_STATUS_NAME" HeaderText="Service Call Status" SortExpression="SC_STATUS_NAME" />
                                                                <asp:BoundField DataField="SC_STATUS_CLOSE" HeaderText="Close" SortExpression="SC_STATUS_CLOSE" />
                                                                <asp:TemplateField HeaderText="Action">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:HiddenField ID="hdStatusID" runat="server" Value='<%#Eval("SC_STATUSID")%>' />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
     ...
     if(document.getElementById('<%=txtStatus.ClientId%>').value !='')
        {
            ...
            {
                document.getElementById('<%=lblError.ClientId%>').innerText ='Service call status should contain only alphabets.'
                return false;
