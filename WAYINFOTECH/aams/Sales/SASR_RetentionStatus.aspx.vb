...
Partial Class Sales_SASR_RetentionStatus
...
#Region "btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click"
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Response.Redirect("../Sales/SAUP_RetentionStatus.aspx?Action=I")
    End Sub
#End Region
...
#Region "BindData()"
    Private Sub BindData(ByVal Operation As Integer)
        ...
        Try
            objInputXml.LoadXml("<SL_SEARCH_STRATEGIC_VISIT_RETENTION_STATUS_INPUT><SVR_STATUS_NAME /><PAGE_NO></PAGE_NO><PAGE_SIZE></PAGE_SIZE><SORT_BY></SORT_BY><DESC></DESC></SL_SEARCH_STRATEGIC_VISIT_RETENTION_STATUS_INPUT>")
            objInputXml.DocumentElement.SelectSingleNode("SVR_STATUS_NAME").InnerText = txtStatus.Text.Trim()
            ...
            If Operation = PageOperation.Search Then
                ...
                If ViewState("SortName") Is Nothing Then
                    ViewState("SortName") = "SVR_STATUS_NAME"
                    objInputXml.DocumentElement.SelectSingleNode("SORT_BY").InnerText = "SVR_STATUS_NAME"
                Else
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                If ds.Tables("STRATEGIC_VISIT_RETENTION").Rows.Count <> 0 Then
                    gvServiceCallStatus.DataSource = ds.Tables("STRATEGIC_VISIT_RETENTION")
                    ...
                    Else
                        lnkPrev.Visible = True
                    End If
                    hdRecordOnCurrentPage.Value = ds.Tables("STRATEGIC_VISIT_RETENTION").Rows.Count.ToString
...
#Region "DeleteRecords()"
    Private Sub DeleteRecords()
        ...
        Dim objCallStatus As New AAMS.bizSales.bzStrategicVisitRetentionStatus
        Try
            objInputXml.LoadXml("<SL_DELETED_STRATEGIC_VISIT_RETENTION_STATUS_INPUT><SVR_STATUSID /></SL_DELETED_STRATEGIC_VISIT_RETENTION_STATUS_INPUT>")
...
#End Region
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Response.Redirect("SASR_RetentionStatus.aspx")
    End Sub
...
#End Region
    ...
    Sub Export(ByVal objOutputXml As XmlDocument)
        ...
        Dim strArray() As String = {"Retention Status", "Close"}
        Dim intArray() As Integer = {1, 2}
        objExport.ExportDetails(objOutputXml, "STRATEGIC_VISIT_RETENTION", intArray, strArray, ExportExcel.ExportFormat.Excel, "RetentionStatus.xls")
    End Sub
