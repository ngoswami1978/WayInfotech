<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SAUP_BusinessDepartment.aspx.vb" Inherits="Sales_SAUP_BusinessDepartment" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>AAMS::Sales::Manage Business Department</title>
...
<body>
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Sales-&gt;</span><span class="sub_menu">Manage Busniess Development
                                Department </span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage Buniness Development Department</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                            ...
                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 308px">
                                                                                &nbsp;<asp:TextBox ID="txtDepartment" runat="server" CssClass="textbox" MaxLength="1000" TabIndex="1" Width="208px"></asp:TextBox></td>
                                                                            <td>
    ...
    function ValidateForm()
    {
     ...
     if(document.getElementById('<%=txtDepartment.ClientId%>').value =='')
        {
            document.getElementById('<%=lblError.ClientId%>').innerText='Department Name is mandatory.'
