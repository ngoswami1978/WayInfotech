<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SAUP_SRV_Call_Status.aspx.vb" Inherits="Sales_SAUP_SRV_Call_Status" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>AAMS::Sales::Manage Service Call Status</title>
...
<body>
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Sales-&gt;</span><span class="sub_menu">Manage Service Call Status</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage Service Call Status</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="textbold">
                                                                                Service Call Status<span class="Mandatory" >*</span></td>
    ...
    function ValidateForm()
    {
     ...
     if(document.getElementById('<%=txtStatus.ClientId%>').value =='')
        {
            document.getElementById('<%=lblError.ClientId%>').innerText='Service call status is mandatory.'
