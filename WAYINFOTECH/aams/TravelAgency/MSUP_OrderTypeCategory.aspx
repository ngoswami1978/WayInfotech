...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript"> 
     function ChkMandatotyOrderTypeCat()
      {
        if (document.getElementById("txtOrderTypeCat").value=="")
        {          
...
<body>
    <form id="form1" runat="server" defaultfocus="txtOrderTypeCat" >
                                        ...
                                        <td align="LEFT" class="redborder">
                                            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="textbold" style="width: 123px; height: 22px;">
                                                    </td>
