<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TAUP_AgencyPriority.aspx.vb" Inherits="TravelAgency_TAUP_AgencyPriority" %>
   ...
   function AgencyPriorityMandatory()
    {
        if (document.getElementById("txtPriority").value=="")
         {          
            document.getElementById("lblError").innerHTML="IATA Status is mandatory.";
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="textbold"  colspan ="2">
                                                                    IATA Status Name<span class="Mandatory">*</span></td>
