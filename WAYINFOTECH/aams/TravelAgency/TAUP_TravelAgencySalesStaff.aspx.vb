'#####################################################################
'############   Page Name -- TravelAgency_TAUP_TravelAgencySalesStaff #
...
Imports System.Data
#End Region
Partial Class TravelAgency_TAUP_TravelAgencySalesStaff
        ...
        Try
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                If Request.QueryString("Action").ToString().Split("|").GetValue(0).ToString().ToUpper = "U" Or Request.QueryString("Action").ToString().Split("|").GetValue(0).ToString().ToUpper = "US" Or Request.QueryString("Action").ToString().Split("|").GetValue(0).ToString().ToUpper = "UP" Then
                    ...
                    param = "TAUP_TravelAgencySalesStaff.aspx?Action=UP&ID=" & objED.Encrypt(objOutputXml.DocumentElement.SelectSingleNode("AGENCYSTAFF").Attributes("AGENCYSTAFFID").Value)
                    If Not Request.QueryString("Source") Is Nothing Then
                        hdPageSource.Value = Request.QueryString("Source").ToString
...
#End Region
    ...
    Private Sub AgencyView()
        ...
        Try
            ...
            objInputXml.DocumentElement.SelectSingleNode("LOCATION_CODE").InnerText = Request.QueryString("Lcode")
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                With objOutputXml.DocumentElement.SelectSingleNode("Agency")
                    ...
                    hdAgencyNameId.Value = Request.QueryString("Lcode")
