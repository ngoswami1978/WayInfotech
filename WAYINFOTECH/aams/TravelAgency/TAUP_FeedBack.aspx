<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TAUP_FeedBack.aspx.vb" Inherits="TravelAgency_TAUP_FeedBack" %>
...
window.open(type,"aaFeedBack","height=600,width=900,top=30,left=20,scrollbars=1");
        ...
        {         
          ...
          {
          strStatus=Status;
          type = "../HelpDesk/HDUP_helpDeskFeedBack.aspx?Action=U&Popup=T&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + strStatus + "&FeedBackId=" + FeedbackID + "&AOFFICE="+ AOFFICE + "&QueryGroup=" +strStatus ;               
