<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MSUP_AgencyType.aspx.vb" Inherits="TravelAgency_MSUP_AgencyType" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language ="javascript" >      
     ...
     function AgencyTypeMandatory()
      {
        if(document.getElementById("txtAgencyType").value.trim()=="")
            {
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 192px; height: 22px" >
                                                                   <asp:TextBox ID="txtAgencyType" runat ="server" CssClass ="textbox" Width="208px" MaxLength="20"></asp:TextBox>
                                                                    </td>
