...
Partial Class TravelAgency_TASR_AgencyStaff
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                If Not Request.QueryString("Source") Is Nothing Then
                    ...
                    If Not Request.QueryString("CallerName") Is Nothing Then
                        Dim callerName As String = ""
                        callerName = Request.QueryString("CallerName").ToString

                        If callerName.Trim.Split("-").Length = 2 Then
                            If callerName.Trim.Split("-")(1).Trim.Length = 0 Then
                                txtStaffName.Text = callerName.Trim.Split("-")(0).Trim
                            End If
    ...
    Protected Sub grdStaff_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdStaff.RowDataBound
        Try
            ...
            Else
                ...
                lnkSelect.Attributes.Add("onclick", "return SelectFunction('" & lnkSelect.CommandArgument & "|" & LCode & "|" & strAgencyName & "|" & HdSigninId.Value & "','" + FName + "','" + MName + "','" + SurName + "');")
            End If
            'Code end
...
#End Region
    ...
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Try
            ...
            If Not Request.QueryString("CallerName") Is Nothing Then
                'Param = Param + "&CallerName=" + Request.QueryString("CallerName").ToString
            End If
