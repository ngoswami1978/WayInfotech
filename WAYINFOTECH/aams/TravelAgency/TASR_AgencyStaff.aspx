<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TASR_AgencyStaff.aspx.vb"
    Inherits="TravelAgency_TASR_AgencyStaff" %>
...
<script language="javascript" type="text/javascript">  
       ...
       function SelectFunction(str,Fname,MName,SurName)
        {  
        var pos=str.split('|'); 
       // alert(Fname);
       // alert(MName);
...
//window.opener.document.forms['form1']['txtDesignation'].value=pos[2];
...
window.close();
    ...
    {   
        ...
        window.location.href="TAUP_AgencyStaff1.aspx?Action=U&ID="+AGENCYSTAFFID;       
        return false;
    }          
...
<body>
    <form id="form1" runat="server" defaultbutton ="btnSearch" defaultfocus ="TxtSignInNum">
