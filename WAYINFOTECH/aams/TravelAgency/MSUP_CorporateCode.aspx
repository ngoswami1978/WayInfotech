     ...
     if(document.getElementById("txtCorporationCode").value=="")
         {
            ...
            document.getElementById("lblError").innerHTML="Corporate code Mandatory !";
            document.getElementById("txtCorporationCode").focus();
            return false;
                  } 
           if (document.getElementById("txtCorporationCode").value.trim().length<2)
        {
             document.getElementById("lblError").innerHTML="Please Enter valid Corporate Code."
             document.getElementById("txtCorporationCode").focus();
             return false;
        }  
       if(document.getElementById("txtCorporateQualifier").value=="")
         {
            document.getElementById("lblError").innerHTML="Corporate qualifier Mandatory !";
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Travel Agency-&gt;</span><span class="sub_menu">Corporate Code</span>&nbsp;</td>
                        </tr>
                        <tr>
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 192px; height: 22px" >
                                                                   <asp:TextBox ID="txtCorporationCode" runat ="server" CssClass ="textbox" Width="208px" MaxLength="2" TabIndex="1"></asp:TextBox>
                                                                    </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="textbold" style="width: 192px; height: 22px;"><asp:TextBox ID="txtCorporateQualifier" runat ="server" CssClass ="textbox" Width="208px" MaxLength="1" TabIndex="2"></asp:TextBox>
                                                                    </td>
                                                             ...
                                                             <tr>
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td class="textbold" style="width: 192px; height: 22px;"><asp:TextBox ID="txtCorporateDesc" runat ="server" CssClass ="textbox" Width="208px" MaxLength="50" TabIndex="3"></asp:TextBox>
                                                                    </td>
                                                                <td style="height: 22px">
                                                                </td>
                                                                <td style="height: 22px">
