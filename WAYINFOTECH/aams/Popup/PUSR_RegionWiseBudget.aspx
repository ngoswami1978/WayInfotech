<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_RegionWiseBudget.aspx.vb"
    Inherits="Popup_PUSR_RegionWiseBudget" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>RegionWiseBudget History</title>
    <base target="_self" />
...
<body>
    <form id="form1" runat="server">
        <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>
                    <%--<asp:GridView ID="grdHistory" runat="server" Width="100%" EnableViewState="false"
                        ...
                        BorderWidth="1" AllowSorting="True" HeaderStyle-ForeColor="white">--%>
                        ...
                        <Columns>
                            <%--<asp:TemplateColumn HeaderText="Country" ItemStyle-Wrap="false" HeaderStyle-Wrap="false"  >
                                <ItemTemplate>
                                    <%#Eval("COUNTRY")%>
                                </ItemTemplate>
                            ...
                            <%--<asp:TemplateColumn HeaderText="Year" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                                <ItemTemplate>
                                    <%#Eval("YEAR")%>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                          ...
                          <asp:TemplateField SortExpression="DATE"  HeaderStyle-HorizontalAlign="Left" HeaderText="DateTime" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                                <ItemTemplate>
                                    <%#Eval("DATE")%>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                           ...
                           <asp:TemplateField HeaderText="Target" SortExpression="CHANGED">
                                <ItemTemplate>
                                    <%#Eval("CHANGED")%>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                       ...
                       <AlternatingRowStyle CssClass="lightblue" />
                                                            ...
                                                            <RowStyle CssClass="textbold" />  </asp:GridView>
