<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_HelpDeskSearchConfigure.aspx.vb"
    Inherits="Popup_PUSR_HelpDeskSearchConfigure" %>
                    ...
                    <tr>
                        <td valign="top">
                            <table width="100%" align="left">
                                <tr>
                                    <td align="right">
                                        <a href="#" class="LinkButtons" onclick="window.opener.location.href ='../HelpDesk/HDRPT_HelpDeskDynamicReport.aspx?Reload=T';window.close();">
                                            Close</a>&nbsp;&nbsp;&nbsp;</td>
                                </tr>
                                <tr>
                                                                ...
                                                                <asp:GridView ID="gvHelpDeskSearchCofig" runat="server" BorderWidth="1" BorderColor="#d4d0c8"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Set Default Value" ItemStyle-HorizontalAlign="Left"
                                                                            HeaderStyle-HorizontalAlign="Left">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtAgencyName" runat="server" CssClass="textbox" Width="220px" MaxLength="30" Visible ="false" TabIndex ="1" ></asp:TextBox>
                                                                                <asp:TextBox ID="txtLTRNo" runat="server" CssClass="textbox" Width="220px" MaxLength="9" Visible ="false"  TabIndex ="1" ></asp:TextBox>
                                                                                <asp:TextBox ID="txtPTRNo"  TabIndex ="1" runat="server" CssClass="textbox" Width="220px"
                                                                                    MaxLength="9" Visible ="false" ></asp:TextBox>
                                                                                <asp:TextBox ID="txtOfficeID"  TabIndex ="1" runat="server" CssClass="textbox" Width="220px"
                                                                                    MaxLength="9" Visible ="false" ></asp:TextBox>
                                                                                <asp:DropDownList  ID="DlstCompVertical"  TabIndex ="1" onkeyup="gotop(this.id)" runat="server" Visible ="false"
                                                                                    CssClass="dropdownlist" Width="226px" AutoPostBack="false" ></asp:DropDownList> 
                                                                                <asp:TextBox ID="TextBox1" TabIndex ="1" runat="server" CssClass="textbox" Width="220px"
                                                                                    MaxLength="9" Visible ="false"></asp:TextBox>
                                                                                <asp:TextBox ID="txtLoggedBy" TabIndex ="1" runat="server" CssClass="textbox" Width="220px"
                                                                                    MaxLength="30" Visible ="false"></asp:TextBox>
                                                                                <asp:TextBox ID="txtCallerName"  TabIndex ="1" runat="server" CssClass="textbox" Width="220px"
                                                                                    MaxLength="30" Visible ="false"></asp:TextBox>
                                                                                <asp:TextBox ID="txtWorkOrderNo"  TabIndex ="1" runat="server" CssClass="textbox"
                                                                                    Width="220px" MaxLength="9" Visible ="false"></asp:TextBox>
                                                                                <asp:TextBox ID="txtAddresses"  TabIndex ="1" runat="server" CssClass="textbox" Width="220px"
                                                                                    MaxLength="100" Visible ="false"></asp:TextBox>
                                                                                <asp:TextBox ID="txtTit"  TabIndex ="1" runat="server" CssClass="textbox" Width="220px"
                                                                                    MaxLength="100" Visible ="false"></asp:TextBox>
                                                                                <asp:DropDownList  ID="ddlQueryGroup"  TabIndex ="1" onkeyup="gotop(this.id)" runat="server" Visible ="false"
                                                                                   OnSelectedIndexChanged ="ddlQueryGroup_SelectedIndexChanged"  CssClass="dropdownlist" Width="226px" AutoPostBack="True">
                                                                                ...
                                                                                <asp:DropDownList ID="ddlQuerySubGroup"  TabIndex ="1" onkeyup="gotop(this.id)" runat="server" Visible ="false" OnSelectedIndexChanged ="ddlQuerySubGroup_SelectedIndexChanged"
                                                                                    CssClass="dropdownlist" Width="226px" AutoPostBack="True">
                                                                                ...
                                                                                <asp:Panel ID="PnlOpenDateFrom" runat="server" Visible="false">
                                                                                    <asp:TextBox ID="txtQueryOpenedDateFrom" runat="server" CssClass="textbox" Width="188px"
                                                                                 ...
                                                                                 <asp:Panel ID="PnlOpenDateTo" runat="server" Visible="false">
                                                                                     <asp:TextBox ID="txtQueryOpenedDateTo" runat="server" CssClass="textbox" Width="188px" TabIndex="1"></asp:TextBox>
                                                                                 ...
                                                                                 <asp:Panel ID="PnlCloseDateFrom" runat="server" Visible="false">
                                                                                      <asp:TextBox ID="txtCloseDateFrom" runat="server" CssClass="textbox" Width="188px" TabIndex="1"></asp:TextBox>
                                                                                 ...
                                                                                 <asp:Panel ID="PnlCloseDateTo" runat="server" Visible="false">
                                                                                     <asp:TextBox ID="txtCloseDateTo" runat="server" CssClass="textbox" Width="188px" TabIndex="1"></asp:TextBox>
                                                                                <img tabIndex="1"  runat ="server"  id="imgCloseDateTo" alt="" src="../Images/calender.gif"  title="Date selector" style="cursor: pointer" />
                                                                                 ...
                                                                                 <asp:Panel ID="PnlDateAssigned" runat="server" Visible="false">
                                                                                  <asp:TextBox ID="txtDateAssigned" runat="server" CssClass="textbox" Width="188px" TabIndex="1"></asp:TextBox>
                                                                                ...
                                                                                <asp:TextBox ID="txtHD_IR_REF"  TabIndex ="1" runat="server" CssClass="textbox" Width="220px"
                                                                                    MaxLength="9" Visible ="false" ></asp:TextBox>
                                                                                    
                                                                               <asp:DropDownList ID="DlstAirLine"  TabIndex ="1" onkeyup="gotop(this.id)" runat="server" Visible ="false"                                                                                     CssClass="dropdownlist" Width="226px" >
