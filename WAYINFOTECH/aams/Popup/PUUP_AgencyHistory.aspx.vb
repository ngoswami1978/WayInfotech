...
#End Region
    ...
    Sub LoadAgencyHistroy()
        ...
        Try
            ...
            objInputXml.LoadXml("<MS_GETAGENCYHISTORY_INPUT><LOCATION_CODE></LOCATION_CODE><PAGE_NO/> <PAGE_SIZE/><SORT_BY/><DESC/></MS_GETAGENCYHISTORY_INPUT>")
            ...
            objOutputXml = objbzAgency.GetHistory(objInputXml)

            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                objXmlReader = New XmlNodeReader(objOutputXml)
                ds.ReadXml(objXmlReader)
                For RowNo = 0 To ds.Tables("AGENCYHISTORY").Rows.Count - 1
                    If (ds.Tables("AGENCYHISTORY").Rows(RowNo)("DateTime") IsNot Nothing) Then
                        ds.Tables("AGENCYHISTORY").Rows(RowNo)("DateTime") = objeAAMS.ConvertDateBlank(ds.Tables("AGENCYHISTORY").Rows(RowNo)("DateTime").ToString())
                    End If
                Next
                grdAgencyHistory.DataSource = ds.Tables("AGENCYHISTORY")
                ...
                SetImageForSorting(grdAgencyHistory)
                ' ###################################################################
...
#Region "Code for Paging And sorting."
    ...
    Protected Sub grdAgencyHistory_Sorted(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdAgencyHistory.Sorted
        Try
    ...
    Protected Sub grdAgencyHistory_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles grdAgencyHistory.Sorting
        Try
