...
Partial Class Popup_PUSR_OrderHistory
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            ' btn1.Attributes.Add("onclick", "return OrderID();")
            ...
            'strjscript &= "return window.returnValue;"
            'strjscript = strjscript & "</script" & ">"
            'Me.litAgencyGroup.Text = strjscript
            'Page.RegisterStartupScript("1", strjscript)
    ...
    Sub ViewHistoryDetails()
        ...
        Try
            ...
            Dim objbzAgencyGroup As New AAMS.bizTravelAgency.bzOrder
            'objInputXml.LoadXml("<MS_GETHISTORYORDER_INPUT><ORDERID /></MS_GETHISTORYORDER_INPUT>")
            objInputXml.LoadXml("<MS_GETHISTORYORDER_INPUT><ORDERID /><PAGE_NO/> <PAGE_SIZE/><SORT_BY/><DESC/></MS_GETHISTORYORDER_INPUT>")
            objInputXml.DocumentElement.SelectSingleNode("ORDERID").InnerText = Request.QueryString("OrderID").ToString() 'hdOrderId.Value ' Session("orderIDVal").ToString()
            ...
            objOutputXml = objbzAgencyGroup.GetHistory(objInputXml)
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                gvOrderHistory.DataSource = ds.Tables("HISTORYDETAIL").DefaultView
                ...
                SetImageForSorting(gvOrderHistory)
                ' ###################################################################
    ...
    Protected Sub gvOrderHistory_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvOrderHistory.RowCommand
        'Dim strjscript As String = "<script language=""javascript"">"
...
#Region "Code for Paging And sorting."
    ...
    Protected Sub gvOrderHistory_Sorted(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvOrderHistory.Sorted
        Try
    ...
    Protected Sub gvOrderHistory_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gvOrderHistory.Sorting
        Try
