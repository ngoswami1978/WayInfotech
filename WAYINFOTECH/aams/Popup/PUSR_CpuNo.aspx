<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_CpuNo.aspx.vb" Inherits="Popup_PUSR_CpuNo" %>
...
<head id="Head1" runat="server">
    ...
    if (id=="1")
    {
    if (window.opener.document.forms['form1']['hdAllowSaveForCpuNo']!=null)
     { 
        window.opener.document.forms['form1']['hdAllowSaveForCpuNo'].value="1";
        if (window.opener.document.forms['form1']["hdblnSNoOverride"].value == "0" || window.opener.document.forms['form1']["hdblnSNoOverride"].value == "")
        {
         document.getElementById("lblError").innerHTML="You don't have enough rights to Install H/W without a Valid Cpu No.";
       // window.opener.document.forms['form1']["hdfocustemp"].value="0";
        window.opener.document.forms['form1']["hdAllowSaveForCpuNo"].value="0";
    ...
    if (window.opener.document.forms['form1']['hdAllowSaveForCpuNo']!=null)
     { 
        window.opener.document.forms['form1']['hdAllowSaveForCpuNo'].value="";
        window.close();
         return false;
      }
       window.close();
