<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUUP_AgencyHistory.aspx.vb"
    Inherits="TravelAgency_MSUP_AgencyHistory" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Agency History</title>
        <base target="_self"/>
...
<body>
    <form id="form1" runat="server">
        <table style="width:100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>
                     <asp:GridView ID="grdAgencyHistory" runat="server" BorderWidth="1" BorderColor="#d4d0c8" AutoGenerateColumns="False" AllowSorting ="true" HeaderStyle-ForeColor ="white" 
                                                                        Width="100%">
                                                                           <Columns>
