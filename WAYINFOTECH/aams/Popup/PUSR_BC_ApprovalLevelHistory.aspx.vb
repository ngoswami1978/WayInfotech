'##############################################################
'############ Page Name -- Popup_PUSR_BC_ApprovalLevelHistory #
'############   Date 09-Seltember 2009  ########################
'############   Developed By Abhishek  ########################
'##############################################################
Partial Class Popup_PUSR_BC_ApprovalLevelHistory
...
#End Region
    ...
    Sub LoadBCApprovalLevelHistroy()
        ...
        Try
            ...
            objOutputXml = objbzBusinessCase.BusinessCaseLevelHistorySearch(objInputXml)
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                '    End If
                'Next
                grdBCApprovalLevelHistory.DataSource = ds.Tables("HIS")
                grdBCApprovalLevelHistory.DataBind()
                ' ##################################################################
                ...
                SetImageForSorting(grdBCApprovalLevelHistory)
                ' ###################################################################
            ...
            Else
                grdBCApprovalLevelHistory.DataSource = Nothing
                grdBCApprovalLevelHistory.DataBind()
...
#Region "Code for Paging And sorting."
    ...
    Protected Sub grdBCApprovalLevelHistory_Sorted(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdBCApprovalLevelHistory.Sorted
        Try
    ...
    Protected Sub grdBCApprovalLevelHistory_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles grdBCApprovalLevelHistory.Sorting
        Try
...
#End Region
    ...
    Protected Sub grdBCApprovalLevelHistory_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdBCApprovalLevelHistory.RowDataBound
        Try
