<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_ISPPoolHistory.aspx.vb" Inherits="Popup_PUSR_ISPPoolHistory" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>ISP:IP Pool History</title>
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" >
                                                            ...
                                                            <tr>
                                                                <td colspan="6" height="4" align="center">
                                                                    <asp:GridView ID="grdvIpPoolHistory" AllowSorting="true" HeaderStyle-ForeColor="White" runat="server" BorderWidth="1" BorderColor="#d4d0c8" AutoGenerateColumns="False"
                                                                        Width="95%" TabIndex="9">
                                                                        <Columns>
                                                                        <asp:BoundField DataField="OfficeID" SortExpression="OfficeID" HeaderText="OfficeID" HeaderStyle-HorizontalAlign="left" />
                                                                        <asp:BoundField DataField="AgencyName"  SortExpression="AgencyName" HeaderText="Agency Name"  HeaderStyle-HorizontalAlign="left"/>
                                                                        <asp:BoundField   DataField="AllocatedDate" SortExpression="AllocatedDate" HeaderText="Allocation Date" HeaderStyle-HorizontalAlign="left" />                                                                                                                                                      
                                                                        <asp:BoundField   DataField="User" SortExpression="User" HeaderText="User" HeaderStyle-HorizontalAlign="left" />                                                                                                                                                      
                                                                        </Columns>                                                                                                                                    
