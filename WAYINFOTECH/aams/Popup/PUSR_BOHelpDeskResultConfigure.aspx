<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_BOHelpDeskResultConfigure.aspx.vb" Inherits="Popup_PUSR_BOHelpDeskResultConfigure" %>
            ...
            <tr>
                <td valign="top">
                    <table width="100%" align="left">  
                      <tr>
                            <td align="right">
                                <a href="#" class="LinkButtons" onclick="window.opener.location.href ='../BackOfficeHelpDesk/BOHDRPT_HelpDeskDynamicReport.aspx?Reload=T';window.close();">Close</a>&nbsp;&nbsp;&nbsp;</td>
                        </tr>                
                        <tr>
