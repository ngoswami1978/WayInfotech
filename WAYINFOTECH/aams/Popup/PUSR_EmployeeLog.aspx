<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_EmployeeLog.aspx.vb"
    Inherits="Popup_PUSR_EmployeeLog" %>
                        ...
                        <table width="850" border="0" align="left" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td class="redborder" colspan="2" valign="top">
                                  <span class="subheading">Employee Details </span>
                                    ...
                                    <asp:GridView ID="grdEmployeeDetails" runat="server" BorderWidth="1" BorderColor="#d4d0c8"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="CHANGEDBY" HeaderText="Employee Name" HeaderStyle-HorizontalAlign="Left"
