<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_Agency.aspx.vb" Inherits="Popup_PUSR_Agency" %>
                                                ...
                                                <tr>
                                                    <td colspan="6">
                                                        <asp:Panel ID="pnlAdvanceSearch"   runat="server" Width="100%">
                                                            ...
                                                            <asp:Literal ID="litAgency" runat="server"></asp:Literal></asp:Panel>
                                                        ...
                                                        <asp:DataGrid ID="grdAgency" BorderWidth="1" BorderColor="#d4d0c8" runat="server"
                                                           ...
                                                           <Columns>
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Address1">
                                                                 ...
                                                                 <asp:TemplateColumn>
                                                                 <ItemTemplate>
                                                                <asp:HiddenField ID="hdFax" value= '<%#Eval("PHONE")%>' runat="server" /> <asp:HiddenField ID="hdPhone" value= '<%#Eval("FAX")%>' runat="server" /> 
                                                                 </ItemTemplate>    </asp:TemplateColumn>
                                                                   
                                                                      
                                                                <asp:TemplateColumn HeaderText="Action">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton  ID="lnkSelect" Runat="server" CssClass="LinkButtons" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "LOCATION_CODE") + "|" + DataBinder.Eval(Container.DataItem, "NAME")+ "|" + DataBinder.Eval(Container.DataItem, "ADDRESS") + "|" + DataBinder.Eval(Container.DataItem, "ADDRESS1")+ "|" + DataBinder.Eval(Container.DataItem, "CITY") + "|" + DataBinder.Eval(Container.DataItem, "COUNTRY")+ "|" + DataBinder.Eval(Container.DataItem, "PHONE") + "|" + DataBinder.Eval(Container.DataItem, "OfficeID")+ "|" + DataBinder.Eval(Container.DataItem, "FAX") %>'>Select</asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateColumn>
                                                            </Columns>
