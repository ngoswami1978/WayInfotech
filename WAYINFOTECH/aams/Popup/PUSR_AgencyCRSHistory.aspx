<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_AgencyCRSHistory.aspx.vb" Inherits="Popup_PUSR_AgencyCRSHistory" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>AAMS:Manage Agency CRS History</title>
      <base target="_self"/>
                    ...
                    <table width="100%" align="left">   
                        ...
                        <tr>
                            <td valign="top">
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" >
                                                            ...
                                                            <tr>
                                                                <td colspan="6"  align="center">
                                                                    <asp:GridView ID="gvAgencyCRSHistory" runat="server" BorderWidth="1" BorderColor="#d4d0c8" AutoGenerateColumns="False" AllowSorting ="true" HeaderStyle-ForeColor ="white"  
                                                                        Width="100%">
                                                                        <Columns>
                                                                           <asp:BoundField DataField ="EMPLOYEENAME" HeaderText ="Employee Name"  SortExpression ="EMPLOYEENAME" />
                                                                            <asp:BoundField DataField ="DATETIME" HeaderText ="Date Time"  SortExpression ="DATETIME" />
                                                                             <asp:BoundField DataField ="CHANGEDATA" HeaderText ="Changed Data"  SortExpression ="CHANGEDATA" />
                                                                             <%-- <asp:BoundField DataField ="" HeaderText ="Employee Name" />--%>
                                ...
                                <asp:HiddenField ID="hdLcode" runat="server" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
