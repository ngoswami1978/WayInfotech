<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_IspPLan.aspx.vb" Inherits="Popup_PUSR_IspPLan" %>
                                                                ...
                                                                <asp:Label ID="lblError" runat="server" CssClass="ErrorMsg"></asp:Label></td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="textbold">
                                                                                ISP Plan &nbsp;Name</td>
                                                                            <td>
                                                                    <asp:TextBox ID="txtISPName" runat="server" CssClass="textboxgrey" Width="208px" ReadOnly="True" TabIndex="1"></asp:TextBox>
                                                                    </td>
                                                                            <td>
