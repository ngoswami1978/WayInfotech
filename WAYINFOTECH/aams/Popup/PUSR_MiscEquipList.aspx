<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_MiscEquipList.aspx.vb" Inherits="Popup_PUSR_MiscEquipList" %>
...
<head runat="server">
    ...
    if (id=="1")
    {
    if (window.opener.document.forms['form1']['hdFlagMiscInstall']!=null)
     { 
        window.opener.document.forms['form1']['hdFlagMiscInstall'].value="1";
        if (window.opener.document.forms['form1']["hdOverRideSerialNo"].value == "0" || window.opener.document.forms['form1']["hdOverRideSerialNo"].value == "")
        {
    ...
    else
    {
        if (window.opener.document.forms['form1']['hdFlagMiscInstall']!=null)
     { 
        window.opener.document.forms['form1']['hdFlagMiscInstall'].value="0";
        window.close();
         return false;
      }
    }
    ...
    if (window.opener.document.forms['form1']['hdFlagMiscInstall']!=null)
     { 
        window.opener.document.forms['form1']['hdFlagMiscInstall'].value="";
        window.close();
         return false;
      }
       window.close();
