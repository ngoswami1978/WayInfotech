...
Partial Class ETHelpDesk_Technical_MSSR_Priority
...
#Region "btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click"
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Response.Redirect("../ECOMMTrackerHelpDesk/TCUP_Priority.aspx?Action=I")
    End Sub
#End Region
...
#Region "BindData()"
    Private Sub BindData(ByVal Operation As Integer)
        ...
        Try
            objInputXml.LoadXml("<HD_SEARCHSEVERITIES_INPUT><HD_SEVERITY_NAME /><HD_QUERY_GROUP_ID>2</HD_QUERY_GROUP_ID><PAGE_NO/> <PAGE_SIZE/><SORT_BY/><DESC/></HD_SEARCHSEVERITIES_INPUT>")
...
#End Region
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Response.Redirect("TCSR_Priority.aspx")
    End Sub
