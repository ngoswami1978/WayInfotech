...
Partial Class ETHelpDesk_HDSR_QuestionSet
    ...
    Private Sub QuestionSearch()
        ...
        '        Dim objbzQ As New AAMS.bizETrackerHelpDesk.bzFeedbackSet
        Dim objbzQ As New AAMS.bizETrackerHelpDesk.bzFeedbackSet
    ...
    Private Sub QuestionDelete(ByVal QID As String)
        Dim objInputXml, objOutputXml As New XmlDocument
        '        Dim objbzDq As New AAMS.bizETrackerHelpDesk.bzFeedbackSet
        Dim objbzDq As New AAMS.bizETrackerHelpDesk.bzFeedbackSet
