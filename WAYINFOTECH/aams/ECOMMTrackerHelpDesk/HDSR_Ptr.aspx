<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_Ptr.aspx.vb" Inherits="ETHelpDesk_HDSR_Ptr" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>HelpDesk: PTR</title>
...
<script type="text/javascript" src="../Calender/calendar-setup.js"></script>
 ...
 type = "../TravelAgency/TASR_Agency.aspx?Popup=T" ;
   ...
   {           
          window.location.href="HDUP_Ptr.aspx?Action=U|"+CheckBoxObj;               
          return false;
    }
...
//        {   
//        
//          window.location.href="HDSR_Ptr.aspx?Action=D|"+ PtrID;                   
//          return false;
//        }
//    }
        ...
        function DeleteFunction(PtrID)
        {
           ...
           if (confirm("Are you sure you want to delete?")==true)
           {
           document.getElementById("hdDeleteFlag").value=PtrID;
           return true;
           }
           else
           {
    ...
    //Method Written for Select Button
         ...
         function SelectFunction(PtrID)
        {   
            if (window.opener.document.forms['form1']['txtPTRNo']!=null)
            {
            window.opener.document.forms['form1']['txtPTRNo'].value=PtrID;
            }
            window.close();
       }
...
<body>
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">ETrackers HelpDesk-></span><span class="sub_menu">PTR</span>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3" style="height: 25px">
                                                        <asp:TextBox ID="txtAgencyName" CssClass="textbox" MaxLength="40" runat="server" Width="93%" onblur="ActDeAct()" TabIndex="1" ></asp:TextBox> 
                                                    ...
                                                    <td style="width: 176px; height: 25px;">
                                                        <asp:Button ID="btnSearch" CssClass="button" runat="server" Text="Search" TabIndex="23" AccessKey="a" /></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="20%" style="height: 25px" colspan="3">
                                                        <asp:TextBox ID="txtPtrTitle" runat="server" CssClass="textbox" MaxLength="40" Width="93%" TabIndex="2"></asp:TextBox>
                                                        </td>
                                                    
                                                    <td style="height: 25px; width: 176px;">
                                                          <asp:Button ID="btnReset" CssClass="button" runat="server" Text="Reset" TabIndex="24" AccessKey="r" />
                                                        </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%" style="height: 25px">
                                                        <asp:TextBox ID="txtPtrNo" runat="server" CssClass="textbox" MaxLength="18" Width="136px" TabIndex="2"></asp:TextBox></td>
                                                    <td width="18%" class="textbold" style="height: 25px">
                                                        &nbsp; &nbsp; &nbsp;
                                                        LTR No.</td>
                                                    <td width="20%" style="height: 25px">
                                                        <asp:TextBox ID="txtLtrNo" runat="server" CssClass="textbox" MaxLength="40" Width="136px" TabIndex="3"></asp:TextBox></td>
                                                    <td style="height: 25px; width: 176px;"><asp:Button ID="btnExport" CssClass="button" runat="server" Text="Export" TabIndex="23" AccessKey="e" /></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                                                                  ...
                                                                                                  <asp:DropDownList ID="drpPtrType" runat="server" CssClass="dropdownlist" Width="142px" TabIndex="4">
                                                                                                  </asp:DropDownList></td>
                                                    <td class="textbold">
                                                        &nbsp; &nbsp; &nbsp;
                                                        Status</td>
                                                    <td>
                                                        <asp:DropDownList ID="drpPtrStatus" runat="server" CssClass="dropdownlist" Width="142px" TabIndex="5">
                                                        </asp:DropDownList></td>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td style="height: 25px">
                                                        <asp:DropDownList ID="drpSeverity" runat="server" CssClass="dropdownlist" Width="144px" TabIndex="6">
                                                        </asp:DropDownList></td>
                                                    <td  class="textbold" style="height: 25px">
                                                        &nbsp; &nbsp; &nbsp;
                                                        Follow Up</td>
                                                    <td style="height: 25px"><asp:DropDownList ID="drpFollowup" runat="server" CssClass="dropdownlist" Width="142px" TabIndex="7">
                                                    </asp:DropDownList></td>
                                                    <td style="width: 176px; height: 25px;">
                                                    </td>
                                                </tr>
                                                       ...
                                                       <table style="width: 100%" cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="18%" class="textbold">
                                                                        Logged By</td>
                                                                    <td width="20%">
                                                                        <asp:TextBox ID="txtPendingWith" CssClass="textbox" MaxLength="40" runat="server" Width="138px" TabIndex="8"></asp:TextBox>
                                                        <img src="../Images/lookup.gif" alt=" " onclick="javascript:return PopupLoggedBy();" tabindex="9" />
                                                                        
                                                                       </td>
                                                                    <td width="18%">
                                                                        <span class="textbold">&nbsp; &nbsp; &nbsp; Assigned To</span></td>
                                                                    <td style="width: 170px"><asp:DropDownList ID="drpAssignedTo" runat="server" CssClass="dropdownlist" Width="142px" TabIndex="10">
                                                                    </asp:DropDownList></td>
                                                                    <td width="18%">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:DropDownList ID="drpPtrTypCat" runat="server" CssClass="dropdownlist" Width="144px" TabIndex="11">
                                                                                                  </asp:DropDownList></td>
                                                                    <td class="textbold">
                                                                        &nbsp; &nbsp; &nbsp;
                                                                        1A Office</td>
                                                                    <td style="width: 170px" >
                                                                                                  ...
                                                                                                  <asp:DropDownList ID="drp1aOffice" runat="server" CssClass="dropdownlist" Width="142px" TabIndex="12">
                                                                                                  </asp:DropDownList></td>
                                                                    <td >
                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td style="height: 25px" >
                                                                       ...
                                                                       <asp:TextBox ID="txtAssignedDt" runat="server" CssClass="textbox" MaxLength="40" Width="136px" TabIndex="13"></asp:TextBox> 
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="textbold">
                                                                        PTR Open Date From</td>
                                                                    <td>
                                                                       <asp:TextBox ID="txtOpenDtFrm" runat="server" CssClass="textbox" MaxLength="40" Width="136px" TabIndex="15"></asp:TextBox>
                                                                        <img id="imgApprovalFrom" alt="" src="../Images/calender.gif"  title="Date selector" style="cursor: pointer" tabindex="16" />
                                                                          <script type="text/javascript">
                                                                                                    Calendar.setup({
                                                                    ...
                                                                    <td class="textbold" >
                                                                        ...
                                                                        PTR &nbsp;Open Date To</td>
                                                                    <td style="width: 170px">
                                                                        <asp:TextBox ID="txtOpenDtTo" runat="server" CssClass="textbox" MaxLength="40" Width="136px" TabIndex="17"></asp:TextBox>
                                                                        <img id="imgApprovalTo" alt="" src="../Images/calender.gif"  title="Date selector" style="cursor: pointer" tabindex="18" />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="textbold" style="height: 25px">
                                                                        PTR Close Date From</td>
                                                                    <td style="height: 25px">
                                                                         <asp:TextBox ID="txtCloseDtFrm" runat="server" CssClass="textbox" MaxLength="40" Width="136px" TabIndex="19"></asp:TextBox>
                                                                        <img id="imgSentFrom" alt="" src="../Images/calender.gif" TabIndex="20" title="Date selector" style="cursor: pointer" />
                                                                         <script type="text/javascript">
                                                                                                    Calendar.setup({
                                                                    ...
                                                                    <td style="height: 25px; width: 170px;" >
                                                                        <asp:TextBox ID="txtCloseDtTo" runat="server" CssClass="textbox" MaxLength="40" Width="136px" TabIndex="21"></asp:TextBox>
     ...
     <tr>
            <td valign="top" style="padding-left:4px; height: 117px;" >
              <table  width="1500px" border="0" align="left" cellpadding="0" cellspacing="0"> 
                                                                            <tr>  
                                                                                    <td class="redborder">
                                                                                     <asp:GridView ID="grdvPtr" runat="server" AllowSorting="true" HeaderStyle-ForeColor="white" AutoGenerateColumns="False" HorizontalAlign="Center"
                                                            ...
                                                            AlternatingRowStyle-CssClass="lightblue" EnableViewState="False">
                                                              <Columns>
                                                       <asp:BoundField DataField="HD_RE_ID" HeaderText="LTR No." SortExpression="HD_RE_ID" ItemStyle-Wrap="false" />
                                                  <asp:BoundField DataField="HD_PTR_REF" HeaderText="PTR No." SortExpression="HD_PTR_REF" ItemStyle-Wrap="false"  />
                                                 ...
                                                 <asp:TemplateField HeaderText="Address" ItemStyle-Width="200px" SortExpression="ADDRESS" ItemStyle-Wrap="true" >
                                                 <ItemTemplate>
                                                 <asp:Label ID="lblAddress" runat="server" Text='<%# Eval("ADDRESS") %>' Width="200px"></asp:Label>
                                                 </ItemTemplate>
                                                 </asp:TemplateField>
                                                 
                                                 <asp:TemplateField HeaderText="PTR Title" SortExpression="HD_PTR_TITLE" ItemStyle-Width="200px" ItemStyle-Wrap="true" >
                                                 <ItemTemplate>
                                                 <asp:Label ID="lblPtrTitle" runat="server" Text='<%# Eval("HD_PTR_TITLE") %>' Width="200px"></asp:Label>
                                                 </ItemTemplate>
                                                 </asp:TemplateField>
                                                 
                                                <%-- <asp:BoundField DataField="HD_PTR_TITLE" HeaderText="PTR Title"   /> --%>              
                                                 <asp:BoundField DataField="HD_STATUS_NAME" SortExpression="HD_STATUS_NAME" HeaderText="Status"   />
                                                 <asp:BoundField DataField="HD_PTR_FOLLOWUP_NAME" SortExpression="HD_PTR_FOLLOWUP_NAME" HeaderText="Follow Up Name"   />
                                                 <asp:BoundField DataField="HD_PTR_SEV_NAME" SortExpression="HD_PTR_SEV_NAME" HeaderText="Severity Name"   />
                                                 <asp:BoundField DataField="HD_PTR_TYPE_NAME" SortExpression="HD_PTR_TYPE_NAME" HeaderText="PTR Type Name"   />
                                                 <asp:BoundField DataField="Employee_Name" SortExpression="Employee_Name" HeaderText="Employee Name"   />
                                                 <asp:TemplateField  HeaderText="Open Date" SortExpression="HD_PTR_OPENDATE" >
                                                 <ItemTemplate>
                                                 <asp:Label ID="lblOpenDt" runat="server" Text='<%# Eval("HD_PTR_OPENDATE")%>'></asp:Label>
                                                 </ItemTemplate>
                                                 </asp:TemplateField>
                                               
                                                 <asp:TemplateField  HeaderText="Close Date" SortExpression="HD_PTR_CLOSEDATE" >
                                                 <ItemTemplate>
                                                 <asp:Label ID="lblClosenDt" runat="server" Text='<%# Eval("HD_PTR_CLOSEDATE")%>'></asp:Label>
                                                 </ItemTemplate>
                                                 </asp:TemplateField>
                                                 ...
                                                 <asp:TemplateField HeaderText="Action" ItemStyle-Wrap="false" >
                                                                                         <ItemTemplate>
                                                                                             ...
                                                                                             <asp:LinkButton ID="lnkSelect" CssClass="LinkButtons"  runat="server" Text="Select" CommandArgument='<%#Eval("HD_PTR_REF")%>'></asp:LinkButton>
                                                                                             
                                                                                              <asp:HiddenField ID="hdPtrID" runat="server" Value='<%#Eval("HD_PTR_ID")%>' />  
                                                                                           </ItemTemplate>
                                                                                </asp:TemplateField>   
                                                            </Columns>
    ...
    function ValidateForm()
    {
     ...
     if(document.getElementById('<%=txtLtrNo.ClientId%>').value !='')
        ...
        if(document.getElementById('<%=txtPtrNo.ClientId%>').value !='')
         {
            var strValue = document.getElementById('<%=txtPtrNo.ClientId%>').value
            reg = new RegExp("^[0-9]+$"); 

            if(reg.test(strValue) == false) 
            {

                document.getElementById('<%=lblError.ClientId%>').innerText ='PTR number should contain only digits.'
                return false;
