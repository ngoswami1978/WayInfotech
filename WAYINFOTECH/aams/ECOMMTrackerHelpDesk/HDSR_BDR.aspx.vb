...
Imports System.Data
#End Region
Partial Class ETHelpDesk_HDSR_BDR
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                objeAAMS.BindDropDown(drpReqType, "ET_ListFuntionalCategory", True, 3)
...
#Region " Sub Procedure Called for deletion of RequestType"
    Sub BdrDelete(ByVal strBdrId As String)
        Try
            Dim objInputXml, objOutputXml As New XmlDocument
            Dim objbbzRequestBDR As New AAMS.bizETrackerHelpDesk.bzRequestBDR
