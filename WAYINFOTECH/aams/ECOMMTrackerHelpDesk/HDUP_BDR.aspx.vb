...
Imports System.Data
#End Region
Partial Class ETHelpDesk_HDUP_BDR
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET BDR Letter Report']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET BDR Letter Report']").Attributes("Value").Value)
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET BDRLetter']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET BDRLetter']").Attributes("Value").Value)
            ...
            End If
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET BDR History']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET BDR History']").Attributes("Value").Value)
                    If strBuilder(0) = "0" Then
    ...
    Sub ViewBdrLetter()
        Try
            If (Not Request.QueryString("Action") = Nothing) Then
                ...
                '                Dim objbzbzRequestBDR As New AAMS.bizETrackerHelpDesk.bzRequestBDR
                Dim objbzbzRequestBDR As New AAMS.bizETrackerHelpDesk.bzRequestBDR
                    ...
                    If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                        ...
                        If (Request.QueryString("Action") = "U") Then
                            ...
                            Else
                                ...
                                strHD_RE_ID = objED.Encrypt(txtLtrNo.Text)
                                Session("Msg") = "U"
                                Response.Redirect("HDUP_BDR.aspx?Popup=T&Msg=U&Action=U&HD_RE_BDR_ID=" & hdEnbdrLetterId.Value & "&ReqID=" & strHD_RE_ID, False) 'Rakesh 2 Aug 08 inplace of above line
                        ...
                        If (Request.QueryString("Action") = "I") Then
                            ...
                            strHD_RE_ID = objED.Encrypt(txtLtrNo.Text)
                            Session("Msg") = "A"
                            Response.Redirect("HDUP_BDR.aspx?Popup=T&Msg=A&Action=U&HD_RE_BDR_ID=" & hdEnbdrLetterId.Value & "&ReqID=" & strHD_RE_ID, False)
...
#Region "btnPrint_ClickEvent"
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        Try
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                Session("ETeBRDLetterRpt") = objOutputXml.OuterXml
                Response.Redirect("../RPSR_ReportShow.aspx?Case=ETBRDLetter", False)
            Else
                lblError.Text = objOutputXml.DocumentElement.SelectSingleNode("Errors/Error").Attributes("Description").Value
            End If
        Catch ex As Exception
...
#Region "Code for Paging "
    ...
    Private Sub BindListForBdr(ByVal strReqId As String, ByVal strBdrId As String)
        Dim objInputXml, objOutputXml As New XmlDocument
        Dim objbzRequestBDR As New AAMS.bizETrackerHelpDesk.bzRequestBDR
        Dim objXmlReader As XmlNodeReader
        Dim ds As DataSet
