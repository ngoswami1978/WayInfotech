...
Partial Class ETHelpDesk_HDUP_QuerySubCategory
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                objeAAMS.BindDropDown(ddlQueryStatus, "ET_QueryStatus", True, 1)
                objeAAMS.BindDropDown(ddlQueryPriority, "ET_QUERYPRIORITY", True, 1)
                objeAAMS.BindDropDown(ddlTeam, "ET_TEAM", True, 1)
    ...
    Private Sub CheckSecurity()
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET Call Query SubCategory']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET Call Query SubCategory']").Attributes("Value").Value)
                End If
