...
Imports System.Xml
Partial Class ETHelpDesk_HDSR_IRSeverity
...
#Region "SearchRecords()"
    Private Sub IRSeverity_Search()
        ...
        Try
            Dim objbzHD As New AAMS.bizETrackerHelpDesk.bzIRSeverity
...
#Region "DeleteRecords()"
    Private Sub IRSeverityDelete(ByVal IR_SeverityID As String)
        Dim objInputXml, objOutputXml As New XmlDocument
        Try
            Dim objIRSeverity As New AAMS.bizETrackerHelpDesk.bzIRSeverity
