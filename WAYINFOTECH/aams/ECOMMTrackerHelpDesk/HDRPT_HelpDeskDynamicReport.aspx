<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDRPT_HelpDeskDynamicReport.aspx.vb" Inherits="ETHelpDesk_HDRPT_HelpDeskDynamicReport" %>
      ...
      function ActDeAct()
     {
      ...
      function  ResultConfigure()
       {   
         ...
         type="../ECOMMTrackerHelpDeskPopup/PUSR_HelpDeskResultConfigure.aspx?Action=U&Popup=T&CurrentSet=" + CurrentSet;
       ...
       {   
         var CurrentSet= document.getElementById("drpSelectSet").value
         type="../ECOMMTrackerHelpDeskPopup/PUSR_HelpDeskSearchConfigure.aspx?Action=U&Popup=T&CurrentSet=" + CurrentSet;
         window.open(type,"ff","height=600,width=900,top=30,left=20,scrollbars=1,status=1,resizable = 1");	     
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">ETrackers HelpDesk-&gt;</span><span class="sub_menu">HelpDesk Report</span>&nbsp;</td>
                        </tr>
                        <tr>
                                        ...
                                        <td align="LEFT" class="redborder"> 
                                                          <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><asp:Button ID="btnReset" CssClass="button" runat="server" Text="Reset" TabIndex="47" Width="125px" AccessKey="R" /></td>
                                                                        </tr>
                                                              <tr>
                                                                  <td>
                                                                  </td>
