<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_PtrFollowUp.aspx.vb" Inherits="ETHelpDesk_HDUP_PtrFollowUp" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
     ...
     function InsertPtrFollowup()
        {
        window.location.href="HDUP_PtrFollowUp.aspx?Action=I|";
        return false;
        }
        ...
        document.getElementById("lblError").innerHTML ="Follow Up Name is Mandatory";
        return false;
        }
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">ETrackers HelpDesk-&gt;</span><span class="sub_menu">PTR Follow Up</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage PTR Follow Up</td>
                        </tr>
                        <tr>
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 22px; width: 149px;" class="textbold" nowrap="nowrap" >
                                                                  Follow Up<span class="Mandatory">* </span>
                                                                </td>
                                                                <td height="22px" style="width: 195px" class="textbold" nowrap="nowrap" >
                                                               <asp:TextBox ID="txtFollowUp" runat="server" CssClass="textbold" TabIndex="1" MaxLength="25" Width="176px" ></asp:TextBox>
                                                                </td>
