<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_IR.aspx.vb" Inherits="ETHelpDesk_HDUP_IR" %>
...
<head id="Head1" runat="server">
  ...
  function  ShowAssigneeHis()
  {
      ...
      if (hdIRsID !="")
      {
           ...
           var type="../ECOMMTrackerHelpDeskPopup/PUSR_IRAssigneeHistory.aspx?AssigneeID="+hdIRsID
      ...
      function  ShowIRHistory()
  {
      ...
      if (IRsID !="")
      {
           var type="../ECOMMTrackerHelpDeskPopup/PUSR_IRHistory.aspx?IRID="+IRsID
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td valign="top" align="left">
                                            <span class="menu">ETrackers HelpDesk-></span><span class="sub_menu">IR</span>
                                        </td>
                                        <td class="right">
