<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_IRFollowUp.aspx.vb" Inherits="ETHelpDesk_HDSR_IRFollowUp" %>
...
<head id="Head1" runat="server">
   ...
   {           
          window.location.href="HDUP_IRFollowUp.aspx?Action=U|"+CheckBoxObj;               
          return false;
    }
        function InsertIRAssignee()
        {
        window.location.href="HDUP_IRFollowUp.aspx?Action=I|";
        return false;
        }
                        ...
                        <table width="100%" align="left">
                            <tr>
                                <td valign="top" align="left">
                                    <span class="menu">ETrackers HelpDesk-&gt; <span class="sub_menu">IR Follow Up</span><span style="font-size: 12pt;
