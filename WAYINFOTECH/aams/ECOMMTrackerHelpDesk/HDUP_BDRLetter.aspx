<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_BDRLetter.aspx.vb" Inherits="ETHelpDesk_HDUP_BDRLetter" %>
      ...
      <table width="860px" align="left" class="border_rightred" >
            <tr>
                <td valign="top">
                    <table width="100%" >
                        <tr>
                            <td valign="top"  align="left" ><span class="menu">ETrackers HelpDesk-&gt;</span><span class="sub_menu">BDR Letter</span></td>
                        </tr>
                        <tr>
