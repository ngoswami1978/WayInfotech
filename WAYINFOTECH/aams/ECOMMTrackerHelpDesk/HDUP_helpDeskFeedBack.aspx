<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_helpDeskFeedBack.aspx.vb" Inherits="ETHelpDesk_HDUP_helpDeskFeedBack" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>AAMS::ETrackers HelpDesk::Manage FeedBack</title>
...
//for Customer Feedback
   ...
   catch(err)
   {
    	 ...
    	 function PopupPage(id)
         {
             ...
             if (id=="1")
             {
                    type = "../TravelAgency/ETTAUP_FeedBack.aspx?Popup=T&LCode="+document.getElementById("hdEnPageLCode").value;
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="top left" style="width:80%">
                                            <span class="menu">ETrackers HelpDesk-> FeedBack</span></td>
