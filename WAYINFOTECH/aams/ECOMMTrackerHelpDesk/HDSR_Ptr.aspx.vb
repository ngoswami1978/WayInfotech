...
Imports System.Xml
Partial Class ETHelpDesk_HDSR_Ptr
    ...
    Private Sub BindDropDowns()
        Try
            ...
            objEaams.BindDropDown(drpFollowup, "ET_HDFOLLOWUP", True, 3)
            'objEaams.BindDropDown(drpPtrStatus, "HDPTRCALLSTATUS", True, 3)
            objEaams.BindDropDown(drpPtrStatus, "ET_HDPTRSTATUS", True, 3)
            objEaams.BindDropDown(drpPtrTypCat, "ET_HDPTRTYPECAT", True, 3)
            objEaams.BindDropDown(drpPtrType, "ET_HDPTRTYPE", True, 3)
            objEaams.BindDropDown(drpSeverity, "ET_HDPTRSEVERITY", True, 3)
            objEaams.BindDropDown(drpAssignedTo, "ET_HDASSIGNEDTO", True, 3)
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
    End Sub
    ...
    Private Sub GetSearchResult()
        ...
        Try
            ...
            End With
            'Dim objHdPtrSearch As New AAMS.bizETrackerHelpDesk.bzPTR
            Dim objHdPtrSearch As New AAMS.bizETrackerHelpDesk.bzPTR
    ...
    Private Sub HDPtrDelelete(ByVal PtrID As String)
        ...
        Try
            'Dim objhdPtrDel As New AAMS.bizETrackerHelpDesk.bzPTR
            Dim objhdPtrDel As New AAMS.bizETrackerHelpDesk.bzPTR
