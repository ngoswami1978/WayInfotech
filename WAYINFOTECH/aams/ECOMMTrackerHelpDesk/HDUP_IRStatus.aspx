<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_IRStatus.aspx.vb" Inherits="ETHelpDesk_HDUP_IRStatus" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>AAMS::HelpDesk::Manage IR Status</title>
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">ETrackers HelpDesk-&gt;</span><span class="sub_menu">Manage IR Status</span></td>
                        </tr>
                        <tr>
