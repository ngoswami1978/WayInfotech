<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_Priority.aspx.vb" Inherits="ETHelpDesk_MSSR_Priority" ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title>AAMS::HelpDesk::Search Priority</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(PriorityID)
			{
				 window.location.href="HDUP_Priority.aspx?Action=U&PriorityID=" +PriorityID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">ETrackers HelpDesk-&gt;</span><span class="sub_menu">Priority Search</span></td>
                        </tr>
                        <tr>
