<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_IRType.aspx.vb" Inherits="ETHelpDesk_HDUP_IRType" %>
      ...
      <table width="860px" align="left" class="border_rightred"  >
            <tr>
                <td valign="top">
                    <table width="100%" >
                        <tr>
                            <td valign="top"  align="left" ><span class="menu">&nbsp;ETrackers HelpDesk-&gt;</span><span class="sub_menu">IR Type</span></td>
                        </tr>
                        <tr>
