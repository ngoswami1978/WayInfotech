<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_RequestTypeCategory.aspx.vb" Inherits="ETHelpDesk_HDUP_RequestTypeCategory" %>
      ...
      <table width="860px" align="left" class="border_rightred" >
            <tr>
                <td valign="top">
                    <table width="100%" >
                        <tr>
                            <td valign="top"  align="left" ><span class="menu">ETrackers HelpDesk-&gt;</span><span class="sub_menu">Request Type Category</span></td>
                        </tr>
                        <tr>
