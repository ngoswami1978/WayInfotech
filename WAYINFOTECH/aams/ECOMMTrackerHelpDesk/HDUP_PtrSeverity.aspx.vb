...
Imports System.Xml
Partial Class ETHelpDesk_HDUP_PtrSeverity
        ...
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET PTR Severity']").Count <> 0 Then
                    strBuilder = eaamsObj.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET PTR Severity']").Attributes("Value").Value)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        '        Dim objtPtrSeverityId As New AAMS.bizETrackerHelpDesk.bzPTRSeverity
        Dim objtPtrSeverityId As New AAMS.bizETrackerHelpDesk.bzPTRSeverity
    ...
    Private Sub ViewPTRSeverity()
        Try
            ...
            '            Dim objbzPTRSeverity As New AAMS.bizETrackerHelpDesk.bzPTRSeverity
            Dim objbzPTRSeverity As New AAMS.bizETrackerHelpDesk.bzPTRSeverity
