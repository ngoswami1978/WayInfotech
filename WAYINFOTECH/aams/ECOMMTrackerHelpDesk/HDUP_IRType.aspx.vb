...
Imports System.Data
#End Region
Partial Class ETHelpDesk_HDUP_IRType
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                '*******************************************************************
                ''Code For 
                objeAAMS.BindDropDown(drpCatName, "ET_HDIRTYPECAT", True)
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET IR Type']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET IR Type']").Attributes("Value").Value)
    ...
    Sub ViewIRType()
        Try
            If (Not Request.QueryString("Action") = Nothing) Then
                ...
                '                Dim objbzIRType As New AAMS.bizETrackerHelpDesk.bzIRType
                Dim objbzIRType As New AAMS.bizETrackerHelpDesk.bzIRType
                ...
                If (Not Request.QueryString("Action") = Nothing) Then
                    ...
                    If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                        If (Request.QueryString("Action") = "U") Then
                            ...
                            Response.Redirect("HDUP_IRType.aspx?&Msg=U&Action=U&HD_IR_TYPE_ID=" & objED.Encrypt(objOutputXml.DocumentElement.SelectSingleNode("IR_TYPE").Attributes("HD_IR_TYPE_ID").Value.Trim), False)
                        Else
                            lblError.Text = objeAAMSMessage.messInsert '"Record added successfully."
                            Response.Redirect("HDUP_IRType.aspx?&Msg=A&Action=U&HD_IR_TYPE_ID=" & objED.Encrypt(objOutputXml.DocumentElement.SelectSingleNode("IR_TYPE").Attributes("HD_IR_TYPE_ID").Value.Trim), False)
                        End If
                    Else
