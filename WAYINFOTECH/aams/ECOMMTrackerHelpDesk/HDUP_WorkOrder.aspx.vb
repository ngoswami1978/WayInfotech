...
Partial Class ETHelpDesk_HDUP_WorkOrder
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                objeAAMS.BindDropDown(drpOrderType, "ET_WorkOrderType", True, 1)
                objeAAMS.BindDropDown(drpFollowUp, "ET_WorkOrderFollowUp", True, 1)
                objeAAMS.BindDropDown(drpSeverity, "ET_WorkOrderSeverity", True, 1)
                objeAAMS.BindDropDown(drpAssigned, "ET_WorkOrderAssignee", True, 1)
                objeAAMS.BindDropDown(drpStatus, "ET_HDPTRSTATUS", True, 1)
...
#Region "btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click"
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            Try
                objOutputXml.Save("c:\Inworkorder.xml")
            Catch ex As Exception
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                If Not Request.QueryString("Action") Is Nothing Then
                    ...
                    Else
                        ...
                        Response.Redirect("HDUP_WorkOrder.aspx?Action=U&Popup=T&Msg=In&OrderID=" + hdOrderID.Value)
                    End If
    ...
    Private Sub CheckSecurity()
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET Work Order']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET Work Order']").Attributes("Value").Value)
                End If
...
#End Region
    ...
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Response.Redirect("HDUP_WorkOrder.aspx?Action=I&ReqID=" + objED.Encrypt(hdReqID.Value) + "&LCode=" + objED.Encrypt(hdLCode.Value))
    End Sub
...
#Region "Code for Paging "
    ...
    Private Sub BindListForWO(ByVal strWO As String)
        Dim objInputXml, objOutputXml As New XmlDocument
        Dim objbzRequestWO As New AAMS.bizETrackerHelpDesk.bzWorkOrder
