...
Imports System.Data
#End Region
Partial Class ETHelpDesk_HDSR_PTRType
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                objeAAMS.BindDropDown(drpCatName, "ET_HDPTRTYPECAT", True, 3)
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET PTR Type']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET PTR Type']").Attributes("Value").Value)
...
#Region "Method for search Request Type"
    Private Sub PtrTypeSearch()
        ...
        Try
            '            Dim objbzPTRType As New AAMS.bizETrackerHelpDesk.bzPTRType
            Dim objbzPTRType As New AAMS.bizETrackerHelpDesk.bzPTRType
