<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_QueryStatus.aspx.vb" Inherits="ETHelpDesk_MSSR_QueryStatus" ValidateRequest="false" %>
...
<link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <title>AAMS::HelpDesk::Search Query Status</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(StatusID)
			{
				 window.location.href="HDUP_QueryStatus.aspx?Action=U&QueryStatusID=" +StatusID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">ETrackers HelpDesk-&gt;</span><span class="sub_menu">Query Status Search</span></td>
                        </tr>
                        <tr>
