...
Partial Class ETHelpDesk_MSSR_CustomerCategory
...
#Region "btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click"
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Response.Redirect("../ECOMMTrackerHelpDesk/HDUP_CustomerCategory.aspx?Action=I")
    End Sub
#End Region
...
#Region "gvCategory_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvCategory.RowDataBound"
    Protected Sub gvCategory_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvCategory.RowDataBound
        Try
            ...
            hdCustCategoryID = CType(e.Row.FindControl("hdCategoryID"), HiddenField)
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET Customer Category']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET Customer Category']").Attributes("Value").Value)
                End If
...
#Region "BindData()"
    Private Sub BindData(ByVal Operation As Integer)
        ...
        Try
            objInputXml.LoadXml("<HD_SEARCHCUSTOMERCATEGORY_INPUT><CUSTOMER_CATEGORY_NAME /><PAGE_NO/> <PAGE_SIZE/><SORT_BY/><DESC/></HD_SEARCHCUSTOMERCATEGORY_INPUT>")
            objInputXml.DocumentElement.SelectSingleNode("CUSTOMER_CATEGORY_NAME").InnerText = txtCategory.Text.Trim()
            ...
            If Operation = PageOperation.Search Then
                ...
                If ViewState("SortName") Is Nothing Then
                    ViewState("SortName") = "CUSTOMER_CATEGORY_NAME"
                    objInputXml.DocumentElement.SelectSingleNode("SORT_BY").InnerText = "CUSTOMER_CATEGORY_NAME" '"LOCATION_CODE"
                Else
            ...
            objOutputXml = objCustomerCategory.Search(objInputXml)
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                If ds.Tables("CUSTOMER_CATEGORY").Rows.Count <> 0 Then
                    gvCategory.DataSource = ds.Tables("CUSTOMER_CATEGORY")
                    gvCategory.DataBind()
                    ...
                    Else
                        lnkPrev.Visible = True
                    End If
                    hdRecordOnCurrentPage.Value = ds.Tables("CUSTOMER_CATEGORY").Rows.Count.ToString
...
#Region "DeleteRecords()"
    Private Sub DeleteRecords()
        Try
            ...
            'Dim objCustomerCategory As New AAMS.bizETrackerHelpDesk.bzCustomerCategory
            Dim objCustomerCategory As New AAMS.bizETrackerHelpDesk.bzCustomerCategory
            objInputXml.LoadXml("<HD_DELETECUSTOMERCATEGORY_INPUT><CUSTOMER_CATEGORY_ID /></HD_DELETECUSTOMERCATEGORY_INPUT>")
            objInputXml.DocumentElement.SelectSingleNode("CUSTOMER_CATEGORY_ID").InnerText = hdID.Value
            hdID.Value = ""
            objOutputXml = objCustomerCategory.Delete(objInputXml)
            BindData(PageOperation.Search)
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
...
#End Region
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Response.Redirect("HDSR_CustomerCategory.aspx")
    End Sub
...
#End Region
    ...
    Sub Export(ByVal objOutputXml As XmlDocument)
        ...
        Dim strArray() As String = {"Customer Category"}
        Dim intArray() As Integer = {1}
        objExport.ExportDetails(objOutputXml, "CUSTOMER_CATEGORY", intArray, strArray, ExportExcel.ExportFormat.Excel, "exportCustomerCategory.xls")
    End Sub
