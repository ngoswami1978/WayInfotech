...
Partial Class ETHelpDesk_HDSR_WorkOrder
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                objeAAMS.BindDropDown(drpOrderType, "ET_WorkOrderType", True, 3)
                objeAAMS.BindDropDown(drpFollowUp, "ET_WorkOrderFollowUp", True, 3)
                objeAAMS.BindDropDown(drpSeverity, "ET_WorkOrderSeverity", True, 3)
                objeAAMS.BindDropDown(drpAssignedTo, "ET_WorkOrderAssignee", True, 3)
                objeAAMS.BindDropDown(drpAoffice, "AOFFICE", True, 3)
                'objeAAMS.BindDropDown(drpStatus, "QueryStatus", True, 3)
                objeAAMS.BindDropDown(drpStatus, "ET_HDPTRSTATUS", True, 3)
