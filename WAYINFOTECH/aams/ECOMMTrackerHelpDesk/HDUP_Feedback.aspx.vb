...
Partial Class ETHelpDesk_HDUP_Feedback
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET Feedback']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET Feedback']").Attributes("Value").Value)
                End If
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            If (Not Request.QueryString("Action") = Nothing) Then
                ...
                '                Dim objhdPtrSave As New AAMS.bizETrackerHelpDesk.bzFeedback
                Dim objhdPtrSave As New AAMS.bizETrackerHelpDesk.bzFeedback
