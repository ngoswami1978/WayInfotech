<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_CustomerCategory.aspx.vb" Inherits="ETHelpDesk_MSSR_CustomerCategory" ValidateRequest="false" %>
...
<head runat="server">
    ...
    function Edit(CategoryID)
			{
				 window.location.href="HDUP_CustomerCategory.aspx?Action=U&CustCategoryID=" +CategoryID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">ETrackers HelpDesk-&gt;<span class="sub_menu"></span></span><span class="sub_menu">Customer Category Search</span></td>
                        </tr>
                        <tr>
