<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_QueryCategory.aspx.vb" Inherits="ETHelpDesk_MSSR_QueryCategory" ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title>AAMS::HelpDesk::Search Query Category</title>
    ...
    function Edit(CategoryID)
			{
				 window.location.href="HDUP_QueryCategory.aspx?Action=U&QueryCategoryID=" +CategoryID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">ETrackers HelpDesk-&gt;</span><span class="sub_menu">Query Category Search</span></td>
                        </tr>
                        <tr>
