...
Partial Class ETHelpDesk_HDUP_helpDeskFeedBack
    ...
    Sub FillDropDownList()
        Try
            ...
            objeAAMS.BindDropDown(ddlHelpDeskAction, "ET_FEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlTechnicalHelpDeskAction, "ET_FEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlSalesHelpDeskAction, "ET_FEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlTrainingHelpDeskAction, "ET_FEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlProductHelpDeskAction, "ET_FEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlCustomerFeedbackAction, "ET_FEEDBACKSTATUS", True, 1)
    ...
    Protected Sub grdvFeedback_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdvFeedback.RowDataBound
        ...
        Try
            ...
            objeAAMS.BindDropDown(drpQuestStatus, "ET_HDQUESTIONSTATUS", True)
