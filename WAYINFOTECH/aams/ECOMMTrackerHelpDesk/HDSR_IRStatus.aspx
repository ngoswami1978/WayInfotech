<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_IRStatus.aspx.vb" Inherits="ETHelpDesk_HDSR_IRStatus" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <title>AAMS::HelpDesk::Search IR Status</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    ...
    function Edit(StatusID)
			{
				 window.location.href="HDUP_IRStatus.aspx?Action=U&IRStatusID=" +StatusID
				 return false;
			}
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">ETrackers HelpDesk-&gt;</span><span class="sub_menu">IR Status Search</span></td>
                        </tr>
                        <tr>
