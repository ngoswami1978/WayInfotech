...
Imports System.Xml
Partial Class ETHelpDesk_HDUP_PtrFollowUp
        ...
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET PTR Followup']").Count <> 0 Then
                    strBuilder = eaamsObj.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET PTR Followup']").Attributes("Value").Value)
    ...
    Private Sub ViewFollowUp()
        Try
            ...
            '            Dim objhFollowup As New AAMS.bizETrackerHelpDesk.bzPTRFollowUp
            Dim objhFollowup As New AAMS.bizETrackerHelpDesk.bzPTRFollowUp
