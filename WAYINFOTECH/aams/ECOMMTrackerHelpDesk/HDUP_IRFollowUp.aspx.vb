...
Imports System.Xml
Partial Class ETHelpDesk_HDUP_IRFollowUp
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET IR Followup']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET IR Followup']").Attributes("Value").Value)
            ...
            Try
                If (Not Request.QueryString("Action") = Nothing) Then
                    ...
                    If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                        ...
                        Else
                            Response.Redirect("HDUP_IRFollowUp.aspx?Action=US|" & objED.Encrypt(objOutputXml.DocumentElement.SelectSingleNode("IR_FOLLOWUP").Attributes("HD_IR_FOLLOWUP_ID").Value.Trim), False)
                            lblError.Text = objeAAMSMessage.messInsert
                        End If
                    Else
    ...
    Private Sub ViewFollowUp()
        Try
            ...
            '            Dim objhFollowup As New AAMS.bizETrackerHelpDesk.bzIRFollowUp
            Dim objhFollowup As New AAMS.bizETrackerHelpDesk.bzIRFollowUp
    ...
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Try
            Response.Redirect("HDUP_IRFollowUp.aspx?Action=I", False)
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
