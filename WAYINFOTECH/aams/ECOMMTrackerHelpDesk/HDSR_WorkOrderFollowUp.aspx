<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_WorkOrderFollowUp.aspx.vb" Inherits="ETHelpDesk_HDSR_WorkOrderFollowUp" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>AAMS::HelpDesk::Search Work Order Follow Up</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(FollowUpID)
			{
				 window.location.href="HDUP_WorkOrderFollowUp.aspx?Action=U&FollowUpID=" +FollowUpID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">ETrackers HelpDesk-&gt;</span><span class="sub_menu">Search Work Order FollowUp</span></td>
                        </tr>
                        <tr>
