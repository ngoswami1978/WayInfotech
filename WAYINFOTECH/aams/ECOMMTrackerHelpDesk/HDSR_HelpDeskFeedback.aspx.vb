...
Partial Class ETHelpDesk_HDSR_HelpDeskFeedback
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                objeAAMS.BindDropDown(drpFeedBackStatus, "ET_FEEDBACKSTATUS", True, 3)
                objeAAMS.BindDropDown(drpRegion, "REGION", True, 3)
                objeAAMS.BindDropDown(drpFeedbackDept, "ET_FeedbackDepartment", True, 3)
            End If
    ...
    Sub DeleteRecords()
        Dim objInputXml, objOutputXml As New XmlDocument
        Try
            'Dim objFbDele As New AAMS.bizETrackerHelpDesk.bzFeedback
            Dim objFbDele As New AAMS.bizETrackerHelpDesk.bzFeedback
