<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_IRTypeCategory.aspx.vb"
    Inherits="ETHelpDesk_HDSR_IRTypeCategory" %>
...
<head id="Head1" runat="server">
   ...
   {           
          window.location.href="HDUP_IRTypeCategory.aspx?Action=U|"+CheckBoxObj;               
          return false;
    }
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">ETrackers HelpDesk-&gt; </span><span class="sub_menu">IR Type Category</span>
                            </td>
                        </tr>
                        <tr>
