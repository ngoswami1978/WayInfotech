<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_Coordinator.aspx.vb" Inherits="ETHelpDesk_MSUP_Coordinator" ValidateRequest="false" %>
         ...
         if (AofficeVar != "")
         {
            ...
            if (strEmployeePageName!="")
            {
                ...
                document.getElementById("hdAOffice").value = AofficeVar
                  type = "../HelpDesk/" + strEmployeePageName+ "?Popup=T&Aoffice="+AofficeVar ;
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">ETrackers HelpDesk-&gt;</span><span class="sub_menu">Manage Coordinator</span></td>
                        </tr>
                        <tr>
