Imports System.Data
Imports System.Xml
Partial Class ETHelpDesk_HDUP_QuestionSet
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET Feedback Questionset']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='ET Feedback Questionset']").Attributes("Value").Value)
    ...
    Private Sub QuestionView()
        Try
            'Dim objViewQ As New AAMS.bizETrackerHelpDesk.bzFeedbackSet
            Dim objViewQ As New AAMS.bizETrackerHelpDesk.bzFeedbackSet
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            '            Dim objQuesSave As New AAMS.bizETrackerHelpDesk.bzFeedbackSet
            Dim objQuesSave As New AAMS.bizETrackerHelpDesk.bzFeedbackSet
