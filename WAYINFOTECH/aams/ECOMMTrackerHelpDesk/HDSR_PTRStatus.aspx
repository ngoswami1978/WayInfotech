<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_PTRStatus.aspx.vb" Inherits="ETHelpDesk_HDSR_PTRStatus" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <title>AAMS::HelpDesk::Search PTR Status</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(StatusID)
			{
				 window.location.href="HDUP_PTRStatus.aspx?Action=U&PTRStatusID=" +StatusID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">ETrackers HelpDesk-&gt;</span><span class="sub_menu">PTR Status Search</span></td>
                        </tr>
                        <tr>
