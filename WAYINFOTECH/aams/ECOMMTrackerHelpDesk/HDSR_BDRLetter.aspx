<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_BDRLetter.aspx.vb" Inherits="ETHelpDesk_HDSR_BDRLetter" %>
...
//            } 
     ...
     function DeleteFunction(CheckBoxObj)
      {   
        ...
        {   
            window.location.href="HDSR_BDRLetter.aspx?Action=D|"+CheckBoxObj + "|";
            return false;
        }
    }
      function EditFunction(CheckBoxObj)
    {                
          window.location ="HDUP_BDRLetter.aspx?Action=U&HD_RE_BDR_ID=" + CheckBoxObj; 
          return false;
    }   
    </script>
      ...
      <table width="860px" align="left" class="border_rightred" >
            <tr>
                <td valign="top">
                    <table width="100%" >
                        <tr>
                            <td valign="top"  align="left" style="height: 20px" ><span class="menu">ETrackers HelpDesk-&gt;</span><span class="sub_menu">BDR Letter</span></td>
                        </tr>
                        <tr>
                                        ...
                                        <td  align ="left" class="redborder" >                                 
                                                        <table width="100%" border="0"  cellpadding="0" cellspacing="0" >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width:18%; height: 19px;" class="textbold" ><span class="textbold">BDR Sent by </span></td>
                                                                <td style="width:17%; height: 19px;" class="textbold" ><asp:DropDownList id="drpBdrSentBy" runat="server" CssClass="dropdownlist" Width="150px" TabIndex="7"></asp:DropDownList></td>
                                                                <td style="width:1%; height: 19px;" class="textbold"></td>
                                                                <td style="width:15%; height: 19px;" ><span class="textbold">Airlines</span></td> 
                                                                <td style="width:17%; height: 19px;" class="textbold" ><asp:DropDownList id="drpAirLine" runat="server" CssClass="dropdownlist" Width="150px" TabIndex="8"></asp:DropDownList></td>
