...
Partial Class Setup_HDSR_Employee
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Session("PageName") = Request.Url.ToString ' "HelpDesk/HDSR_Employee.aspx"
        Try
            '***************************************************************************************
            '***************************************************************************************
    ...
    Private Sub EmployeeSearch()
        ...
        objInputXml.DocumentElement.SelectSingleNode("Request").InnerText = IIf(chkRequest.Checked = True, "0", "1")
        '@ New 
