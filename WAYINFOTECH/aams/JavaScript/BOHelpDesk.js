...
var strCallType="";
        ...
        document.getElementById("hdData").value=""
           for(i=0;i<document.forms[0].elements.length;i++) 
            ...
            {
              window.location.href="BOHDUP_CallLog.aspx?Action=U&MULTIHD_RE_ID="+ data + "&strStatus=" + strCallType;  
              return false;     
            }
}
    ...
    function StatusChangeDataCallLog()
    {
        ...
        document.getElementById("hdData").value=""
           for(i=0;i<document.forms[0].elements.length;i++) 
            ...
            {
              var  type = "BOHDUP_ChangeStatus.aspx?Popup=T&HD_RE_ID=" + data + "&QueryGroup="+ strCallType;
   ...
   function ReLogFunctionCallLog(LCode,strStatus)
        {
            window.location.href="BOHDUP_CallLog.aspx?Action=U&LCode="+LCode + "&strStatus=" + strStatus;               
            return false;
        }
        ...
        {           
          window.location.href="BOHDUP_CallLog.aspx?Action=U&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + strStatus;               
          return false;
        }
      ...
      function PopupPageFunctional(id)
       ...
       /*  if (stLCode != "")
               ...
               // var strMultiHD_RE_ID=document.getElementId("hdMULTIHD_RE_ID").value;
                ...
                if (strHD_RE_ID != "" && strLCode != "" )
                {
                   ...
                   // {
                        ...
                        {
                            type = "../BackOfficeHelpDesk/BOHDUP_Ptr.aspx?Popup=T&Action=I&ReqID="+strHD_RE_ID + "&LCode="+strLCode; //+ "&MultiHD_RE_ID=" + strMultiHD_RE_ID ;
   	                        window.open(type,"aabHelpDesks","height=600,width=900,top=30,left=20,scrollbars=1,status=1");  
   	                    }
   	                    else
   	                    {
   	                        //var strAction="U|" + document.getElementById("hdEnPTRNo").value ;
   	                        var strAction="U|" + document.getElementById("ddlPTRNo").value ;   	                        
   	                        type = "../BackOfficeHelpDesk/BOHDUP_Ptr.aspx?Popup=T&Action=" + strAction + "&ReqID="+strHD_RE_ID + "&LCode="+strLCode ;//+ "&MultiHD_RE_ID=" + strMultiHD_RE_ID;
   	                        window.open(type,"aabHelpDesks","height=600,width=900,top=30,left=20,scrollbars=1,status=1");
   	                    }
   	                //}
   	            } 
                    ...
                    //{
                        ...
                        
                        {
                            if (document.getElementById("ddlQueryCategory").value != "")
                            {
                                 ...
                                 type = "../BackOfficeHelpDesk/BOHDUP_BDR.aspx?Popup=T&Action=I&ReqID="+strHD_RE_ID + "&LCode="+strLCode +"&requestType=" + text1;//'document.getElementById("ddlQueryCategory").value;
   	                            window.open(type,"aabHelpDesks","height=600,width=900,top=30,left=20,scrollbars=1,status=1");  
   	                        }
   	                        else
   	                        {
   	                     ...
   	                     {
                             type = "../BackOfficeHelpDesk/BOHDUP_BDR.aspx?Popup=T&Action=U&ReqID="+strHD_RE_ID + "&LCode="+strLCode + "&HD_RE_BDR_ID=" + document.getElementById("ddlBDRLetterID").value;
   	                         window.open(type,"boHelpDesks","height=600,width=920,top=30,left=20,scrollbars=1,status=1");           
   	                    }
       	            //}
        ...
        if (id=="5")
                   ...
                   // if(strPTRNo=="" && strBDRLetterID=="")
                    //{
                       // if(document.getElementById("hdEnWorkOrderNo").value == "") commented on 13 apr 10
                        ...
                        {
                        type = "../BackOfficeHelpDesk/BOHDUP_WorkOrder.aspx?Popup=T&Action=I&ReqID="+strHD_RE_ID + "&LCode="+strLCode ;
   	                    window.open(type,"aaBHelpDesks","height=600,width=900,top=30,left=20,scrollbars=1,status=1");  
   	                    }
           	            
   	                    else
   	                    {
                        type = "../BackOfficeHelpDesk/BOHDUP_WorkOrder.aspx?Popup=T&Action=U&ReqID="+strHD_RE_ID + "&LCode="+strLCode + "&OrderID=" + document.getElementById("ddlWorkOrderNo").value ;
   	                    window.open(type,"BOHelpDesks1","height=600,width=920,top=30,left=20,scrollbars=1,status=1");           
   	                    }
   	                 //}
   	            }
   	            else
         ...
         {
                var strHD_RE_ID=document.getElementById("hdEnPageHD_RE_ID").value;
                type ="BOHDUP_Transaction.aspx?HD_RE_ID="+strHD_RE_ID ;
         ...
         {
                var strHD_RE_ID=document.getElementById("hdEnPageHD_RE_ID").value;
                type ="../Popup/PUSR_BOCallLogHistory.aspx?HD_RE_ID="+strHD_RE_ID ;
          ...
          if (id=="8")
         {
              ...
              type="BOHDUP_helpDeskFeedBack.aspx?Popup=T&Action=U&strStatus=" + strStatus + "&LCode="+ LCode + "&HD_RE_ID=" + HD_RE_ID + "&FeedBackId="+ strFeedBackId + "&AOFFICE="+ AOFFICE ;   
    ...
    //   {    
      ...
      /*      if(strHD_RE_ID!="")
       ...
       //Action=U&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + strStatus
            ...
            document.getElementById("pnlSol").style.display="none";
            document.getElementById("pnlFollowUp").style.display="none";
            window.location.href="BOHDUP_LinkedLTR.aspx?Action=U&strStatus=" + strStatus + "&LCode="+ LCode + "&HD_RE_ID=" + HD_RE_ID + "&FeedBackId="+ strFeedBackId + "&AOFFICE="+ AOFFICE ;   
            return false;
       ...
       //Action=U&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + strStatus
         ...
         /*   document.getElementById("pnlCall").style.display="none";
            ...
            document.getElementById("pnlSol").style.display="none";
            document.getElementById("pnlFollowUp").style.display="none";*/
            window.location.href="BOHDUP_helpDeskFeedBack.aspx?Action=U&strStatus=" + strStatus + "&LCode="+ LCode + "&HD_RE_ID=" + HD_RE_ID + "&FeedBackId="+ strFeedBackId + "&AOFFICE="+ AOFFICE ;   
            return false;
       }       
...
//		     } 
    ...
    {       }
		    ...
		    return false;}	
   /* if(textbox('txtDateAssigned')==true )
        {   
               if(textbox('txtLoggedDate')==true )
               {
                      if (document.getElementById("hdPageHD_RE_ID").value.trim() !="")
                        {
                                if (compareDates(document.getElementById('txtLoggedDate').value,"dd/MM/yyyy HH:mm",document.getElementById('txtDateAssigned').value,"dd/MM/yyyy HH:mm")==1)
                           {
                                document.getElementById('lblError').innerText ='Assigned DateTime should be greater than or equal to Logged Datetime.';
                                return false;
                           }
                        }                        
               }  
        }
    	else{ document.getElementById("lblError").innerText="Assigned DateTime is Mandatory";	        	  
		      return false;} 		*/     
...
{ 
       ...
       {   
            if(strHD_RE_ID!="")
           {
           window.location.href="BOHDUP_CallLog.aspx?Action=U&TabType=0&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + EnstrStatus + "&FeedBackId="+ strFeedBackId;               
          return false;
           }
          return false;
       }       
       ...
       {   
            if(strHD_RE_ID!="")
           {
           window.location.href="BOHDUP_CallLog.aspx?Action=U&TabType=1&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + EnstrStatus+ "&FeedBackId="+ strFeedBackId;                   
          return false;
           }
       ...
       else if (id == (ctextFront +  "02" + ctextBack))
       {
            ...
            if(strHD_RE_ID!="")
           {
           window.location.href="BOHDUP_CallLog.aspx?Action=U&TabType=2&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + EnstrStatus+ "&FeedBackId="+ strFeedBackId;                   
          return false;
           }
       ...
       else if (id == (ctextFront +  "03" + ctextBack))
       {
            ...
            if(strHD_RE_ID!="")
           {
           window.location.href="BOHDUP_CallLog.aspx?Action=U&TabType=3&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + EnstrStatus+ "&FeedBackId="+ strFeedBackId;                   
          return false;
           }
          return false;
      ...
      var strStatus=document.getElementById("hdEnFunctional").value;
       ...
       {   
            if(strHD_RE_ID!="")
           {
           window.location.href="BOTCUP_CallLog.aspx?Action=U&TabType=0&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + EnstrStatus+ "&FeedBackId="+ strFeedBackId;                     
          return false;
           }
          return false;
       }       
       ...
       {   
            if(strHD_RE_ID!="")
           {
           window.location.href="BOTCUP_CallLog.aspx?Action=U&TabType=1&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + EnstrStatus+ "&FeedBackId="+ strFeedBackId;                     
          return false;
           }
       ...
       else if (id == (ctextFront +  "02" + ctextBack))
       {
            ...
            if(strHD_RE_ID!="")
           {
           window.location.href="BOTCUP_CallLog.aspx?Action=U&TabType=2&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + EnstrStatus+ "&FeedBackId="+ strFeedBackId;                     
          return false;
           }
      ...
      var AOFFICE=document.getElementById("hdEnAOffice").value;
            ...
            window.location.href="BOHDUP_helpDeskFeedBack.aspx?Action=U&strStatus="+EnstrStatus+"&LCode="+ LCode + "&HD_RE_ID=" + HD_RE_ID + "&FeedBackId="+ strFeedBackId+ "&AOFFICE="+ AOFFICE ;
            return false;
...
function PopupPage(id)
         ...
         if (id=="3")
         {
                type = "../BackOficeHelpDesk/BOHDSR_Ptr.aspx?Popup=T";
        ...
        if (id=="5")
         {
                 var strHD_RE_ID=document.getElementById("hdEnPageHD_RE_ID").value;
                type ="BOTCUP_Transaction.aspx?HD_RE_ID="+strHD_RE_ID ;
...
function ClearAssignedDatetime()
{
if (document.getElementById("hdPageHD_RE_ID").value.trim() !="")
{
  document.getElementById("txtDateAssigned").value="";
  return false;
}
}


function GetLoggedDateTime()
{
    if (document.getElementById("hdPageHD_RE_ID").value.trim() =="")
    {
      document.getElementById("txtLoggedDate").value=document.getElementById("txtDateAssigned").value;
      return false;
    }
}
