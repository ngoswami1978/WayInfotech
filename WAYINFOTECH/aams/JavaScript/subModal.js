...
function initPopUp() {
	...
	/*
	'<div id="popupTitleBar" style="visiblity:hidden;">' +
				'<div id="popupTitle" style="visiblity:hidden;"></div>' +
				'<div id="popupControls" style="visiblity:hidden;">' +
	...
	*/
	...
	popcont.innerHTML = '' +
		'<div id="popupInner">' +
			'<iframe src="'+gLoading+'" style="width:100%;height:100%;background-color:transparent;border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none;" scrolling="auto"  frameborder="0" allowtransparency="true" id="popupFrame" name="popupFrame" width="100%" height="100%"></iframe>' +
		'</div>';
...
function showPopWin(url, width, height, returnFunc,IsCenter) {

	gPopupIsShown = true;
	disableTabIndexes();
	gPopupMask.style.display = "block";
	gPopupContainer.style.display = "block";
	if ((IsCenter == null)||(IsCenter == undefined))
	{
	    centerPopWin(width, height);
	}
	else if (IsCenter == "P")
	{
	    centerPopWin(width, height,"40|0");
	}
	else if (IsCenter == "L")
	{
	    centerPopWin(width, height,"350|250");
	}
...
//
var gi = 0;
function centerPopWin(width, height,IsOptional) {
	if (gPopupIsShown == true) {
		...
		/*var titleBarHeight = parseInt(document.getElementById("popupTitleBar").offsetHeight, 10);*/
		var titleBarHeight = parseInt(150,10);
		var topMargin = scTop + ((fullHeight - (height+titleBarHeight)) / 2);
		if (topMargin < 0) { topMargin = 0; }
		if ((IsOptional == null)||(IsOptional == undefined))
		{
		...
		{
		    var sp = IsOptional.split('|');
		    gPopupContainer.style.left = sp[0] + "px";
		    gPopupContainer.style.top = sp[1] + "px";
		}
	}
}
...
window.frames["popupFrame"].document.title="AAMS";
