<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_HelpDeskResultConfigure.aspx.vb" Inherits="ECOMMTrackerHelpDeskPopup_PUSR_HelpDeskResultConfigure" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>ETrackers HelpDesk:Configure Result</title>
            ...
            <tr>
                <td valign="top">
                    <table width="100%" align="left">  
                      <tr>
                            <td align="right">
                                <a href="#" class="LinkButtons" onclick="window.opener.location.href ='../ECOMMTrackerHelpDesk/HDRPT_HelpDeskDynamicReport.aspx?Reload=T';window.close();">Close</a>&nbsp;&nbsp;&nbsp;</td>
                        </tr>                
                        <tr>
