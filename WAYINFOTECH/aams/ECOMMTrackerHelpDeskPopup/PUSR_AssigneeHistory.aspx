<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_AssigneeHistory.aspx.vb" Inherits="ECOMMTrackerHelpDeskPopup_PUSR_AssigneeHistory" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>ETrackers HelpDesk:Work Order Assignee History</title>
                    ...
                    <table width="100%" align="left">  
                        ...
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Work Order Assignee History</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" >
                                                            ...
                                                            <tr>
                                                                <td colspan="6" height="4" align="center">
                                                                    <asp:GridView ID="gvAssigneeHistory" runat="server" BorderWidth="1" BorderColor="#d4d0c8" AutoGenerateColumns="False"
                                                                        Width="99%" TabIndex="9" AllowSorting="true">
                                                                        <Columns>
                                                                        <asp:BoundField DataField="ASSIGNEE_NAME" HeaderText="Assignee Name" SortExpression ="ASSIGNEE_NAME" />
