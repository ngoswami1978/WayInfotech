<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_PtrHistory.aspx.vb" Inherits="ECOMMTrackerHelpDeskPopup_PUSR_PtrHistory" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>ETrackers HelpDesk:PTR History</title>
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" >
                                                            ...
                                                            <tr>
                                                                <td colspan="6" height="4" align="center">
                                                                    <asp:GridView ID="gvPtrHistory" AllowSorting="true" HeaderStyle-ForeColor="white" runat="server" BorderWidth="1" BorderColor="#d4d0c8" AutoGenerateColumns="False"
                                                                        Width="95%" TabIndex="9">
                                                                        <Columns>
                                                                        <asp:BoundField DataField="Employee_Name" SortExpression="Employee_Name" HeaderText="Employee Name" HeaderStyle-HorizontalAlign="left" />
                                                                        <asp:BoundField DataField="DATETIME" SortExpression="DATETIME" HeaderText="Date Time"  HeaderStyle-HorizontalAlign="left"/>
                                                                        <asp:BoundField   DataField="CHANGEDATA" SortExpression="CHANGEDATA" HeaderText="Change Data" HeaderStyle-HorizontalAlign="left" />                                                                                                                                                      
                                                                        </Columns>                                                                                                                                    
