<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PUSR_HelpDeskSearchConfigure.aspx.vb"
    Inherits="ECOMMTrackerHelpDeskPopup_PUSR_HelpDeskSearchConfigure" %>
...
<head id="Head1" runat="server">
    <title>ETrackers HelpDesk:Configure Search</title>
                    ...
                    <tr>
                        <td valign="top">
                            <table width="100%" align="left">
                                <tr>
                                    <td align="right">
                                        <a href="#" class="LinkButtons" onclick="window.opener.location.href ='../ECOMMTrackerHelpDesk/HDRPT_HelpDeskDynamicReport.aspx?Reload=T';window.close();">
                                            Close</a>&nbsp;&nbsp;&nbsp;</td>
                                </tr>
                                <tr>
