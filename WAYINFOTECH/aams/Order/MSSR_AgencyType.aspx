<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MSSR_AgencyType.aspx.vb" Inherits="Order_MSSR_AgencyType" %>
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Order-&gt;</span><span class="sub_menu">Agency Type</span></td>
                        </tr>
                        <tr>
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 192px; height: 22px" >
                                                                   <asp:TextBox ID="txtCustomerType" runat ="server" CssClass ="textbox" Width="208px" MaxLength="30"></asp:TextBox>
                                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td colspan="6" height="4">
                                                                    <asp:GridView ID="gvAgencyType" runat="server"  AutoGenerateColumns="False" TabIndex="4" Width="100%"    >
                                                 <Columns>
