...
<body bgcolor="ffffff" >
    <form id="frmOrderStatus" runat="server"  defaultfocus ="txtOrderStatus" >
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" >
                                                            ...
                                                            <tr>
                                                                <td colspan="6" height="4">
                                                                    <asp:GridView ID="gvOrderStatus" runat="server"  AutoGenerateColumns="False" TabIndex="5" Width="100%"    >
                                                                         <Columns>                                               
