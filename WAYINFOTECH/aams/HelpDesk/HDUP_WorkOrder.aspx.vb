...
Partial Class HelpDesk_HDUP_WorkOrder
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                objeAAMS.BindDropDown(drpOrderType, "WorkOrderType", True, 1)
                objeAAMS.BindDropDown(drpFollowUp, "WorkOrderFollowUp", True, 1)
                objeAAMS.BindDropDown(drpSeverity, "WorkOrderSeverity", True, 1)
                objeAAMS.BindDropDown(drpAssigned, "WorkOrderAssignee", True, 1)
                objeAAMS.BindDropDown(drpStatus, "HDPTRSTATUS", True, 1)
    ...
    Private Sub CheckSecurity()
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='Work Order']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='Work Order']").Attributes("Value").Value)
                End If
...
#Region "Code for Paging "
    ...
    Private Sub BindListForWO(ByVal strWO As String)
        Dim objInputXml, objOutputXml As New XmlDocument
        Dim objbzRequestWO As New AAMS.bizHelpDesk.bzWorkOrder
