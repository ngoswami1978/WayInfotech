...
Imports System.Xml
Partial Class HelpDesk_HDSR_Ptr
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Session("PageName") = "HelpDesk/HDSR_Ptr.aspx"
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='PTR']").Count <> 0 Then
                    strBuilder = objEaams.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='PTR']").Attributes("Value").Value)
    ...
    Private Sub BindDropDowns()
        Try
            ...
            objEaams.BindDropDown(drpFollowup, "HDFOLLOWUP", True, 3)
            'objEaams.BindDropDown(drpPtrStatus, "HDPTRCALLSTATUS", True, 3)
            objEaams.BindDropDown(drpPtrStatus, "HDPTRSTATUS", True, 3)
            objEaams.BindDropDown(drpPtrTypCat, "HDPTRTYPECAT", True, 3)
            objEaams.BindDropDown(drpPtrType, "HDPTRTYPE", True, 3)
            objEaams.BindDropDown(drpSeverity, "HDPTRSEVERITY", True, 3)
            objEaams.BindDropDown(drpAssignedTo, "HDASSIGNEDTO", True, 3)
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
    End Sub
    ...
    Private Sub GetSearchResult()
        ...
        Try
            ...
            End With
            Dim objHdPtrSearch As New AAMS.bizHelpDesk.bzPTR
    ...
    Private Sub HDPtrDelelete(ByVal PtrID As String)
        ...
        Try
            Dim objhdPtrDel As New AAMS.bizHelpDesk.bzPTR
