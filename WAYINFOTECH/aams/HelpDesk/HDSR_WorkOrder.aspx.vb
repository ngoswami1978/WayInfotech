...
Partial Class HelpDesk_HDSR_WorkOrder
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                objeAAMS.BindDropDown(drpOrderType, "WorkOrderType", True, 3)
                objeAAMS.BindDropDown(drpFollowUp, "WorkOrderFollowUp", True, 3)
                objeAAMS.BindDropDown(drpSeverity, "WorkOrderSeverity", True, 3)
                objeAAMS.BindDropDown(drpAssignedTo, "WorkOrderAssignee", True, 3)
                objeAAMS.BindDropDown(drpAoffice, "AOFFICE", True, 3)
                'objeAAMS.BindDropDown(drpStatus, "QueryStatus", True, 3)
                objeAAMS.BindDropDown(drpStatus, "HDPTRSTATUS", True, 3)
