...
Imports System.Xml
Partial Class HelpDesk_HDUP_IR
    ...
    Private Sub ViewIRDetails()
        Try
            ...
            Dim objhdIRView As New AAMS.bizHelpDesk.bzIR
    ...
    Private Sub BindDropDowns()
        Try
            ...
            objeAAMS.BindDropDown(drpFollowup, "HDIRFOLLOWUP", True)
            objeAAMS.BindDropDown(drpType, "HDIRTYPE", True)
            objeAAMS.BindDropDown(drpSeverity, "HDIRSEVERITY", True)
            objeAAMS.BindDropDown(drpStatus, "HDIRSTATUSFORMANAGE", False)
            objeAAMS.BindDropDown(drpAssignedTo, "HDASSIGNEDTO", True)
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
    End Sub
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            If (Not Request.QueryString("Action") = Nothing) Then
                ...
                Dim objhdIRSave As New AAMS.bizHelpDesk.bzIR
    ...
    Public Function ReturnIR_statusValu() As String
        ...
        Dim objbzCallStatus As New AAMS.bizHelpDesk.bzIR
...
#Region "Code for Paging "
    ...
    Private Sub BindListForIR(ByVal strIR As String)
        Dim objInputXml, objOutputXml As New XmlDocument
        Dim objbzRequestIR As New AAMS.bizHelpDesk.bzIR
