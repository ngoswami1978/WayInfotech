<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_QuestionSet.aspx.vb"
    Inherits="HelpDesk_HDSR_QuestionSet" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <title>AAMS::HelpDesk::Search Question Set</title>
    ...
    {           
        window.location.href="HDUP_QuestionSet.aspx?Action=U&SetID="+CheckBoxObj;       
        return false;
    }
    ...
    {   
        window.location.href="HDUP_QuestionSet.aspx?Action=I";       
        return false;
    }
                ...
                <tr>
                    <td class="top" style="width: 857px">
                        <table width="100%" class="left">
                            <tr>
                                <td>
                                    <span class="menu">HelpDesk -&gt;</span><span class="sub_menu">QuestionSet</span></td>
                            </tr>
                            <tr>
