...
Imports System.Xml
Partial Class HelpDesk_HDSR_PtrFollowUp
        ...
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='PTR Followup']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='PTR Followup']").Attributes("Value").Value)
    ...
    Private Sub HDPtrFollowup_Del(ByVal FollowupID As String)
        Dim objInputXml, objOutputXml As New XmlDocument
        Try
            Dim objhdFolloUp As New AAMS.bizHelpDesk.bzPTRFollowUp
