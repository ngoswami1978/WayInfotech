...
Imports System.Xml
Partial Class HelpDesk_HDUP_PtrSeverity
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='PTR Severity']").Count <> 0 Then
                    strBuilder = eaamsObj.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='PTR Severity']").Attributes("Value").Value)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim objtPtrSeverityId As New AAMS.bizHelpDesk.bzPTRSeverity
    ...
    Private Sub ViewPTRSeverity()
        Try
            ...
            Dim objbzPTRSeverity As New AAMS.bizHelpDesk.bzPTRSeverity
