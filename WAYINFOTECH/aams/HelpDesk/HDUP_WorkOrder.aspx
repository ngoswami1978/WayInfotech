<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_WorkOrder.aspx.vb" Inherits="HelpDesk_HDUP_WorkOrder" %>
...
//  var hdPtrsID=document.getElementById("hdOrderID").value.trim();
   ...
   var type="../Popup/PUSR_AssigneeHistory.aspx?WO_Number="+hdPtrsID
  ...
  var ptrsID=document.getElementById("hdHistoryOrderID").value.trim();
   ...
   var type="../Popup/PUSR_EmployeeHistory.aspx?WO_Number="+ptrsID
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">HelpDesk-&gt;</span><span class="sub_menu">Manage Work Order</span></td>
