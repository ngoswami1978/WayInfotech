...
Imports System.IO
Imports Excel
Partial Class HelpDesk_HDRPT_Feedback
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='FeedBackGraph']").Count <> 0 Then
                    strBuilder = objEaams.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='FeedBackGraph']").Attributes("Value").Value)
    ...
    Private Sub FeedbakReport()
        ...
        Try
            ...
            Session("eFeedback") = objInputXml.OuterXml
            Response.Redirect("../RPSR_ReportShow.aspx?Case=Feedback&Action=" + drpRptType.SelectedValue.Trim, False)
        Catch ex As Exception
            lblError.Text = ex.Message.ToString
        Finally
            objInputXml = Nothing
