...
Imports System.Xml
Partial Class HelpDesk_HDSR_PtrSeverity
        ...
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='PTR Severity']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='PTR Severity']").Attributes("Value").Value)
...
#Region "SearchRecords()"
    Private Sub PTRSeverity_Search()
        ...
        Try
            Dim objbzHD As New AAMS.bizHelpDesk.bzPTRSeverity
...
#Region "DeleteRecords()"
    Private Sub PTRSeverityDelete(ByVal PTR_SeverityID As String)
        Dim objInputXml, objOutputXml As New XmlDocument
        Try
            Dim objPtrSeverity As New AAMS.bizHelpDesk.bzPTRSeverity
