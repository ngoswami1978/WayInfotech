...
Imports System.Xml
Partial Class HelpDesk_HDSR_IR
    ...
    Private Sub BindDropDowns()
        Try
            ...
            objEaams.BindDropDown(drpFollowup, "HDIRFOLLOWUP", True, 3)
            objEaams.BindDropDown(drpIRStatus, "HDIRSTATUS", True, 3)
            objEaams.BindDropDown(drpIRTypCat, "HDIRTYPECAT", True, 3)
            objEaams.BindDropDown(drpIRType, "HDIRTYPE", True, 3)
            objEaams.BindDropDown(drpSeverity, "HDIRSEVERITY", True, 3)
            objEaams.BindDropDown(drpAssignedTo, "HDIRASSIGNEDTO", True, 3)
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
    End Sub
    ...
    Private Sub GetSearchResult()
        ...
        Try
            ...
            End With
            Dim objHdIRSearch As New AAMS.bizHelpDesk.bzIR
    ...
    Private Sub HDIRDelelete(ByVal IRID As String)
        ...
        Try
            Dim objhdIRDel As New AAMS.bizHelpDesk.bzIR
