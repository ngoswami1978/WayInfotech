<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDRPT_HelpDeskDynamicReport.aspx.vb" Inherits="HelpDesk_HDRPT_HelpDeskDynamicReport" %>
      ...
      function ActDeAct()
     {
      ...
      function  ResultConfigure()
       {   
         ...
         type="../Popup/PUSR_HelpDeskResultConfigure.aspx?Action=U&Popup=T&CurrentSet=" + CurrentSet;
       ...
       {   
         var CurrentSet= document.getElementById("drpSelectSet").value
         type="../Popup/PUSR_HelpDeskSearchConfigure.aspx?Action=U&Popup=T&CurrentSet=" + CurrentSet;
         window.open(type,"ff","height=600,width=900,top=30,left=20,scrollbars=1,status=1,resizable = 1");	     
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">HelpDesk-&gt;</span><span class="sub_menu">HelpDesk Report</span>&nbsp;</td>
                        </tr>
                        <tr>
                                        ...
                                        <td align="LEFT" class="redborder"> 
                                                          <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><asp:Button ID="btnReset" CssClass="button" runat="server" Text="Reset" TabIndex="49" Width="125px" AccessKey="R" /></td>
                                                                        </tr>
                                                              <tr>
                                                                  <td>
                                                                  </td>
                                                                  ...
                                                                  <td>
                                                                      <asp:Button accessKey="O" id="BtnRequestForReport" tabIndex="50" runat="server" CssClass="button" Width="125px" Text="Export" Visible ="false"  ></asp:Button></td>
                                                              </tr>
                                                                        <tr>
                                                                        <td></td>
                                                                                                ...
                                                                                                <table width="100%" border="0" align="left" cellpadding="0"  cellspacing="1" >                                                            
                                                                                                     <tr>
                                                                                                        ...
                                                                                                        <td style="width:64%">             <asp:TextBox ID="txtOfficeID" runat="server" CssClass="textbox" MaxLength="9"
                                                                                                                TabIndex="14" Width="170px"></asp:TextBox></td> 
                                                                                                    </tr>
                                                                                                </table>
                                                                                           </div>
                                                                                                ...
                                                                                                <table width="100%" border="0" align="left" cellpadding="0"  cellspacing="1" >                                                            
                                                                                                     <tr>
                                                                                                        <td class="textbold" style="width:36%">
                                                                                                            Logged By</td>
                                                                                                        <td style="width:64%">             
                                                                                                            <asp:TextBox ID="txtLoggedBy" runat="server" CssClass="textbox" MaxLength="30" TabIndex="16" Width="170px"></asp:TextBox>
                                                                                                            <img  tabIndex="17"  id="img1" runat="server" alt="Select & Add Logged By" onclick="PopupPage(1)"
                                                                                                     ...
                                                                                                     <tr>
                                                                                                        ...
                                                                                                        <td style="width:64%" class="textbold">   
                                                                                                            <asp:DropDownList ID="ddlQueryGroup" runat="server" AutoPostBack="True" CssClass="dropdownlist" onkeyup="gotop(this.id)" 
                                                                                                                ...
                                                                                                                <asp:ListItem Value="1" Text="Functional" ></asp:ListItem>
                                                                                                                <asp:ListItem Value="2" Text="Technical"></asp:ListItem>
                                                                                                            </asp:DropDownList></td> 
                                                                                                    </tr>
                                                                                                </table>
                                                                                           </div>
                                                                                             ...
                                                                                             <div id="DivDateAssign" runat ="server"  style ="empty-cells:hide;height:28px;" >
                                                                                                <table width="100%" border="0" align="left" cellpadding="0"  cellspacing="1" >                                                            
                                                                                                     <tr>
                                                                                                        <td class="textbold" style="width:36%">
                                                                                                            Date Assigned</td>
                                                                                                        <td style="width:64%" class="textbold"><asp:TextBox ID="txtDateAssigned" runat="server" CssClass="textbox" Width="170px" TabIndex="28"></asp:TextBox>
                                                                                                             <img tabIndex="29"  id="imgDateAssigned" alt="" src="../Images/calender.gif"  title="Date selector" style="cursor: pointer" />                                                
                                                                                                             <script type="text/javascript">
                                                                                                            Calendar.setup({
                                                                                            ...
                                                                                            <div id="Div1AOffice" runat ="server"  style ="empty-cells:hide;height:28px;"  >
                                                                                                <table width="100%" border="0" align="left" cellpadding="0"  cellspacing="1" >                                                            
                                                                                                     <tr valign="top">
                                                                                                        <td class="textbold" style="width:36%">
                                                                                                            1A Office</td>
                                                                                                        <td style="width:64%" class="textbold"><asp:DropDownList ID="ddlAOffice" runat="server" CssClass="dropdownlist" Width="176px" onkeyup="gotop(this.id)"  TabIndex="31">
                                                                                                            </asp:DropDownList></td> 
                                                                                                    </tr>
                                                                                                </table>                                                                                                                                                   
                                                                                           </div>
                                                                                             <div id="DivWorkOrderNo" runat ="server"   style ="empty-cells:hide;height:28px;" >
                                                                                                <table width="100%" border="0" align="left" cellpadding="0"  cellspacing="1" >                                                            
                                                                                                     <tr>
                                                                                                        <td class="textbold" style="width:36%">
                                                                                                            Work Order No.</td>
                                                                                                        <td style="width:64%" class="textbold">             <asp:TextBox ID="txtWorkOrderNo" runat="server" CssClass="textbox" Width="170px"  TabIndex="33" MaxLength="9"></asp:TextBox></td> 
                                                                                                    </tr>
                                                                                                </table>
                                                                                           </div>
                                                                                             <div id="DivAddress" runat ="server"  style ="empty-cells:hide;height:28px;"  >
                                                                                                <table width="100%" border="0" align="left" cellpadding="0"  cellspacing="1" >                                                            
                                                                                                     <tr>
                                                                                                        <td class="textbold" style="width:36%">
                                                                                                            Address</td>
                                                                                                        <td style="width:64%" class="textbold">             <asp:TextBox ID="txtAddresses" runat="server" CssClass="textbox" Width="170px" TabIndex="35" MaxLength="100"></asp:TextBox></td> 
                                                                                                    </tr>
                                                                                                </table>
                                                                                           </div>
                                                                                             <div id="DivDispLastCall" runat ="server"   style ="empty-cells:hide;height:28px;" >
                                                                                                <table width="100%" border="0" align="left" cellpadding="0"  cellspacing="1" >                                                            
                                                                                                     <tr>
                                                                                                       ...
                                                                                                       <asp:CheckBox ID="chkDisplayLastCall" runat="server" CssClass="textbold" onclick="fillDate()" Checked="True" TabIndex="37" /></td> 
                                                                                                    </tr>
                                                                                                </table>
                                                                                           </div>
                                                                                              <div id="DivAgencyStatus" runat ="server"   style ="empty-cells:hide;height:28px;" >
                                                                                                <table width="100%" border="0" align="left" cellpadding="0"  cellspacing="1" >                                                            
                                                                                                     <tr>
                                                                                                        <td class="textbold" style="width:36%; height: 20px;">
                                                                                                            Agency Status</td>
                                                                                                        <td style="width:64%; height: 20px;" class="textbold"><asp:DropDownList id="dlstAgencyStatus" tabIndex=39 onkeyup="gotop(this.id)" runat="server" CssClass="textbold" Width="176px" Visible="true">
                                                                                                   </asp:DropDownList></td> 
                                                                                                    </tr>
                                                                                                </table>
                                                                                           </div> 
                                                                                         ...
                                                                                         <table  width="100%" border="0" cellpadding="0"  cellspacing="1"   align="left">                                                            
                                                                                             <tr>       
                                                                                                <td style="width:36%" class="textbold">
                                                                                                            Title</td>
                                                                                                   <td style="width:64%" class="textbold">
                                                                                                            <asp:TextBox ID="txtTit" runat="server" CssClass="textbox" MaxLength="100" TabIndex="41"
                                                                                                                Width="170px"></asp:TextBox></td> 
                                                                                              </tr>
                                                                                         </table> 
                                                                                      </div> 
                                                                                           <div id="DivAirLine" runat ="server"   style ="empty-cells:hide;height:28px;">
                                                                                         <table  width="100%" border="0" cellpadding="0"  cellspacing="1"   align="left">                                                            
                                                                                             <tr>       
                                                                                                <td style="width:36%" class="textbold">
                                                                                                       Airline     </td>
                                                                                                   <td style="width:64%" class="textbold">
                                                                                                            <asp:DropDownList id="DlstAirLine" tabIndex=43 onkeyup="gotop(this.id)" runat="server" CssClass="textbold" Width="220px" Visible="true">
                                                                                                   </asp:DropDownList></td> 
                                                                                              </tr>
                                                                                         </table> 
                                                                                      </div>      
                                                                                                ...
                                                                                                <td class="textbold" style="width:36%"> Customer Category
                                                                                                   ...
                                                                                                   <td style="width:64%" >
                                                                                                       &nbsp;<asp:DropDownList ID="ddlCustomerCategory" runat="server" CssClass="dropdownlist"
                                                                                                        onkeyup="gotop(this.id)"    Width="145px" TabIndex="15">
                                                                                                       </asp:DropDownList>
                                                                                                  </td> 
                                                                                              </tr>
                                                                                            </table> 
                                                                                         ...
                                                                                         <table  width="100%" border="0"  align="left" cellpadding="0"  cellspacing="1" >                                                            
                                                                                             <tr>       
                                                                                                <td class="textbold" style="width:36%"> Caller Name </td>
                                                                                                   <td style="width:64%" >
                                                                                                       &nbsp;<asp:TextBox id="txtCallerName" tabIndex=18 runat="server" CssClass="textbox" Width="139px" MaxLength="30"></asp:TextBox><IMG tabIndex="19"  id="Img4" onclick="PopupPage(3);" alt="Select & Add Caller Name" src="../Images/lookup.gif" runat="server" />                                
                                                                                                  </td> 
                                                                                              </tr>
                                                                                         </table> 
                                                                                      </div>
                                                                                         ...
                                                                                         <table  width="100%" border="0" cellpadding="0"  cellspacing="1"   align="left">                                                            
                                                                                             <tr>       
                                                                                                <td style="width:36%" class="textbold"> Severity</td>
                                                                                                   <td style="width:64%" class="textbold"> &nbsp;<asp:DropDownList ID="ddlQueryPriority" runat="server" CssClass="dropdownlist" onkeyup="gotop(this.id)"  Width="145px" TabIndex="25">
                                                                                                           <asp:ListItem Selected="True" Value ="" >All</asp:ListItem>
                                                                                                       </asp:DropDownList>&nbsp;</td> 
                                                                                              </tr>
                                                                                         </table> 
                                                                                         ...
                                                                                         <table  width="100%" border="0" cellpadding="0"  cellspacing="1"   align="left">                                                            
                                                                                             <tr>       
                                                                                                <td style="width:36%" class="textbold"> Coordinator2</td>
                                                                                                   <td style="width:64%" class="textbold"> &nbsp;<asp:DropDownList ID="ddlCoordinator2" runat="server" CssClass="dropdownlist" Width="145px" onkeyup="gotop(this.id)"  TabIndex="27">
                                                                                                       </asp:DropDownList>&nbsp;</td> 
                                                                                              </tr>
                                                                                         </table> 
                                                                                      </div>
                                                                                         ...
                                                                                         <table  width="100%" border="0" cellpadding="0"  cellspacing="1"   align="left">                                                            
                                                                                             <tr>       
                                                                                                <td style="width:36%" class="textbold"> Disposition</td>
                                                                                                   <td style="width:64%" class="textbold"> &nbsp;<asp:DropDownList ID="ddlDisposition" runat="server" CssClass="dropdownlist" Width="145px" onkeyup="gotop(this.id)"  TabIndex="30">
                                                                                                       </asp:DropDownList>&nbsp;</td> 
                                                                                              </tr>
                                                                                         </table> 
                                                                                      </div>
                                                                                         ...
                                                                                         <table  width="100%" border="0" cellpadding="0"  cellspacing="1"   align="left">                                                            
                                                                                             <tr valign="top">       
                                                                                                <td style="width:36%" class="textbold"> Agency 1A Office</td>
                                                                                                   <td style="width:64%" class="textbold"> &nbsp;<asp:DropDownList ID="ddlAgencyAOffice" runat="server" CssClass="dropdownlist" Width="145px" onkeyup="gotop(this.id)"  TabIndex="32">
                                                                                                       </asp:DropDownList>&nbsp;</td> 
                                                                                              </tr>
                                                                                         </table> 
                                                                                      </div>
                                                                                       <div id="DivFollowUp" runat ="server"  style ="empty-cells:hide;height:28px;" >
                                                                                         <table  width="100%" border="0" cellpadding="0"  cellspacing="1"   align="left">                                                            
                                                                                             <tr>       
                                                                                                <td style="width:36%" class="textbold"> 
                                                                                                            Follow up</td>
                                                                                                   <td style="width:64%" class="textbold"> &nbsp;<asp:DropDownList ID="drpFollowup" runat="server" CssClass="dropdownlist" onkeyup="gotop(this.id)"  Width="145px" TabIndex="34">
                                                                                                   </asp:DropDownList></td> 
                                                                                              </tr>
                                                                                         </table> 
                                                                                      </div>
                                                                                         ...
                                                                                         <table  width="100%" border="0" cellpadding="0"  cellspacing="1"   align="left">                                                            
                                                                                             <tr>       
                                                                                                <td style="width:36%" class="textbold"> Assigned To</td>
                                                                                                   <td style="width:64%" class="textbold"> &nbsp;<asp:DropDownList ID="drpAssignedTo" runat="server" CssClass="dropdownlist" onkeyup="gotop(this.id)"  Width="145px" TabIndex="36">
                                                                                                   </asp:DropDownList></td> 
                                                                                              </tr>
                                                                                         </table> 
                                                                                      </div>
                                                                                         ...
                                                                                         <table  width="100%" border="0" cellpadding="0"  cellspacing="1"   align="left">                                                            
                                                                                             <tr>       
                                                                                                <td style="width:36%" class="textbold"> Contact Type</td>
                                                                                                   <td style="width:64%" class="textbold">&nbsp;<asp:DropDownList id="ddlContactType" tabIndex=38 onkeyup="gotop(this.id)" runat="server" CssClass="textbold" Width="143px">
                                                                                                     </asp:DropDownList></td> 
                                                                                              </tr>
                                                                                         </table> 
                                                                                      </div>
                                                                                         ...
                                                                                         <table  width="100%" border="0" cellpadding="0"  cellspacing="1"   align="left">                                                            
                                                                                             <tr>       
                                                                                                <td style="width:36%" class="textbold">Agency Type</td>
                                                                                                   <td style="width:64%" class="textbold">&nbsp;<asp:DropDownList id="DlstAgencyType" tabIndex=40 onkeyup="gotop(this.id)" runat="server" CssClass="textbold" Width="143px" Visible="true">
                                                                                                   </asp:DropDownList></td> 
                                                                                              </tr>
                                                                                         </table> 
                                                                                      </div> 
                                                                                         ...
                                                                                         <table  width="100%" border="0" cellpadding="0"  cellspacing="1"   align="left">                                                            
                                                                                             <tr>       
                                                                                                <td style="width:36%" class="textbold">IR Number</td>
                                                                                                   <td style="width:64%" class="textbold"><asp:TextBox ID="txtHD_IR_REF" runat="server" CssClass="textbox" Width="170px"  TabIndex="42" MaxLength="9"></asp:TextBox></td> 
                                                                                              </tr>
                                                                                         </table> 
                                                                                      </div>
                                                                                         ...
                                                                                         <table  width="100%" border="0" cellpadding="0"  cellspacing="1"   align="left">                                                            
                                                                                             <tr>       
                                                                                                <td style="width:36%" class="textbold">&nbsp;</td>
                                                                                                   <td style="width:64%" class="textbold">&nbsp;<asp:DropDownList id="DropDownList1" tabIndex=44 onkeyup="gotop(this.id)" runat="server" CssClass="textbold" Width="143px" Visible="false">
                                                                                                   </asp:DropDownList></td> 
                                                                                              </tr>
                                                                                         </table> 
                                                                                      </div>                                                                                               
