<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_CallLog.aspx.vb" Inherits="HelpDesk_HDUP_CallLog"
...
function CallLogDescription(fr,hd_re_id,rowid)
    ...
    //alert(rowid);    
    var type;    
    type ="../Popup/PUUP_HDDescSolution.aspx?fr="+ fr +"&hd_re_id="+hd_re_id + "&ID="+rowid;	
                ...
                <td class="top">
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="top left" style="width: 80%">
                                            <span class="menu">HelpDesk-></span><span class="sub_menu">Call Log</span>
                                        </td>
                                                            ...
                                                            <tr>
                                                                        ...
                                                                        <table width="100%" border="0" class="left" cellpadding="2" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td colspan="3">
                                                                                    ...
                                                                                    <img id="Img2" runat="server" alt="Select & Add Agency Name" onclick="PopupPageFunctional(1)"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <div id="dvAutoPopulate" runat="server" style="position: absolute;background-color:Green">
                                                                                    ...
                                                                                    <asp:DropDownList ID="DlstCallerName" runat ="server" CssClass ="dropdownlist"  TabIndex="2"  Width="172px"></asp:DropDownList><img id="Img1" runat="server" tabindex="2" alt="Select & Add Caller Name" onclick="PopupPageFunctional(2)"
                                                                                        src="../Images/lookup.gif" style="cursor: pointer" /> 
                                                                                    <asp:TextBox ID="txtCallerName" runat="server" Width="168px" MaxLength="50" TabIndex="2" ReadOnly ="true" 
                                                                                      style="display:none;"   CssClass="textboxgrey" ></asp:TextBox>                                             
                                                                                         <input id="hdCallCallerName" runat="server" style="width: 1px" type="hidden" /> 
                                                                                         <div id="AutoCompleteTo" />
                                                                                          <asp:TextBox ID="txtCallerName2"  runat ="server"  style="display:none;" Width="0px"></asp:TextBox>
                                                                                         <cc1:AutoCompleteExtender ID="AutoCompleteExtenderForCaller" runat="server" TargetControlID="txtCallerName2"  Enabled ="false" 
                                                                                           ...
                                                                                           <input id="hdCallerName" runat="server" style="width: 1px" type="hidden" /> 
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <img id="Img5" tabindex="2" runat="server" alt="Select & Add PTR No" onclick="PopupPageFunctional(3)"
                                                                                        src="../Images/lookup.gif" style="cursor: pointer;" />
                                                                                </td>
                                                                                <td class="textbold">
                                                                                    BDR Letter ID</td>
                                                                                <td>
                                                                                    ...
                                                                                    <img id="Img3" tabindex="2" runat="server" alt="Select & Add BDR Letter ID" onclick="PopupPageFunctional(4)"
                                                                                        src="../Images/lookup.gif" style="cursor: pointer;" />
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <img id="Img4" runat="server" tabindex="2" alt="Select & Add Work Order No" onclick="PopupPageFunctional(5)"
                                                                                        src="../Images/lookup.gif" style="cursor: pointer;" />
                                                                                </td>
                                                                                <td class="textbold">
                                                                                    Close Date Time</td>
                                                                ...
                                                                <td class="center top " colspan="2" rowspan="1">
                                                                    ...
                                                                    <asp:Button ID="btnHistory" runat="server" TabIndex="3" CssClass="button topMargin"
                                                                        Text="History" Width="106px" OnClientClick="return PopupPageFunctional(7)" /><br />
                                                                    <asp:Button ID="btnAssigneeHistory" runat="server" TabIndex="3" CssClass="button topMargin"
                                                                        Text="Assignee History" Width="106px" OnClientClick="return PopupPageFunctional(6)" /><br />
                                                                    <asp:Button ID="btnFeedBack" runat="server" TabIndex="3" CssClass="button topMargin"
                                                                        Text="FeedBack" Width="106px" OnClientClick="return PopupPageFunctional(8)" /><br />
                    ...
                    <asp:HiddenField ID="HdFuncManForDecAndSoln" runat="server" Value=""  />
                     ...
                     <asp:HiddenField ID="HdDescWriitenByUser" runat="server" Value=""  />
                      ...
                      <asp:HiddenField ID="HdRequireCallerName" runat="server" Value=""  />
...
function FillCallerName(StrOut)
{
            //alert(StrOut) ;
			...
			var DlstCallername = document.getElementById('<%=DlstCallerName.ClientId%>');
			
			 DlstCallername.options.length=0;
			
			if (StrOut=="") 
            {
             listItem = new Option(names, codes );
             DlstCallername.options[0] = listItem;
            }
            else
            {
			    ...
			    var Callers = dsRoot.getElementsByTagName('STAFF');
			    var text;     			
			    var listItem;
			    listItem = new Option(names, codes);
			    DlstCallername.options[0] = listItem;
			    for (var count = 0; count < Callers.length; count++)
			    {
				    codes= Callers[count].getAttribute("FIRSTNAME") + Callers[count].getAttribute("SURNAME")+ "-" + Callers[count].getAttribute("SIGNINID") ; 
			        names=Callers[count].getAttribute("FIRSTNAME") + Callers[count].getAttribute("SURNAME") +  "-" + Callers[count].getAttribute("SIGNINID") ; 
				    listItem = new Option(names, codes);
				    DlstCallername.options[DlstCallername.length] = listItem;
			    }
			}
