...
Partial Class HelpDesk_TCUP_CallLog
    ...
    Sub LoadAllControl()
        Try
            ...
            objeAAMS.BindDropDown(ddlQueryStatus, "TSTATUSWITHCLOSED", True, 1)
            objeAAMS.BindDropDown(ddlPriority, "TPRIORITY", True, 1)
    ...
    Sub DownloadFile(ByVal strFileName As String)
        Try
            If strFileName.Trim = "" Then
                Exit Sub
            End If
            Dim fullpath As String = Path.GetFullPath(Server.MapPath("../HelpDeskFiles/") + strFileName)
