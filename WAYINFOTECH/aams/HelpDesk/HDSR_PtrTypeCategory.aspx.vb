...
Imports System.Xml
Partial Class HelpDesk_HDSR_PtrTypeCategory
   ...
   Dim objeAAMSMessage As New eAAMSMessage
        ...
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='PTR Type Category']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='PTR Type Category']").Attributes("Value").Value)
    ...
    Private Sub HDPtrTypeSearch()
        ...
        Try
            Dim objhdPtrCat As New AAMS.bizHelpDesk.bzPTRTypeCategory
