...
Partial Class HelpDesk_MSSR_QueryCategory
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                txtCategory.Focus()
                objeAAMS.BindDropDown(drpSubGroup, "QuerySubGroup", True, 3)
            End If
            ' Checking security.
            CheckSecurity()
...
#Region "btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click"
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Response.Redirect("../HelpDesk/HDUP_QueryCategory.aspx?Action=I")
    End Sub
#End Region
