<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TCUP_CallLog.aspx.vb" Inherits="HelpDesk_TCUP_CallLog"
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="top left" style="width: 80%">
                                            <span class="menu">Technical-></span><span class="sub_menu">Call Log</span>
                                        </td>
                                                                    ...
                                                                    <asp:Panel ID="pnlCall" runat="server" Width="100%">
                                                                        <table width="100%" border="0" class="left" cellpadding="2" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:DropDownList ID="DlstCallerName" runat ="server" CssClass ="dropdownlist"  TabIndex="2"  Width="172px"></asp:DropDownList><img id="Img1" runat="server" alt="Select & Add Caller Name" onclick="PopupPage(2)"
                                                                                        src="../Images/lookup.gif" tabindex="2" style="cursor: pointer" />
                                                                                    <asp:TextBox ID="txtCallerName" runat="server" Width="168px" MaxLength="50" TabIndex="2" ReadOnly ="true"  style="display:none;" 
                                                                                        CssClass="textboxgrey" ></asp:TextBox>
                                                  ...
                                                  showsTime      : true
                                                                ...
                                                                <td class="top">
                                                                    ...
                                                                    <asp:Button ID="btnHistory" runat="server" TabIndex="3" CssClass="button topMargin"
                                                                        Text="History" Width="100px" OnClientClick="return PopupPage(4)" /><br />
                                                                    <asp:Button ID="btnAssigneeHistory" runat="server" TabIndex="3" CssClass="button topMargin"
                                                                        Text="Assignee History" Width="100px" OnClientClick="return PopupPage(5)" /><br />
                                                                    <asp:Button ID="btnFeedBack" runat="server" CssClass="button topMargin" OnClientClick="return PopupPage(6)"
