...
Imports System.Xml
Partial Class HelpDesk_HDSR_IRTypeCategory
    ...
    Private Sub DeleteIRType_Cat(ByVal IRTypeCatID As String)
        ...
        Try
            Dim objhdIRTypeCat As New AAMS.bizHelpDesk.bzIRTypeCategory
    ...
    Private Sub HDIRTypeSearch()
        ...
        Try
            Dim objhdIRCat As New AAMS.bizHelpDesk.bzIRTypeCategory
