...
Partial Class BOHelpDesk_HDUP_IRTypeCategory
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO IR Type Category']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO IR Type Category']").Attributes("Value").Value)
        ...
        Try
            Try
                If (Not Request.QueryString("Action") = Nothing) Then
                    ...
                    Dim objhdIRTypeCate As New AAMS.bizBOHelpDesk.bzIRTypeCategory
                    ...
                    If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                        ...
                        Else
                            Response.Redirect("BOHDUP_IRTypeCategory.aspx?Action=US|" & objED.Encrypt(objOutputXml.DocumentElement.SelectSingleNode("IR_CATEGORIES").Attributes("HD_IR_TYCAT_ID").Value.Trim), False)
    ...
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Try
            Response.Redirect("BOHDUP_IRTypeCategory.aspx?Action=I", False)
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
