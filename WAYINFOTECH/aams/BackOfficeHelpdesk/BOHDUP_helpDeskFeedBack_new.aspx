<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_helpDeskFeedBack_new.aspx.vb" Inherits="BOHelpDesk_HDUP_helpDeskFeedBack_new" %>
...
//           window.location.href="HelpDesk_HDUP_helpDeskFeedBack_new?Action=U&TabType=0&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + EnStatus + "&FeedBackId="+ FeedBackId;    
            window.location.href="BOHDUP_helpDeskFeedBack_new.aspx";
           return false;
