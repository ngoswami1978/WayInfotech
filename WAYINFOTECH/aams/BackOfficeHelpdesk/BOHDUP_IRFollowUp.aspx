<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_IRFollowUp.aspx.vb" Inherits="BOHelpDesk_HDUP_IRFollowUp" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Manage IR Followup</title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        document.getElementById("lblError").innerHTML ="Followup name is mandatory.";
        return false;
        }
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">Back Office HelpDesk&gt;</span><span class="sub_menu">IR Follow Up</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage IR Follow Up</td>
                        </tr>
                        <tr>
