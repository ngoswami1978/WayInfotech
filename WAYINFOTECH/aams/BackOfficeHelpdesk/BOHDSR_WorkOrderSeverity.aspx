<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_WorkOrderSeverity.aspx.vb" Inherits="BOHelpDesk_HDSR_WorkOrderSeverity" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title>AAMS::Back Office HelpDesk::Search Work Order Severity</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(SeverityID)
			{
				 window.location.href="BOHDUP_WorkOrderSeverity.aspx?Action=U&SeverityID=" +SeverityID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">Search Work Order Severity</span></td>
                        </tr>
                        <tr>
