<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_Solution.aspx.vb" Inherits="BOHelpDesk_HDUP_Solution" EnableEventValidation="false" %>
...
{   
       ...
       {   
           if(strHD_RE_ID!="")
           {
           window.location.href="BOHDUP_CallLog.aspx?Action="+pgStatus + "&LCode=" + strLCode + "&HD_RE_ID=" +strHD_RE_ID ;
           }
           else
           {
       ...
       {   
           ...
           if(strHD_RE_ID!="")
           {
           window.location.href="BOHDUP_Description.aspx?Action="+pgStatus + "&LCode=" + strLCode + "&HD_RE_ID=" +strHD_RE_ID ;
           }
           else
           {
       ...
       else if (id == (ctextFront +  "02" + ctextBack))
       {
            ...
            if(strHD_RE_ID!="")
           {
           window.location.href="BOHDUP_Solution.aspx?Action="+pgStatus + "&LCode=" + strLCode + "&HD_RE_ID=" +strHD_RE_ID ;
           }
           else
           {
       ...
       else if (id == (ctextFront +  "03" + ctextBack))
       {
            ...
            if(strHD_RE_ID!="")
           {
           window.location.href="BOHDUP_FollowUp.aspx?Action="+pgStatus + "&LCode=" + strLCode + "&HD_RE_ID=" +strHD_RE_ID ;
           }
           else
           {
           window.location.href="BOHDUP_FollowUp.aspx?Action="+pgStatus + "&LCode=" + strLCode ;
           }
                        ...
                        <tr>
                            <td class="top">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="top left">
                                            <span class="menu">Back Office HelpDesk-></span><span class="sub_menu">Solution</span></td>
                                    </tr>
                                    <tr>
                                                        ...
                                                        <asp:Panel ID="pnlSolution" runat="server" Width="100%">
                                                            <table width="100%" border="0" class="left" cellpadding="2" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="top">
                                                                        <asp:Button ID="btnSave" runat="server" CssClass="button" Text="Save" TabIndex="3" AccessKey="s" />
                                                                        <br /><asp:Button ID="btnReset" runat="server" CssClass="button topMargin" Text="Reset" TabIndex="3" AccessKey="r" /><br />
                                                                        </td>
                                                                </tr>
                                                                <tr>
