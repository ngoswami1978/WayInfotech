<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_IRFollowUp.aspx.vb" Inherits="BOHelpDesk_HDSR_IRFollowUp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Search IR Followup</title>
   ...
   {           
          window.location.href="BOHDUP_IRFollowUp.aspx?Action=U|"+CheckBoxObj;               
          return false;
    }
        function InsertIRAssignee()
        {
        window.location.href="BOHDUP_IRFollowUp.aspx?Action=I|";
        return false;
        }
                        ...
                        <table width="100%" align="left">
                            <tr>
                                <td valign="top" align="left">
                                    <span class="menu">Back Office Help Desk-><span class="sub_menu">IR Follow Up</span><span style="font-size: 12pt;
                                                            ...
                                                            <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 20%;">
                                                                            ...
                                                                            <asp:TextBox ID="txtFollowup" runat="server" CssClass="textfield" TabIndex="1"
                                                                                Width="177px" MaxLength="25"></asp:TextBox></td>
                                                                ...
                                                                <tr >
                                                                    <td colspan="4" style="width:100%">
                                                                        &nbsp;<asp:GridView ID="grdvIRFollowUp" BorderWidth="1" AllowSorting="true" HeaderStyle-ForeColor="white" BorderColor="#d4d0c8" runat="server"
                                                                                AutoGenerateColumns="False" Width="100%" EnableViewState="false">
                                                                              <Columns>
                                                                                    <asp:TemplateField SortExpression="HD_IR_FOLLOWUP_NAME" HeaderText="Follow Up Name">
                                                                                        <itemtemplate>
                                                                                           <%#Eval("HD_IR_FOLLOWUP_NAME")%> 
                                                                                    </itemtemplate>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <asp:LinkButton ID="linkDelete" runat="server" Text="Delete" CssClass="LinkButtons"></asp:LinkButton>
                                                                                             <%--<a href="#" class="LinkButtons" id="linkDelete" runat="server">
                                                                                                Delete</a>--%>
                                                                                                <asp:HiddenField ID="hdField" runat="server" Value='<%#Eval("HD_IR_FOLLOWUP_ID") %>' />
                                                                                        </ItemTemplate>
