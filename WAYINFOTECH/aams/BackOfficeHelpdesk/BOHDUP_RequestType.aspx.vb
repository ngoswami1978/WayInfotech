...
Imports System.Data
#End Region
Partial Class BOHelpDesk_HDUP_RequestType
                ...
                If (Not Request.QueryString("Action") = Nothing) Then
                    ...
                    If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                        If (Request.QueryString("Action") = "U") Then
                            ...
                            Response.Redirect("BOHDUP_RequestType.aspx?&Msg=U&Action=U&HD_RETYPE_ID=" & objOutputXml.DocumentElement.SelectSingleNode("RequestType").Attributes("HD_RETYPE_ID").Value, False)
                        Else
                            lblError.Text = objeAAMSMessage.messInsert '"Record added successfully."
                            Response.Redirect("BOHDUP_RequestType.aspx?&Msg=A&Action=U&HD_RETYPE_ID=" & objOutputXml.DocumentElement.SelectSingleNode("RequestType").Attributes("HD_RETYPE_ID").Value, False)
                        End If
                    Else
