<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDRPT_TechnicalReport.aspx.vb" Inherits="BOHelpDesk_HDRPT_TechnicalReport" %>
...
<head id="Head1" runat="server">
    ...
    <title>AAMS::Back Office HelpDesk::Technical Report</title>
                            ...
                            <tr>
                                <td class="top">
                                    <table width="100%" class="left">
                                        <tr>
                                            <td>
                                                <span class="menu">Back Office HelpDesk -&gt;</span><span class="sub_menu">Technical Report</span></td>
                                        </tr>
                                        <tr>
                                                            ...
                                                            <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3">
                                                                        ...
                                                                        <img id="Img2" runat="server" alt="Select & Add Agency Name" onclick="PopupPageCallLog(2)" tabindex="2"
                                                  ...
                                                  showsTime      : true
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <img id="img1" runat="server" alt="Select & Add Logged By" onclick="PopupPageCallLog(1)" tabindex="20"
                                                                            src="../Images/lookup.gif" style="cursor: pointer" /></td>
                                                                    <td class="textbold">
                                                                        Call Assigned To</td>
