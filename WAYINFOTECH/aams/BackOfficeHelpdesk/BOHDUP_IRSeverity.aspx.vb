...
Imports System.Xml
Partial Class BOHelpDesk_HDUP_IRSeverity
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO IR Severity']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO IR Severity']").Attributes("Value").Value)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim objtIRSeverityId As New AAMS.bizBOHelpDesk.bzIRSeverity
        ...
        Try
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                Else
                    lblError.Text = objeAAMSMessage.messInsert
                    Response.Redirect("BOHDUP_IRSeverity.aspx?Action=US&IRSeverityID=" + objED.Encrypt(CheckBoxOb))
    ...
    Private Sub ViewIRSeverity()
        Try
            ...
            Dim objbzIRSeverity As New AAMS.bizBOHelpDesk.bzIRSeverity
    ...
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Try
            Response.Redirect("BOHDUP_IRSeverity.aspx?Action=I", False)
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
