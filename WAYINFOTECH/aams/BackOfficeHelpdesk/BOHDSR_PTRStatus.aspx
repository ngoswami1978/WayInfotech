<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_PTRStatus.aspx.vb" Inherits="BOHelpDesk_HDSR_PTRStatus" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <title>AAMS::Back Office HelpDesk::Search PTR Status</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(StatusID)
			{
				 window.location.href="BOHDUP_PTRStatus.aspx?Action=U&PTRStatusID=" +StatusID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">PTR Status Search</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Search PTR Status</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                        <tr>
                                            ...
                                            <td>
                                                                    ...
                                                                    <asp:TextBox ID="txtPTRStatus" runat="server" CssClass="textbox" Width="208px" MaxLength="25" TabIndex="1"></asp:TextBox>
                                                                    </td>
                                                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="textbold" colspan="3" style="height: 26px">
                                                                                <asp:GridView EnableViewState="False" ID="gvPTRStatus" runat="server"  AutoGenerateColumns="False" TabIndex="6" Width="80%" AllowSorting="True">
                                                                                <Columns>
                                                                                   <asp:BoundField DataField="HD_PTR_STATUS_NAME" HeaderText="PTR Status" SortExpression="HD_PTR_STATUS_NAME" />
                                                                                   <asp:BoundField DataField="HD_PTR_STATUS_CLOSE" HeaderText="Close" SortExpression="HD_PTR_STATUS_CLOSE" />
                                                            ...
                                                            <asp:LinkButton ID="lnkEdit" runat="server" CommandName ="EditX" Text ="Edit" CssClass ="LinkButtons"></asp:LinkButton>&nbsp;
                                                               <asp:LinkButton ID="lnkDelete" runat="server" CommandName ="DeleteX" Text ="Delete" CssClass ="LinkButtons"></asp:LinkButton> 
                                                                ...
                                                                <asp:HiddenField ID="hdStatusID" runat="server" Value='<%#Eval("HD_PTR_STATUS_ID")%>' />   
                                                             </ItemTemplate>
                                                           </asp:TemplateField>
...
//     if(document.getElementById('<%=txtPTRStatus.ClientId%>').value !='')
//        {
//            var strValue = document.getElementById('<%=txtPTRStatus.ClientId%>').value
//            reg = new RegExp("^[a-zA-Z ]+$"); 

//            if(reg.test(strValue) == false) 
//            {
//                document.getElementById('<%=lblError.ClientId%>').innerHTML ='PTR status should contain only alphabets.'
//                return false;
...
//        }
    ...
    {
        document.getElementById('<%=txtPTRStatus.ClientId%>').value=''
