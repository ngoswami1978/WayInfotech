<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_WorkOrderAssignee.aspx.vb" Inherits="BOHelpDesk_HDSR_WorkOrderAssignee" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>AAMS::Back Office HelpDesk::Search Work Order Assignee</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(AssigneeID)
			{
				 window.location.href="BOHDUP_WorkOrderAssignee.aspx?Action=U&AssigneeID=" +AssigneeID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">Search Work Order Assignee</span></td>
                        </tr>
                        <tr>
