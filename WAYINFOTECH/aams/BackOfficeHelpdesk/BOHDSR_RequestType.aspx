<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_RequestType.aspx.vb" Inherits="BOHelpDesk_HDSR_RequestType" %>
...
<head runat="server">
     ...
     function  NewHDSRRequestType()
       {    
           window.location="BOHDUP_RequestType.aspx?Action=I";
           return false;
       }  
...
//         }   
    ...
    {                
          window.location ="BOHDUP_RequestType.aspx?Action=U&HD_RETYPE_ID=" + CheckBoxObj; 
          return false;
    }   
    </script>
      ...
      <table width="860px" align="left" class="border_rightred" >
            <tr>
                <td valign="top">
                    <table width="100%" >
                        <tr>
                            <td valign="top"  align="left" ><span class="menu">Back Office Help Desk-></span><span class="sub_menu">Request Type</span></td>
                        </tr>
                        <tr>
