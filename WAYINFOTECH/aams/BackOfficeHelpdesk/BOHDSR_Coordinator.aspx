<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_Coordinator.aspx.vb" Inherits="BOHelpDesk_MSSR_Coordinator" %>
...
<head id="Head1" runat="server">
   <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    ...
    {           
          window.location.href="BOHDUP_Coordinator.aspx?Action=U&Aoffice="+CoordinatorID+"&CoType="+CoordinatorID1;               
          return false;
    }
            ...
            <tr>
                <td class="top">
                    <table width="100%" class="left">
                        <tr>
                            <td   >
                            <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">Coordinator Search</span></td>
                        </tr>
                        <tr>
