<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_QueryCategory.aspx.vb" Inherits="BOHelpDesk_MSSR_QueryCategory" ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title>AAMS::Back Office HelpDesk::Search Query Category</title>
    ...
    function Edit(CategoryID)
			{
				 window.location.href="BOHDUP_QueryCategory.aspx?Action=U&QueryCategoryID=" +CategoryID
				 return false;
			}
...
//                var GroupID = document.getElementById('<%=drpSubGroup.ClientId%>').value         
//                window.location.href="HDSR_QueryCategory.aspx?Action=D&QueryCategoryID=" +CategoryID+"&CategoryName="+CategoryName+"&GroupID="+GroupID
...
<body>
    <form id="form1" runat="server" defaultfocus="txtCategory" defaultbutton="btnSearch">
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">Query Category Search</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Search Query Category</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                        <tr>
                                            ...
                                            <td>
                                                                    ...
                                                                    <asp:TextBox ID="txtCategory" runat="server" CssClass="textbold" Width="208px" MaxLength="30" TabIndex="1"></asp:TextBox></td>
                                                                            <td>
                                                                    <asp:Button ID="btnSearch" CssClass="button" runat="server" Text="Search" TabIndex="3" AccessKey="a" /></td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="textbold">
                                                                                Sub Group</td>
                                                                            <td style="width: 308px">
                                                                                <asp:DropDownList ID="drpSubGroup" runat="server" CssClass="dropdownlist"
                                                                                    TabIndex="4" Width="214px" onkeyup="gotop(this.id)">
                                                                                </asp:DropDownList></td>
                                                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" style="height: 26px">
                                                                                <asp:GridView EnableViewState="False" ID="gvCategory" runat="server"  AutoGenerateColumns="False" TabIndex="6" Width="80%" AllowSorting="True">
                                                                                <Columns>
                                                                                    <asp:BoundField DataField="CALL_SUB_GROUP_NAME" HeaderText="Sub Group" SortExpression="CALL_SUB_GROUP_NAME" />
                                                                                   <asp:BoundField DataField="CALL_CATEGORY_NAME" HeaderText="Category" SortExpression="CALL_CATEGORY_NAME" />
                                                            ...
                                                            <asp:LinkButton ID="lnkEdit" runat="server" CommandName ="EditX" Text ="Edit" CssClass ="LinkButtons"></asp:LinkButton>&nbsp;
                                                               <asp:LinkButton ID="lnkDelete" runat="server" CommandName ="DeleteX" Text ="Delete" CssClass ="LinkButtons"></asp:LinkButton> 
                                                                ...
                                                                <asp:HiddenField ID="hdCategoryID" runat="server" Value='<%#Eval("CALL_CATEGORY_ID")%>' />   
                                                             </ItemTemplate>
                                                           </asp:TemplateField>
    ...
    function ClearControls()
    {
        ...
        document.getElementById('<%=drpSubGroup.ClientId%>').selectedIndex=0
