<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOTCUP_QuerySubCategory.aspx.vb" Inherits="BOHelpDesk_Technical_MSUP_QuerySubCategory" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>AAMS::Back Office Technical::Manage Query Sub Category</title>
            ...
            <tr>
                <td class="top">
                    <table width="100%"  class="left">
                        <tr>
                            <td  >
                            <span class="menu">Back Office Technical-&gt;</span><span class="sub_menu">Query Sub Category </span></td>
                        </tr>
                        <tr>
