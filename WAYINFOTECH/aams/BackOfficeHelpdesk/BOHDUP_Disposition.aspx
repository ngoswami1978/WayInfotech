<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_Disposition.aspx.vb" Inherits="BOHelpDesk_MSUP_Disposition" ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>AAMS::Back Office HelpDesk::Manage Disposition</title>
    <link href="../CSS/AAMS.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="frmDisposition" runat="server" defaultbutton="btnSave">
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">Manage Disposition</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage Disposition</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="textbold">
                                                                                Disposition<span class="Mandatory" >*</span></td>
                                                                            <td style="width: 308px">
                                            <asp:TextBox ID="txtDisposition" runat="server" CssClass="textbox" MaxLength="25" TabIndex="1" Width="208px"></asp:TextBox></td>
                                                                            <td>
    ...
    function ValidateForm()
    {
     ...
     if(document.getElementById('<%=txtDisposition.ClientId%>').value =='')
        {
            document.getElementById('<%=lblError.ClientId%>').innerText='Disposition is mandatory.'
            document.getElementById('<%=txtDisposition.ClientId%>').focus();
            return false;
        }
//        else
//        {
