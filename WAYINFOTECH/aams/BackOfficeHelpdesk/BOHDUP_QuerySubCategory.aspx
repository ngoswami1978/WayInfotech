<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_QuerySubCategory.aspx.vb" Inherits="BOHelpDesk_HDUP_QuerySubCategory" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>AAMS::Back Office HelpDesk::Manage Query Sub Category</title>
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">Manage Query Sub Category</span></td>
                        </tr>
                        <tr>
