<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_PTRType.aspx.vb" Inherits="BOHelpDesk_HDUP_PTRType" %>
...
<head id="Head1" runat="server">
     ...
     function  NewHDUPPtrType()
       {    
           window.location="BOHDUP_PTRType.aspx?Action=I";
           return false;
       }  
      ...
      <table width="860px" align="left" class="border_rightred"  >
            <tr>
                <td valign="top">
                    <table width="100%" >
                        <tr>
                            <td valign="top"  align="left" ><span class="menu">Back Office Help Desk-></span><span class="sub_menu">PTR Type</span></td>
                        </tr>
                        <tr>
                                        ...
                                        <td  align ="left" class="redborder">                                 
                                                        <table width="100%" border="0"  cellpadding="0" cellspacing="0" >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width:16%;" class="textbold" ><span class="textbold">PTR Type</span><span class ="Mandatory">*</span> </td>
