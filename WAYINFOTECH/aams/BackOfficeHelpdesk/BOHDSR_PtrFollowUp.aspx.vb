...
Imports System.Xml
Partial Class BOHelpDesk_HDSR_PtrFollowUp
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Session("PageName") = "HelpDesk/HDSR_PtrFollowUp.aspx"
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO PTR Followup']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO PTR Followup']").Attributes("Value").Value)
    ...
    Private Sub HDPtrFollowup_Del(ByVal FollowupID As String)
        Dim objInputXml, objOutputXml As New XmlDocument
        Try
            Dim objhdFolloUp As New AAMS.bizBOHelpDesk.bzPTRFollowUp
