<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_HelpDeskFeedback.aspx.vb" Inherits="BOHelpDesk_HDSR_HelpDeskFeedback" MaintainScrollPositionOnPostback="true" %>
...
var type;
    ...
    if (id=="2")
    {
        ...
        {         
          ...
          {
          strStatus=Status;
          window.location.href="BOHDUP_CallLog.aspx?Action=U&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + strStatus + "&FeedBackId=" + FeedbackID + "&AOFFICE="+ AOFFICE + "&QueryGroup=" +strStatus ;               
          }
          else
          {strStatus=Status;      
          window.location.href="BOTCUP_CallLog.aspx?Action=U&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + strStatus + "&FeedBackId=" + FeedbackID + "&AOFFICE="+ AOFFICE + "&QueryGroup=" +strStatus ;               
          }
          return false;
        }
            ...
            <tr>
                <td class="top">
                    <table width="100%" class="left">
                        <tr>
                            <td   >
                            <span class="menu">Back Office HelpDesk -&gt;</span><span class="sub_menu">FeedBack Search</span></td>
                        </tr>
                        <tr>
