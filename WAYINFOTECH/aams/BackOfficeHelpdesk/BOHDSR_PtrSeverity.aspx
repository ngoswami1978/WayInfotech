<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_PtrSeverity.aspx.vb" Inherits="BOHelpDesk_HDSR_PtrSeverity" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Seach PTR Severity </title>
    <script src="../JavaScript/BOHelpDesk.js" type="text/javascript"></script>
    <link href="../CSS/AAMS.css" type="text/css" rel="stylesheet" />
</head>
<script language="javascript" type="text/javascript">
    function PTRSeverityReset()
    {
    
     document.getElementById("lblError").innerText=""
        document.getElementById("txtPTRSeverity").value=""; 
        if (document.getElementById("grdvPtrSeverity")!=null) 
        document.getElementById("grdvPtrSeverity").style.display ="none"; 
        return false;
    }
    function NewFunction()
    {  
        window.location.href="BOHDUP_PTRSeverity.aspx?Action=I";      
        return false;
    }  
      function EditFunction(PTRSeverityID)
    {    
        window.location.href="BOHDUP_PTRSeverity.aspx?Action=U&PTRSeverityID="+PTRSeverityID;      
        return false;
     }
    function DeleteFunction(PTRSeverityID)
    {  
        if (confirm("Are you sure you want to delete?")==true)
        {     
        document.getElementById("hdDeleteFlag").value=PTRSeverityID;
        }
        else
        {
...
<body>
    <form id="form1" runat="server" defaultfocus="txtPTRSeverity" defaultbutton="btnSearch">
                        ...
                        <table width="100%" align="left">
                            <tr>
                                <td valign="top" align="left">
                                    <span class="menu">Back Office Help Desk-><span class="sub_menu">PTR Severity</span><span style="font-size: 12pt"><span
                                                            ...
                                                            <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left" style="width: 10%">
                                                                        PTR Priority</td>
                                                                    <td style="width: 10%;">
                                                                    <asp:TextBox ID="txtPTRSeverity" runat="server" CssClass="textbold" TabIndex="1"
                                                                ...
                                                                <td></td>
                                                                    <td colspan="3" style="width:100%">
                                                                        <asp:GridView ID="grdvPtrSeverity" AllowSorting="true" HeaderStyle-ForeColor="white" BorderWidth="1" BorderColor="#d4d0c8" runat="server"
                                                                        AutoGenerateColumns="False" Width="58%" EnableViewState="false">
                                                                        <Columns>
                                                                            <asp:TemplateField SortExpression="HD_PTR_SEV_NAME" HeaderText="PTR Priority">
                                                                                <ItemTemplate>
                                                                                    <%#Eval("HD_PTR_SEV_NAME")%>
                                                                                </ItemTemplate>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Action">
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    ...
                                                                                    <asp:HiddenField ID="hdField" runat="server" Value='<%#Eval("HD_PTR_SEV_ID") %>' />
                                                                                </ItemTemplate>
