<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_IRSeverity.aspx.vb" Inherits="BOHelpDesk_HDSR_IRSeverity" %>
...
<script language="javascript" type="text/javascript">
    ...
    {    
        window.location.href="BOHDUP_IRSeverity.aspx?Action=U&IRSeverityID="+IRSeverityID;      
        return false;
     }
                        ...
                        <table width="100%" align="left">
                            <tr>
                                <td valign="top" align="left">
                                    <span class="menu">Back Office Help Desk-><span class="sub_menu">IR Severity</span><span style="font-size: 12pt"><span
