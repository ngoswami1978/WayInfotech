...
Imports System
Imports Excel
Partial Class BOHelpDesk_HDRPT_TechnicalReport
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                    If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO Technical Report']").Count <> 0 Then
                        strBuilderTechnical = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO Technical Report']").Attributes("Value").Value)
                    End If
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Try
            Response.Redirect("BOHDRPT_TechnicalReport.aspx", False)
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub printTechReport()
        ...
        If Session("LoginSession") IsNot Nothing Then
            ...
            objOutputXml = objbzDMReportConfiguration.TechnicalReport(objInputXml)
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                Session("BOTechReport") = objOutputXml.OuterXml
                Response.Redirect("../RPSR_ReportShow.aspx?Case=BOTechReport", False)
            Else
                lblError.Text = objOutputXml.DocumentElement.SelectSingleNode("Errors/Error").Attributes("Description").Value
            End If
