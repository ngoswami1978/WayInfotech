<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_IRSeverity.aspx.vb" Inherits="BOHelpDesk_HDUP_IRSeverity" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Manage IR Severity</title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        document.getElementById("lblError").innerHTML ="IR Severity name is mandatory.";
        return false;
        }
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">Back Office HelpDesk&gt;</span><span class="sub_menu">IR Severity</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage IR Severity</td>
                        </tr>
                        <tr>
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 22px; width: 149px;" class="textbold" nowrap="nowrap" >
                                                                    IR Severity<span class="Mandatory">* </span>
                                                                </td>
