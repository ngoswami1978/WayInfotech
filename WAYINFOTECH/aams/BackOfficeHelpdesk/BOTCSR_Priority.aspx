<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOTCSR_Priority.aspx.vb"
    Inherits="BOHelpDesk_Technical_MSSR_Priority" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>AAMS::Back OfficeTechnical::Search Priority</title>
    ...
    function Edit(PriorityID)
			{
				 window.location.href="BOTCUP_Priority.aspx?Action=U&PriorityID=" +PriorityID
				 return false;
			}
...
//                window.location.href="TCSR_Priority.aspx?Action=D&PriorityID=" +PriorityID+"&PriorityName="+Priority
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">Back Office Technical-&gt;</span><span class="sub_menu">Priority
                                    Search</span></td>
                        </tr>
                        <tr>
                                            ...
                                            <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 308px">
                                                        <asp:TextBox ID="txtPriority" runat="server" CssClass="textbox" Width="208px" MaxLength="25"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3" style="height: 26px">
                                                        <asp:GridView EnableViewState="False" ID="gvPriority" runat="server" AutoGenerateColumns="False"
                                                            TabIndex="6" Width="80%" AllowSorting="True">
                                                            <Columns>
                                                                <asp:BoundField DataField="HD_SEVERITY_NAME" HeaderText="Priority" SortExpression="HD_SEVERITY_NAME" />
