<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_IRTypeCategory.aspx.vb" Inherits="BOHelpDesk_HDUP_IRTypeCategory" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Manage IR Type Category</title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function validateIRCategory()
        {
         if(document.getElementById("txtIRTypeCat").value=='')
        {
        document.getElementById("txtIRTypeCat").focus();
        document.getElementById("lblError").innerHTML ="IR Type Category is Mandatory";
        return false;
        }
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">IR Type Category</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage IR Type Category</td>
                        </tr>
                        <tr>
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 22px; width: 149px;" class="textbold" nowrap="nowrap" >
                                                                    IR Type Category<span class="Mandatory">* </span>
                                                                </td>
                                                                <td height="22px" style="width: 195px" class="textbold" nowrap="nowrap" >
                                                                    &nbsp;<asp:TextBox ID="txtIRTypeCat" runat="server" CssClass="textbold" TabIndex="1" MaxLength="25" Width="176px" ></asp:TextBox>
                                                                </td>
