...
Imports System.Xml
Partial Class BOHelpDesk_HDSR_IRAssignee
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO IR Assignee']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO IR Assignee']").Attributes("Value").Value)
    ...
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Try
            Response.Redirect("BOHDUP_IRAssignee.aspx?Action=I", False)
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
    ...
    Private Sub HDIRAssignee_Search()
        ...
        Try
            Dim objbzAssignee As New AAMS.bizBOHelpDesk.bzIRAssignee
    ...
    Private Sub HDIRAssignee_Del(ByVal AssingeeID As String)
        Dim objInputXml, objOutputXml As New XmlDocument
        Try
            Dim objhdAssignee As New AAMS.bizBOHelpDesk.bzIRAssignee
    ...
    Protected Sub grdvIRAssignee_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdvIRAssignee.RowDataBound
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                ...
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='IR Assignee']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='IR Assignee']").Attributes("Value").Value)
