<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_WorkOrder.aspx.vb" Inherits="BOHelpDesk_HDSR_WorkOrder" MaintainScrollPositionOnPostback="true" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title>AAMS::Back Office HelpDesk::Search Work Order</title>
...
function PopupEmployeePage()
{
 ...
 function Edit(OrderID)
			{
				 window.location.href="BOHDUP_WorkOrder.aspx?Action=U&OrderID=" +OrderID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">Work Order Search</span></td>
                        </tr>
                        <tr>
...
<td class="redborder top">
 <asp:GridView ID="gvOrder" runat="server" Width="1500px"  AutoGenerateColumns="False" TabIndex="19"  EnableViewState="False" AllowSorting="True" >
           <Columns>
             ...
             <ItemTemplate>
             <div id="lblOrderTitle" runat="server" >
             <%# Eval("WO_TITLE") %>
             </div>
             </ItemTemplate>
                   <ItemStyle Width="200px" Wrap="True" />
             ...
             <ItemTemplate>
             <div id="lblOrderType" runat="server">
             <%# Eval("WO_TYPE_NAME") %>
             </div>
             </ItemTemplate>
                   <ItemStyle Width="100px" Wrap="True" />
