<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_IRAssignee.aspx.vb" Inherits="BOHelpDesk_HDSR_IRAssignee" %>
...
<head id="Head1" runat="server">
   ...
   {           
          window.location.href="BOHDUP_IRAssignee.aspx?Action=U|"+CheckBoxObj;               
          return false;
    }
        function InsertIRAssignee()
        {
       window.location.href="BOHDUP_IRAssignee.aspx?Action=I|";
        return false;
        }
                        ...
                        <table width="100%" align="left">
                            <tr>
                                <td valign="top" align="left">
                                    <span class="menu">Back Office Help Desk-><span class="IR_menu">IR Assignee</span><span style="font-size: 12pt;
