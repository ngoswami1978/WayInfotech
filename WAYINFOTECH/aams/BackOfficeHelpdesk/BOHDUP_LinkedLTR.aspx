<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_LinkedLTR.aspx.vb" Inherits="BOHelpDesk_HDUP_LinkedLTR" ValidateRequest="false" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
     function DeleteFunction(HD_RE_ID)
        ...
        {     
          var type="BOHDUP_CallLog.aspx?Action=U&LCode="+LCode +"&HD_RE_ID="+ HD_RE_ID + "&strStatus=" + strStatus + "&Popup=T";               
    ...
    type ="BOHDSR_CallLog.aspx?Popup=T&strStatus="+ document.getElementById("hdEnFunctional").value+"&LCodeMuk="+ LCode + "&HD_RE_IDMuk=" + HD_RE_ID  ;
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="top left" style="width:80%">
                                            <span class="menu">Back Office HelpDesk-></span><span class="sub_menu">Linked LTR</span>
                                        </td>
