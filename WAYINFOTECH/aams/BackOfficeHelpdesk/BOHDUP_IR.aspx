<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_IR.aspx.vb" Inherits="BOHelpDesk_HDUP_IR" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Back Office HelpDesk: IR</title>
  ...
  function  ShowAssigneeHis()
  {
      ...
      if (hdIRsID !="")
      {
           ...
           var type="../Popup/PUSR_BOIRAssigneeHistory.aspx?AssigneeID="+hdIRsID
      ...
      function  ShowIRHistory()
  {
      ...
      if (IRsID !="")
      {
           var type="../Popup/PUSR_BOIRHistory.aspx?IRID="+IRsID
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td valign="top" align="left">
                                            <span class="menu">Back Office HelpDesk-></span><span class="sub_menu">IR</span>
                                        </td>
                                        <td class="right">
