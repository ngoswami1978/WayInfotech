<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOTCSR_QueryStatus.aspx.vb" Inherits="BOHelpDesk_Technical_MSSR_QueryStatus" %>
...
<link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <title>AAMS::Back Office Technical::Search Query Status</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(StatusID)
			{
				 window.location.href="BOTCUP_QueryStatus.aspx?Action=U&QueryStatusID=" +StatusID
				 return false;
			}
...
//                window.location.href="TCSR_QueryStatus.aspx?Action=D&QueryStatusID=" +StatusID+"&StatusName="+StatusName	
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Back Office Technical-&gt;</span><span class="sub_menu">Query Status Search</span></td>
                        </tr>
                        <tr>
