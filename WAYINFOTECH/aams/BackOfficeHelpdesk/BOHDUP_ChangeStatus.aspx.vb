...
Partial Class BOBirdresHelpDesk_HDUP_ChangeStatus
            ...
            If Not Page.IsPostBack Then
                ...
                If Request.QueryString("QueryGroup") IsNot Nothing Then
                    If Request.QueryString("QueryGroup").ToString.ToUpper = "FUNCTIONAL" Then
                        objeAAMS.BindDropDown(ddlStatus, "BOQueryStatusWithClosed", True, 1)
                    Else
                        objeAAMS.BindDropDown(ddlStatus, "BOTSTATUSWITHCLOSED", True, 1)
                    End If
                End If
            End If
