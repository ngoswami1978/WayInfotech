<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_PtrAssignee.aspx.vb" Inherits="BOHelpDesk_HDSR_PtrAssignee" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Search PTR Assignee</title>
   ...
   {           
          window.location.href="BOHDUP_PtrAssignee.aspx?Action=U|"+CheckBoxObj;               
          return false;
    }
        function InsertPtrAssignee()
        {
       window.location.href="BOHDUP_PtrAssignee.aspx?Action=I|";
        return false;
        }
...
//        {   
//        
//          window.location.href="HDSR_PtrAssignee.aspx?Action=D|"+ PtrID + "|"+ document.getElementById("<%=txtAssigneeName.ClientID%>").value;                    
//          return false;
//        }
//    }
...
//        document.getElementById("txtAssigneeName").value=""; 
//        if (document.getElementById("grdvPtrAssignee")!=null) 
//        document.getElementById("grdvPtrAssignee").style.display ="none"; 
                        ...
                        <table width="100%" align="left">
                            <tr>
                                <td valign="top" align="left">
                                    <span class="menu">Back Office Help Desk-><span class="sub_menu">PTR Assignee</span><span style="font-size: 12pt;
                                        font-family: Times New Roman">&nbsp;</span><span class="sub_menu"></span><span style="font-size: 12pt;
                                                            ...
                                                            <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                                                                ...
                                                                <tr >
                                                                    <td colspan="4" style="width:100%">
                                                                        &nbsp;<asp:GridView ID="grdvPtrAssignee" AllowSorting="true" HeaderStyle-ForeColor="white" BorderWidth="1" BorderColor="#d4d0c8" runat="server"
                                                                                AutoGenerateColumns="False" EnableViewState="false" Width="816px">
                                                                              <Columns>
                                                                                    <asp:TemplateField SortExpression="ASSIGNEE_NAME" HeaderText="PTR Assignee Name">
                                                                                        <itemtemplate>
                                                                                           <%#Eval("ASSIGNEE_NAME")%> 
                                                                                    </itemtemplate>
