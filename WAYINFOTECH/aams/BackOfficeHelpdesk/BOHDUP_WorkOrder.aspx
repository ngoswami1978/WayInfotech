<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_WorkOrder.aspx.vb" Inherits="BOHelpDesk_HDUP_WorkOrder" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>AAMS::Back Office HelpDesk::Manage Work Order</title>
...
//  var hdPtrsID=document.getElementById("hdOrderID").value.trim();
   ...
   var type="../Popup/PUSR_BOAssigneeHistory.aspx?WO_Number="+hdPtrsID
  ...
  var ptrsID=document.getElementById("hdHistoryOrderID").value.trim();
   ...
   var type="../Popup/PUSR_BOEmployeeHistory.aspx?WO_Number="+ptrsID
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">Manage Work Order</span></td>
