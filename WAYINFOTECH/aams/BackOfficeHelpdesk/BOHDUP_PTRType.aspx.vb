...
Imports System.Data
#End Region
Partial Class BOHelpDesk_HDUP_PTRType
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                '*******************************************************************
                ''Code For 
                objeAAMS.BindDropDown(drpCatName, "BOHDPTRTYPECAT", True)
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO PTR Type']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO PTR Type']").Attributes("Value").Value)
    ...
    Sub ViewPtrType()
        Try
            If (Not Request.QueryString("Action") = Nothing) Then
                ...
                Dim objbzPTRType As New AAMS.bizBOHelpDesk.bzPTRType
                ...
                If (Not Request.QueryString("Action") = Nothing) Then
                    ...
                    If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                        If (Request.QueryString("Action") = "U") Then
                            ...
                            Response.Redirect("BOHDUP_PTRType.aspx?&Msg=U&Action=U&HD_PTR_TYPE_ID=" & objED.Encrypt(objOutputXml.DocumentElement.SelectSingleNode("PTR_TYPE").Attributes("HD_PTR_TYPE_ID").Value.Trim), False)
                        Else
                            lblError.Text = objeAAMSMessage.messInsert '"Record added successfully."
                            Response.Redirect("BOHDUP_PTRType.aspx?&Msg=A&Action=U&HD_PTR_TYPE_ID=" & objED.Encrypt(objOutputXml.DocumentElement.SelectSingleNode("PTR_TYPE").Attributes("HD_PTR_TYPE_ID").Value.Trim), False)
                        End If
                    Else
