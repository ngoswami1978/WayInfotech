<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_Feedback.aspx.vb" Inherits="BOHelpDesk_HDSR_Feedback" %>
...
<title></title>
  ...
  function PopupAgencyPage()
   ...
   {           
          window.location.href="BOHDUP_Feedback.aspx?Action=U|"+CheckBoxObj;               
          return false;
    }
     ...
     <table style="width:845px" align="left" class="border_rightred" >
            <tr>
                <td valign="top"  style="width:860px;">
                    <table width="100%" >
                        <tr>
                            <td valign="top"  align="left" ><span class="menu">Back Office Help Desk-></span><span class="sub_menu">Feedback</span></td>
                        </tr>
                        <tr>
