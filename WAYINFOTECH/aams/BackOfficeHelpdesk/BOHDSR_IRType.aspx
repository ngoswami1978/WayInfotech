<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_IRType.aspx.vb" Inherits="BOHelpDesk_HDSR_IRType" %>
...
<head id="Head1" runat="server">
    ...
    {                
          window.location ="BOHDUP_IRType.aspx?Action=U&HD_IR_TYPE_ID=" + CheckBoxObj; 
          return false;
    } 
      ...
      <table width="860px" align="left" class="border_rightred" >
            <tr>
                <td valign="top">
                    <table width="100%" >
                        <tr>
                            <td valign="top"  align="left" ><span class="menu">Back Office Help Desk-></span><span class="sub_menu">IR Type</span></td>
                        </tr>
                        <tr>
