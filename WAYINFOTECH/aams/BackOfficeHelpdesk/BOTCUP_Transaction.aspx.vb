...
Partial Class BOHelpDesk_TCUP_Transaction
        ...
        Try
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                If ds.Tables("REQUEST_ASSIGNEE").Rows.Count <> 0 Then
                    ...
                    '        Select Case ViewState("Desc")
                    '            Case "FALSE"
                    '                gvTransaction.HeaderRow.Cells(3).Controls.Add(imgUp)
                    '            Case "TRUE"
                    '                gvTransaction.HeaderRow.Cells(3).Controls.Add(imgDown)
                    '        End Select
                    'End Select

                    SetImageForSorting(gvTransaction)
            ...
            Else
                ...
                Else
                    ...
                    Dim dc4 As New DataColumn("LeftDateTime", GetType(String))
                    Dim dr As DataRow
                    dt.Columns.Add(dc)
                    dt.Columns.Add(dc1)
                    dt.Columns.Add(dc2)
