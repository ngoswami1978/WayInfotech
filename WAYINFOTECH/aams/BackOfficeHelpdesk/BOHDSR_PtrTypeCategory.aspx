<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_PtrTypeCategory.aspx.vb" Inherits="BOHelpDesk_HDSR_PtrTypeCategory" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Search PTR Type Category</title>
   ...
   {           
          window.location.href="BOHDUP_PtrTypeCategory.aspx?Action=U|"+CheckBoxObj;               
          return false;
    }
                        ...
                        <table width="100%" align="left">
                            <tr>
                                <td valign="top" align="left">
                                    <span class="menu">Back Office Help Desk-></span><span class="sub_menu">PTR Type Category</span>
                                </td>
                            </tr>
                            <tr>
                                <tr>
