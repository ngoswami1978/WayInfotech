...
Partial Class BOHelpDesk_HDSR_QuestionSet
    ...
    Private Sub QuestionSearch()
        ...
        Dim objbzQ As New AAMS.bizBOHelpDesk.bzFeedbackSet
    ...
    Private Sub QuestionDelete(ByVal QID As String)
        Dim objInputXml, objOutputXml As New XmlDocument
        Dim objbzDq As New AAMS.bizBOHelpDesk.bzFeedbackSet
        Try
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Response.Redirect("BOHDSR_QuestionSet.aspx")
    End Sub
