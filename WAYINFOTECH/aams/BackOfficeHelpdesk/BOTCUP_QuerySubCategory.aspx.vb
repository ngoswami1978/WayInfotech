...
Partial Class BOHelpDesk_Technical_MSUP_QuerySubCategory
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            '<HD_UPDATECALLSUBCATEGORY_INPUT>
            '	<CALL_SUB_CATEGORY CALL_SUB_CATEGORY_ID='' CALL_SUB_CATEGORY_NAME='' CALL_CATEGORY_ID='' />
            '</HD_UPDATECALLSUBCATEGORY_INPUT>
            ' objInputXml.LoadXml("<MS_UPDATE_CALLCATEGORY_INPUT><DETAILS ACTION='' CALL_SUB_CATEGORY_ID='' CALL_SUB_CATEGORY_NAME='' CALL_CATEGORY_ID='' CALL_SUB_GROUP_ID='' HD_QUERY_GROUP_ID=''/></MS_UPDATE_CALLCATEGORY_INPUT>")
            objInputXml.LoadXml("<HD_UPDATECALLSUBCATEGORY_INPUT><CALL_SUB_CATEGORY CALL_SUB_CATEGORY_ID='' CALL_SUB_CATEGORY_NAME='' CALL_CATEGORY_ID='' DESC='' /></HD_UPDATECALLSUBCATEGORY_INPUT>")
            ...
            End If
            ' objInputXml.DocumentElement.SelectSingleNode("CALL_SUB_CATEGORY").Attributes("CALL_SUB_GROUP_ID").Value = ddlQuerySubGroup.SelectedValue
            ...
            End If
            objInputXml.DocumentElement.SelectSingleNode("CALL_SUB_CATEGORY").Attributes("DESC").InnerText = txtDesc.Text
    ...
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Response.Redirect("BOTCUP_QuerySubCategory.aspx?Action=I|")
    End Sub
    ...
    Sub ViewRecords()
        ...
        If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
            ...
            ddlCategoryName.Enabled = False
            ddlQuerySubGroup.Enabled = False
            If objOutputXml.DocumentElement.SelectSingleNode("CALL_SUB_CATEGORY").Attributes("DESC") IsNot Nothing Then
                txtDesc.Text = objOutputXml.DocumentElement.SelectSingleNode("CALL_SUB_CATEGORY").Attributes("DESC").InnerText()
            End If
        Else
            lblError.Text = objOutputXml.DocumentElement.SelectSingleNode("Errors/Error").Attributes("Description").Value
        End If
    ...
    '    objInputXml.LoadXml("<MS_SEARCH_CALLCATEGORY_INPUT>	<CALL_CATEGORY_NAME/>	<CALL_SUB_GROUP_ID/></MS_SEARCH_CALLCATEGORY_INPUT>")
    ...
    '        ddlCategoryName.DataSource = ds.Tables("DETAILS")
    ...
    Private Sub CheckSecurity()
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO Tech Query SubCategory']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO Tech Query SubCategory']").Attributes("Value").Value)
                End If
