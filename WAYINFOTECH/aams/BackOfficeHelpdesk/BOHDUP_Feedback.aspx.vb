...
Partial Class BOHelpDesk_HDUP_Feedback
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            If (Not Request.QueryString("Action") = Nothing) Then
                ...
                Dim objhdPtrSave As New AAMS.bizBOHelpDesk.bzFeedback
                ...
                If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                    ...
                    Else
                        ...
                        Response.Redirect("BOHDUP_Feedback.aspx?Action=US|" & objOutputXml.DocumentElement.SelectSingleNode("FEEDBACK").Attributes("FEEDBACK_ID").Value, False)
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Try
            If (Request.QueryString("Action").ToString().Split("|").GetValue(0).ToString().ToUpper() = "U") Or (Request.QueryString("Action").ToString().Split("|").GetValue(0).ToString().ToUpper() = "US") Then
                Response.Redirect("BOHDUP_Feedback.aspx?Action=U|" + Request.QueryString("Action").ToString().Split("|").GetValue(1).ToString())
            Else
                Response.Redirect("BOHDUP_Feedback.aspx?Action=I|")
            End If
        Catch ex As Exception
