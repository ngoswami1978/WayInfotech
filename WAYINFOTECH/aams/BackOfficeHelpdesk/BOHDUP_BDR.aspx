<%@ Page Language="VB" ValidateRequest="false" AutoEventWireup="false" CodeFile="BOHDUP_BDR.aspx.vb"
    Inherits="BOHelpDesk_HDUP_BDR"  EnableEventValidation="false" %>
  ...
  // Written for showing History Page
    ...
    { 
        ...
        // var BDRValue=objBdrId;
         ...
         var type="../Popup/PUSR_BOBDRHistory.aspx?BDRId=" + BDRValue; 
                    ...
                    <table width="100%">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">Back Office Help Desk-></span><span class="sub_menu">BDR</span></td>
                            <td class="right">
