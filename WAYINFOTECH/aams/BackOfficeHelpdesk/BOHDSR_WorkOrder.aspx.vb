...
Partial Class BOHelpDesk_HDSR_WorkOrder
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                objeAAMS.BindDropDown(drpOrderType, "BOWorkOrderType", True, 3)
                objeAAMS.BindDropDown(drpFollowUp, "BOWorkOrderFollowUp", True, 3)
                objeAAMS.BindDropDown(drpSeverity, "BOWorkOrderSeverity", True, 3)
                objeAAMS.BindDropDown(drpAssignedTo, "BOWorkOrderAssignee", True, 3)
                objeAAMS.BindDropDown(drpAoffice, "AOFFICE", True, 3)
                'objeAAMS.BindDropDown(drpStatus, "QueryStatus", True, 3)
                objeAAMS.BindDropDown(drpStatus, "BOHDPTRSTATUS", True, 3)
