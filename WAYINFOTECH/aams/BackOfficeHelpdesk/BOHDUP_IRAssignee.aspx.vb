...
Imports System.Xml
Partial Class BOHelpDesk_HDUP_IRAssignee
            ...
            Try
                If (Not Request.QueryString("Action") = Nothing) Then
                    ...
                    If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                        ...
                        Else
                            Response.Redirect("BOHDUP_IRAssignee.aspx?Action=US|" & objED.Encrypt(objOutputXml.DocumentElement.SelectSingleNode("IR_ASSIGNEE").Attributes("ASSIGNEEID").Value), False)
