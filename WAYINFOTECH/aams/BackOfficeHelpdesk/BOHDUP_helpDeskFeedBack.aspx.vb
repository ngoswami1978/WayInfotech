...
Partial Class BOHelpDesk_HDUP_helpDeskFeedBack
    ...
    Sub FillDropDownList()
        Try
            ...
            objeAAMS.BindDropDown(ddlHelpDeskAction, "BOFEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlTechnicalHelpDeskAction, "BOFEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlSalesHelpDeskAction, "BOFEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlTrainingHelpDeskAction, "BOFEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlProductHelpDeskAction, "BOFEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlCustomerFeedbackAction, "BOFEEDBACKSTATUS", True, 1)
    ...
    Protected Sub grdvFeedback_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdvFeedback.RowDataBound
        ...
        Try
            ...
            objeAAMS.BindDropDown(drpQuestStatus, "BOHDQUESTIONSTATUS", True)
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Try
            ...
            If hdFeedBackId.Value <> "" Then
                ...
                End If
            Else
                Response.Redirect("BOHDUP_helpDeskFeedBack.aspx?" + Request.QueryString.ToString)
            End If
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
