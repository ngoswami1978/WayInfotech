<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_Priority.aspx.vb" Inherits="BOHelpDesk_MSSR_Priority" ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title>AAMS::Back Office HelpDesk::Search Priority</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(PriorityID)
			{
				 window.location.href="BOHDUP_Priority.aspx?Action=U&PriorityID=" +PriorityID
				 return false;
			}
	...
	function Delete(PriorityID)
	{
		 ...
		 if (confirm("Are you sure you want to delete?")==true)
            {    
//                var Priority = document.getElementById('<%=txtPriority.ClientId%>').value      
//                window.location.href="HDSR_Priority.aspx?Action=D&PriorityID=" +PriorityID+"&PriorityName="+Priority
		        
		        document.getElementById('<%=hdID.ClientId%>').value  =PriorityID
                return true;
            }
            return false;
	}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">Priority Search</span></td>
                        </tr>
                        <tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                                                ...
                                                                <asp:Label ID="lblError" runat="server" CssClass="ErrorMsg" EnableViewState="False"></asp:Label></td>
                                                                    ...
                                                                    <asp:TextBox ID="txtPriority" runat="server" CssClass="textbox" Width="208px" MaxLength="25" TabIndex="1"></asp:TextBox>
                                                                    </td>
                                                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" style="height: 26px">
                                                                                <asp:GridView EnableViewState="False" ID="gvPriority" runat="server"  AutoGenerateColumns="False" TabIndex="6" Width="80%" AllowSorting="True">
                                                                                <Columns>
                                                                                   <asp:BoundField DataField="HD_SEVERITY_NAME" HeaderText="Priority" SortExpression="HD_SEVERITY_NAME" ItemStyle-Width="60%" />
                                                            ...
                                                            <asp:LinkButton ID="lnkEdit" runat="server" CommandName ="EditX" Text ="Edit" CssClass ="LinkButtons"></asp:LinkButton>&nbsp;
                                                               <asp:LinkButton ID="lnkDelete" runat="server" CommandName ="DeleteX" Text ="Delete" CssClass ="LinkButtons"></asp:LinkButton> 
                                                                ...
                                                                <asp:HiddenField ID="hdPriorityID" runat="server" Value='<%#Eval("HD_SEVERITY_ID")%>' />   
                                                             </ItemTemplate>
                                                           </asp:TemplateField>
