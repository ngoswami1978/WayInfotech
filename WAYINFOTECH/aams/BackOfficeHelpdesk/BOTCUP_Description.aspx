<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOTCUP_Description.aspx.vb" Inherits="BOHelpDesk_HDUP_Description" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>AAMS::Back Office Technical::Manage Description</title>
...
{   
       ...
       {   
           ...
           {
           window.location.href="BOTCUP_CallLog.aspx?Action="+pgStatus + "&LCode=" + strLCode ;
           }
           return false;
       }       
       ...
       {   
           ...
           {
           window.location.href="BOTCUP_Description.aspx?Action="+pgStatus + "&LCode=" + strLCode ;
           }
       ...
       else if (id == (ctextFront +  "02" + ctextBack))
       {
           ...
           {
           window.location.href="BOTCUP_Solution.aspx?Action="+pgStatus + "&LCode=" + strLCode ;
           }
                        ...
                        <tr>
                            <td class="top">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="top left">
                                            <span class="menu">Back Office Technical-></span><span class="sub_menu">Description</span></td>
                                    </tr>
                                    <tr>
