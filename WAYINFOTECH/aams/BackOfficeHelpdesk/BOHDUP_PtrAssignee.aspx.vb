...
Imports System.Xml
Partial Class BOHelpDesk_HDUP_PtrAssignee
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO PTR Assignee']").Count <> 0 Then
                    strBuilder = eaamsObj.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO PTR Assignee']").Attributes("Value").Value)
        ...
        Try
            Try
                If (Not Request.QueryString("Action") = Nothing) Then
                    ...
                    Dim objhdAssignee As New AAMS.bizBOHelpDesk.bzPTRAssignee
                    ...
                    If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                        ...
                        Else
                            Response.Redirect("BOHDUP_PtrAssignee.aspx?Action=US|" & objED.Encrypt(objOutputXml.DocumentElement.SelectSingleNode("PTR_ASSIGNEE").Attributes("ASSIGNEEID").Value), False)
