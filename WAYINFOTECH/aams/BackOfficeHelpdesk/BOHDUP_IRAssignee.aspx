<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_IRAssignee.aspx.vb" Inherits="BOHelpDesk_HDUP_IRAssignee" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Manage IR Assignee</title>
    ...
    <script type="text/javascript" language="javascript">
     ...
     function InsertIRAssignee()
        ...
        document.getElementById("lblError").innerHTML ="IR assignee name is mandatory.";
        return false;
        }
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">Back Office HelpDesk&gt;</span><span class="sub_menu">IR Assignee</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage IR Assignee </td>
                        </tr>
                        <tr>
