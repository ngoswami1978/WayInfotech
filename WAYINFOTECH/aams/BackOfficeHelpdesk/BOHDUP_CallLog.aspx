<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_CallLog.aspx.vb" Inherits="BOHelpDesk_HDUP_CallLog"
...
<head id="Head1" runat="server">
    <title>AAMS::Back Office HelpDesk::Manage Call Log</title>
...
function CallLogDescription(fr,hd_re_id,rowid)
    ...
    //alert(rowid);    
    var type;    
    type ="../Popup/PUUP_BOHDDescSolution.aspx?fr="+ fr +"&hd_re_id="+hd_re_id + "&ID="+rowid;	
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="top left" style="width: 80%">
                                            <span class="menu">Back Office HelpDesk-></span><span class="sub_menu">Call Log</span>
                                        </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <div id="dvAutoPopulate" runat="server" style="position: absolute;background-color:Green">
                                                                                    ...
                                                                                    <asp:TextBox ID="txtCallerName" runat="server" Width="168px" MaxLength="50" TabIndex="2"
                                                                                        CssClass="TextTitleCase" onkeypress="allTextWithSpace();" onkeyup="populateDiv()"></asp:TextBox><img id="Img1" runat="server" tabindex="2" alt="Select & Add Caller Name" onclick="PopupPageFunctional(2)"
    ...
    //	        
             ...
             var strIRNo=document.getElementById("txtIRNumber").value;
                    ...
                    {                 
                            ...
                            {
                                IRtype = "BOHDUP_IR.aspx?Popup=T&Action=I&ReqID="+IRstrHD_RE_ID + "&LCode="+strIRLCode;
   	                        ...
   	                        else
   	                        {
   	                            ...
   	                            IRtype = "BOHDUP_IR.aspx?Popup=T&Action=" + IRstrAction + "&ReqID="+IRstrHD_RE_ID + "&LCode="+strIRLCode ;
   	                            window.open(IRtype,"aaHelpDeskIR","height=600,width=900,top=30,left=20,scrollbars=1,status=1");
   	                        }   	               
   	                } 
   	                else
