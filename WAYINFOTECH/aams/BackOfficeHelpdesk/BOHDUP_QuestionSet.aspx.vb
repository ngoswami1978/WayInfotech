Imports System.Data
Imports System.Xml
Partial Class BOHelpDesk_HDUP_QuestionSet
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO Feedback Questionset']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO Feedback Questionset']").Attributes("Value").Value)
    ...
    Private Sub QuestionView()
        Try
            Dim objViewQ As New AAMS.bizBOHelpDesk.bzFeedbackSet
            Dim ds As New DataSet
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            Dim objQuesSave As New AAMS.bizBOHelpDesk.bzFeedbackSet
            Dim ds As New DataSet
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                Else
                    lblError.Text = objeAAMSMessage.messInsert
                    Response.Redirect("BOHDUP_QuestionSet.aspx?Action=US&SetID=" + objED.Encrypt(CheckBoxOb))
    ...
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Try
            Response.Redirect("BOHDUP_QuestionSet.aspx?Action=I")
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
    End Sub
