...
Partial Class BOHelpDesk_HDUP_Solution
    ...
    Sub BindData()
        ...
        Try
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                Else
                    gvSolution.DataSource = String.Empty
                    gvSolution.DataBind()
                End If
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            Dim objCall As New AAMS.bizBOHelpDesk.bzCall
            ' Load Input Xml.
            objInputXml.LoadXml("<HD_UPDATEREQUESTSOLUTION_INPUT><REQUESTSOLUTION HD_RE_ID='' EmployeeID='' ACTION_TAKEN='' DATETIME=''/></HD_UPDATEREQUESTSOLUTION_INPUT>")
            objInputXml.DocumentElement.SelectSingleNode("REQUESTSOLUTION").Attributes("HD_RE_ID").Value = hdPageHD_RE_ID.Value
            objInputXml.DocumentElement.SelectSingleNode("REQUESTSOLUTION").Attributes("EmployeeID").Value = Session("LoginSession").ToString().Split("|")(0)
            objInputXml.DocumentElement.SelectSingleNode("REQUESTSOLUTION").Attributes("ACTION_TAKEN").Value = txtSolution.Text
            objInputXml.DocumentElement.SelectSingleNode("REQUESTSOLUTION").Attributes("DATETIME").Value = ""

            ' Calling update method for update.
            objOutputXml = objCall.SaveRequestSolution(objInputXml)
