...
Imports System.Xml
Partial Class BOHelpDesk_HDUP_PtrFollowUp
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO PTR Followup']").Count <> 0 Then
                    strBuilder = eaamsObj.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO PTR Followup']").Attributes("Value").Value)
            ...
            Try
                If (Not Request.QueryString("Action") = Nothing) Then
                    ...
                    If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                        ...
                        Else
                            Response.Redirect("BOHDUP_PtrFollowUp.aspx?Action=US|" & objED.Encrypt(objOutputXml.DocumentElement.SelectSingleNode("PTR_FOLLOWUP").Attributes("HD_PTR_FOLLOWUP_ID").Value.Trim), False)
                            lblError.Text = objeAAMSMessage.messInsert
                        End If
                    Else
    ...
    Private Sub ViewFollowUp()
        Try
            ...
            Dim objhFollowup As New AAMS.bizBOHelpDesk.bzPTRFollowUp
