<%@ Page Language="VB"  EnableEventValidation ="false"  AutoEventWireup="false" CodeFile="BOHDSR_HelpDeskFeedBackReport.aspx.vb" Inherits="BOHelpDesk_HDSR_HelpDeskFeedBackReport" MaintainScrollPositionOnPostback="true" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
   <title>AAMS::Back Office HelpDesk::Search FeedBack</title>
...
<body>
            ...
            <tr>
                <td valign="top">
                     <table width="100%" class="left">
                        <tr>
                            <td   >
                            <span class="menu"> Back Office HelpDesk -&gt;</span><span class="sub_menu">FeedBack Report Search</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td >
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="redborder center" style="height: 360px">
                            ...
                            <img id="imgDateTo" alt="" TabIndex="2" src="../Images/calender.gif"  title="Date selector" style="cursor: pointer" /><script type="text/javascript">
                                        ...
                                        <tr>
                                            ...
                                            <td class="textbold">
                                                Feedback Dept.</td>
                                            <td>
                                                <asp:DropDownList ID="drpFeedbackDept" runat="server" CssClass="dropdownlist" onkeyup="gotop(this.id)"
    ...
    <tr><td class="top" style="height: 225px" >
<table width="100%">
 ...
 <asp:GridView ID="gvOrder" runat="server" Width="3500px"  AutoGenerateColumns="False" TabIndex="19"  EnableViewState="False"  AllowSorting="True" >
           <Columns>
              ...
              <asp:BoundField HeaderText="Suggestion For Products" DataField="SUGGESTION_PRODUCT" SortExpression="SUGGESTION_PRODUCT" >
               ...
               <asp:BoundField HeaderText="Suggestion For Corp. Comm." DataField="SUGGESTION_CCOMMUNICATION" SortExpression="SUGGESTION_CCOMMUNICATION" >
                  <ItemStyle Width="2.5%" />
              </asp:BoundField>
              ...
              <asp:BoundField HeaderText="Corp. Comm. Action Taken" DataField="ACTIONTAKEN_CCOMMUNICATION" SortExpression="ACTIONTAKEN_CCOMMUNICATION" >
                  <ItemStyle Width="2.5%" />
              </asp:BoundField>
              
              
              <asp:BoundField HeaderText="Helpdesk Status" DataField="STATUS_HELPDESK" SortExpression="STATUS_HELPDESK" >
                  <ItemStyle Width="1.67%" />
              </asp:BoundField>
             ...
             <asp:BoundField HeaderText="Sales Status" DataField="STATUS_SALES" SortExpression="STATUS_SALES" >
              ...
              <asp:BoundField HeaderText="Corp. Comm. Status" DataField="STATUS_CCOMMUNICATION" SortExpression="STATUS_CCOMMUNICATION" >
                  <ItemStyle Width="1.67%" />
              </asp:BoundField>
             ...
             <asp:BoundField HeaderText="Assigned To(Sales)" DataField="ASSIGNEDTO_SALES" SortExpression="ASSIGNEDTO_SALES" >
              ...
              <asp:BoundField HeaderText="Assigned To(Corp. Comm.)" DataField="ASSIGNEDTO_CCOMMUNICATION" SortExpression="ASSIGNEDTO_CCOMMUNICATION" >
                  <ItemStyle Width="2.5%" />
              </asp:BoundField>              
