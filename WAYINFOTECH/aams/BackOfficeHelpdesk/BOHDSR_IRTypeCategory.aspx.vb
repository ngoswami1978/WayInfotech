...
Imports System.Xml
Partial Class BOHelpDesk_HDSR_IRTypeCategory
    ...
    Private Sub DeleteIRType_Cat(ByVal IRTypeCatID As String)
        ...
        Try
            Dim objhdIRTypeCat As New AAMS.bizBOHelpDesk.bzIRTypeCategory
    ...
    Private Sub HDIRTypeSearch()
        ...
        Try
            Dim objhdIRCat As New AAMS.bizBOHelpDesk.bzIRTypeCategory
