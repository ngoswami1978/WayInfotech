<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_PtrSeverity.aspx.vb" Inherits="BOHelpDesk_HDUP_PtrSeverity" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Manage PTR Severity</title>
    <link rel="stylesheet" href="../CSS/AAMS.css" type="text/css" />
    <link type="text/javascript" href="../JavaScript/BOHelpDesk.js" />
    
    <script type="text/javascript" language="javascript">
    
     function InsertSeverity()
        {
        ...
        {
         if(document.getElementById("txtSeverity").value=='')
        {
        document.getElementById("txtSeverity").focus();
        document.getElementById("lblError").innerHTML ="PTR Priority Name is Mandatory";
        return false;
        }
...
<body>
     <form id="form1" defaultbutton="btnSave" defaultfocus="txtSeverity" runat="server">
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">Back Office HelpDesk&gt;</span><span class="sub_menu">PTR Priority</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage PTR Priority</td>
                        </tr>
                        <tr>
                                                    ...
                                                    <td class="textbold" style="height: 28px; width: 100%" colspan="4" valign="top">
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 195px; height: 22px;" class="textbold" nowrap="nowrap" >
                                                                    &nbsp;<asp:TextBox ID="txtSeverity" runat="server" CssClass="textbold" TabIndex="1" MaxLength="25" Width="176px" ></asp:TextBox>
                                                                </td>
