<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_QuerySubGroup.aspx.vb" Inherits="BOHelpDesk_MSSR_QuerySubGroup" ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>AAMS::Back Office HelpDesk::Search Query Sub Group</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(SubGroupID)
			{
				 window.location.href="BOHDUP_QuerySubGroup.aspx?Action=U&GroupID=" +SubGroupID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">Query Sub Group Search</span></td>
                        </tr>
                        <tr>
