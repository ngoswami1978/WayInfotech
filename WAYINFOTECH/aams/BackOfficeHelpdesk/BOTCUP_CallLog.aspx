<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOTCUP_CallLog.aspx.vb" Inherits="BOHelpDesk_TCUP_CallLog"
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="top left" style="width: 80%">
                                            <span class="menu">Back Office Technical-></span><span class="sub_menu">Call Log</span>
                                        </td>
                                                                        ...
                                                                        <table width="100%" border="0" class="left" cellpadding="2" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <img id="Img1" runat="server" alt="Select & Add Caller Name" onclick="PopupPage(2)"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtDateAssigned" runat="server" CssClass="textboxgrey" MaxLength="10" ReadOnly="True" Width="170px" TabIndex="20"></asp:TextBox>                                                                                        
                                                                                 </td>
                                                                                <td class="textbold">
                                                                                    Left Date Time</td>
                                                                                <td>
