<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_RequestTypeCategory.aspx.vb" Inherits="BOHelpDesk_HDSR_RequestTypeCategory" %>
...
<head id="Head1" runat="server">
     ...
     function  NewHDUPReqTypeCategory()
       {    
           window.location="BOHDUP_RequestTypeCategory.aspx?Action=I";
           return false;
       }  
...
//       
    ...
    {                
          window.location ="BOHDUP_RequestTypeCategory.aspx?Action=U&HD_RE_TYCAT_ID=" + CheckBoxObj; 
          return false;
    }   
    </script>
      ...
      <table width="860px" align="left" class="border_rightred" >
            <tr>
                <td valign="top">
                    <table width="100%" >
                        <tr>
                            <td valign="top"  align="left" ><span class="menu">Back Office Help Desk-></span><span class="sub_menu">Request Type Category</span></td>
                        </tr>
                        <tr>
