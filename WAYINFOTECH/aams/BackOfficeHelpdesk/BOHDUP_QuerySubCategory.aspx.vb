...
Partial Class BOHelpDesk_HDUP_QuerySubCategory
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            objInputXml.LoadXml("<HD_UPDATECALLSUBCATEGORY_INPUT><CALL_SUB_CATEGORY CALL_SUB_CATEGORY_ID='' CALL_SUB_CATEGORY_NAME='' CALL_CATEGORY_ID='' HD_STATUS_ID='' CONTACT_TYPE_ID='' HD_SEVERITY_ID='' TEAM_ID='' TITLE='' DESC='' /></HD_UPDATECALLSUBCATEGORY_INPUT>")
    ...
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Response.Redirect("BOHDUP_QuerySubCategory.aspx?Action=I|")
    End Sub
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                objeAAMS.BindDropDown(ddlQueryStatus, "BOQueryStatus", True, 1)
                objeAAMS.BindDropDown(ddlQueryPriority, "BOQUERYPRIORITY", True, 1)
                objeAAMS.BindDropDown(ddlTeam, "BOTEAM", True, 1)
    ...
    Private Sub CheckSecurity()
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO Call Query SubCategory']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BO Call Query SubCategory']").Attributes("Value").Value)
                End If
