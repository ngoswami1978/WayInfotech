<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_IRStatus.aspx.vb" Inherits="BOHelpDesk_HDSR_IRStatus" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <title>AAMS::Back Office HelpDesk::Search IR Status</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    ...
    function Edit(StatusID)
			{
				 window.location.href="BOHDUP_IRStatus.aspx?Action=U&IRStatusID=" +StatusID
				 return false;
			}
...
<body>
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">IR Status Search</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">Search IR Status</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                            ...
                                            <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 308px">
                                                        <asp:TextBox ID="txtIRStatus" runat="server" CssClass="textbox" Width="208px" MaxLength="25"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="textbold" colspan="3" >
                                                        <asp:GridView EnableViewState="False" ID="gvIRStatus" runat="server" AutoGenerateColumns="False"
                                                            TabIndex="6" Width="80%" AllowSorting="True">
                                                            <Columns>
                                                                <asp:BoundField DataField="HD_IR_STATUS_NAME" HeaderText="IR Status" SortExpression="HD_IR_STATUS_NAME" />
                                                                <asp:BoundField DataField="HD_IR_STATUS_CLOSE" HeaderText="Close" SortExpression="HD_IR_STATUS_CLOSE"  ItemStyle-Width ="100px" />
                                                                <asp:TemplateField HeaderText="Action" ItemStyle-Width ="100px">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:HiddenField ID="hdStatusID" runat="server" Value='<%#Eval("HD_IR_STATUS_ID")%>' />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
    ...
    {
        document.getElementById('<%=txtIRStatus.ClientId%>').value=''
