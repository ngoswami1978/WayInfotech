<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDSR_QueryStatus.aspx.vb" Inherits="BOHelpDesk_MSSR_QueryStatus" ValidateRequest="false" %>
...
<link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <title>AAMS::Back Office HelpDesk::Search Query Status</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(StatusID)
			{
				 window.location.href="BOHDUP_QueryStatus.aspx?Action=U&QueryStatusID=" +StatusID
				 return false;
			}
	...
	function Delete(StatusID)
	{
		 ...
		 if (confirm("Are you sure you want to delete?")==true)
            {    
//                var StatusName = document.getElementById('<%=txtQueryStatus.ClientId%>').value
//                window.location.href="HDSR_QueryStatus.aspx?Action=D&QueryStatusID=" +StatusID+"&StatusName="+StatusName	
...
<body>
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu">Query Status Search</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Search Query Status</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                        <tr>
                                            ...
                                            <td>
                                                                    ...
                                                                    <asp:TextBox ID="txtQueryStatus" runat="server" CssClass="textbox" Width="208px" MaxLength="25" TabIndex="1"></asp:TextBox>
                                                                    </td>
                                                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="textbold" colspan="3" >
                                                                                <asp:GridView EnableViewState="False" ID="gvQueryStatus" runat="server"  AutoGenerateColumns="False" TabIndex="6" Width="80%" AllowSorting="True">
                                                                                <Columns>
                                                                                   <asp:BoundField DataField="HD_STATUS_NAME" HeaderText="Query Status" SortExpression="HD_STATUS_NAME" />
                                                                                   <asp:BoundField DataField="HD_STATUS_CLOSE" HeaderText="Close" SortExpression="HD_STATUS_CLOSE" />
                                                            ...
                                                            <asp:LinkButton ID="lnkEdit" runat="server" CommandName ="EditX" Text ="Edit" CssClass ="LinkButtons"></asp:LinkButton>&nbsp;
                                                               <asp:LinkButton ID="lnkDelete" runat="server" CommandName ="DeleteX" Text ="Delete" CssClass ="LinkButtons"></asp:LinkButton> 
                                                                ...
                                                                <asp:HiddenField ID="hdStatusID" runat="server" Value='<%#Eval("HD_STATUS_ID")%>' />   
                                                             </ItemTemplate>
                                                           </asp:TemplateField>
 ...
 <script language="javascript" type="text/javascript">
    function ValidateForm()
    {
     ...
     if(document.getElementById('<%=txtQueryStatus.ClientId%>').value !='')
        {
            var strValue = document.getElementById('<%=txtQueryStatus.ClientId%>').value
            reg = new RegExp("^[a-zA-Z ]+$"); 

            if(reg.test(strValue) == false) 
            {
                document.getElementById('<%=lblError.ClientId%>').innerText ='Query status should contain only alphabets.'
                return false;
    ...
    {
        document.getElementById('<%=txtQueryStatus.ClientId%>').value=''
