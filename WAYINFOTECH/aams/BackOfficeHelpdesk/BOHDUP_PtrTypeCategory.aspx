<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BOHDUP_PtrTypeCategory.aspx.vb" Inherits="BOHelpDesk_HDUP_PtrTypeCategory" %>
...
<head id="Head1" runat="server">
    <title>Manage PTR Type Category</title>
    ...
    <script type="text/javascript" language="javascript">
     ...
     function InsertPtrTypeCat()
        {
        window.location.href="BOHDUP_PtrTypeCategory.aspx?Action=I";
        return false;
        }
        
        function validatePtrCategory()
        {
         if(document.getElementById("txtPtrTypeCat").value=='')
        {
        document.getElementById("txtPtrTypeCat").focus();
        document.getElementById("lblError").innerHTML ="PTR Type Category is Mandatory";
        return false;
        }
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">Back Office HelpDesk-&gt;</span><span class="sub_menu"> PTR Type Category</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage PTR Type Category</td>
                        </tr>
                        <tr>
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 22px; width: 149px;" class="textbold" nowrap="nowrap" >
                                                                    PTR Type Category<span class="Mandatory">* </span>
                                                                </td>
                                                                <td height="22px" style="width: 195px" class="textbold" nowrap="nowrap" >
                                                                    &nbsp;<asp:TextBox ID="txtPtrTypeCat" runat="server" CssClass="textbold" TabIndex="1" MaxLength="25" Width="176px" ></asp:TextBox>
                                                                </td>
