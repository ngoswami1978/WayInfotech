...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            If (Request.QueryString("BDRId") IsNot Nothing) Then
                LoadBDRHistroy()
                Session("BDRId") = objED.Decrypt(Request.QueryString("BDRId"))
    ...
    Sub LoadBDRHistroy()
        ...
        Try
            ...
            objInputXml.DocumentElement.SelectSingleNode("HD_RE_BDR_ID").InnerText = objED.Decrypt(Request.QueryString("BDRId")) 'Rakesh Added on 2 Aug 08
