<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRRPT_TrainingRoomPerformance.aspx.vb" Inherits="Training_TRRPT_TrainingRoomPerformance" %>
...
<script type="text/javascript" src="../Calender/calendar-setup.js"></script>
    <title>AAMS::Training::Room Performance</title>
            ...
            <tr>
                <td class="top">
                    <table width="100%" class="left">
                        <tr>
                            <td   >
                            <span class="menu"> Training -&gt;</span><span class="sub_menu">Training Room Performance</span></td>
                        </tr>
                        <tr>
                            <td class="heading center" >
                                Training Room Performance</td>
                        </tr>
                        <tr>
                            <td >
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                        ...
                                        <tr>
                                            ...
                                            <td class="textbold">
                                                Course</td>
                                            <td colspan="3">
                                                <asp:DropDownList ID="ddlCourse" runat="server" CssClass="dropdownlist" TabIndex="2"
                                                    Width="427px" onkeyup="gotop(this.id)">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 200px">
                                                <asp:DropDownList ID="ddlAoffice" runat="server" CssClass="dropdownlist" Width="143px" TabIndex="2" onkeyup="gotop(this.id)">
                                                  
                                                </asp:DropDownList></td>
                                            <td class="textbold">
                                                Region</td>
                                            <td>
                                                <asp:DropDownList ID="ddlReagion" runat="server" CssClass="dropdownlist" Width="125px" TabIndex="2" onkeyup="gotop(this.id)">
                                          ...
                                          <tr>
                                            ...
                                            <td class="textbold"><asp:DropDownList ID="ddlDateType" runat="server" CssClass="dropdownlist" onkeyup="gotop(this.id)"
                                            ...
                                            <td class="textbold">
                                                From
                                                <asp:TextBox ID="txtStartDateFrom" runat="server" CssClass="textbox" Width="102px" TabIndex="2" MaxLength="10"></asp:TextBox>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtStartDateTo" runat="server" CssClass="textbox" Width="121px" TabIndex="2" MaxLength="10"></asp:TextBox>
