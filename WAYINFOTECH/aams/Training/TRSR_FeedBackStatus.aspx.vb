...
Partial Class Training_TRSR_FeedBackStatus
...
#Region "Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load"
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            '   Deleting records.
            If (hdFeedBackStatusId.Value <> "") Then
                DeleteRecords()
            End If
...
#Region "btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click"
	Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
		Response.Redirect("TRSR_FeedBackStatus.aspx")
	End Sub
#End Region
...
#Region "BindData()"
    Private Sub BindData(ByVal Operation As Integer)
        ...
        Try
            'objInputXml.LoadXml("<TR_SEARCH_PARTMOOD_INPUT><TR_PART_MOOD_NAME></TR_PART_MOOD_NAME></TR_SEARCH_PARTMOOD_INPUT>")
            objInputXml.LoadXml("<TR_SEARCH_PARTMOOD_INPUT><TR_PART_MOOD_NAME></TR_PART_MOOD_NAME><PAGE_NO/> <PAGE_SIZE/><SORT_BY/><DESC/></TR_SEARCH_PARTMOOD_INPUT>")

            objInputXml.DocumentElement.SelectSingleNode("TR_PART_MOOD_NAME").InnerText = txtFeedBackStatus.Text.Trim()
            ...
            If Operation = PageOperation.Search Then
                ...
                If ViewState("SortName") Is Nothing Then
                    ViewState("SortName") = "TR_PART_MOOD_ORDER"
                    objInputXml.DocumentElement.SelectSingleNode("SORT_BY").InnerText = "TR_PART_MOOD_ORDER" '"LOCATION_CODE"
                Else
            ...
            objOutputXml = objbzFeedBackLevel.Search(objInputXml)
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                If ds.Tables("PTMOOD").Rows.Count <> 0 Then
                    gvDomain.DataSource = ds.Tables("PTMOOD")
                    gvDomain.DataBind()
                    ...
                    Else
                        lnkPrev.Visible = True
                    End If
                    txtRecordOnCurrentPage.Text = ds.Tables("PTMOOD").Rows.Count.ToString
                    ...
                    Select Case ViewState("SortName").ToString
                        ...
                        Case "TR_PART_MOOD_ORDER"
                            ...
                            End Select
                        Case "TR_PART_MOOD_NAME"
                            Select Case ViewState("Desc").ToString
                                Case "FALSE"
                                    gvDomain.HeaderRow.Cells(1).Controls.Add(imgUp)
                                Case "TRUE"
                                    gvDomain.HeaderRow.Cells(1).Controls.Add(imgDown)
                            End Select
                    End Select
                    ' @ Added Code To Show Image'
                    '@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
#Region "DeleteRecords()"
	Private Sub DeleteRecords()
		Try
			...
			Dim objbzFeedBackLevel As New AAMS.bizTraining.bzFeedBackLevel
			If hdFeedBackStatusId.Value <> "" Then
				objInputXml.LoadXml("<TR_DELETE_PARTMOOD_INPUT><PTMOOD TR_PART_MOOD_ID=''/></TR_DELETE_PARTMOOD_INPUT>")
				objInputXml.DocumentElement.SelectSingleNode("PTMOOD").Attributes("TR_PART_MOOD_ID").Value = hdFeedBackStatusId.Value
				hdFeedBackStatusId.Value = ""
				objOutputXml = objbzFeedBackLevel.Delete(objInputXml)
                'BindData(PageOperation.Search)
				If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
...
#End Region
    ...
    Sub Export(ByVal objOutputXml As XmlDocument)
        ...
        Dim strArray() As String = {"FeedBack Status Order", "FeedBack Status"}
        Dim intArray() As Integer = {2, 1}
        objExport.ExportDetails(objOutputXml, "PTMOOD", intArray, strArray, ExportExcel.ExportFormat.Excel, "exportFEEDBACKSTATUS.xls")
