<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRHR_CourseSessionRegister.aspx.vb" Inherits="TRHR_CourseSessionRegister" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Training:Register Participant History</title>
                    ...
                    <table width="100%" align="left">  
                        ...
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Register Participant History</td>
                        </tr>
                        <tr>
                            <td valign="top">
                                                            ...
                                                            <tr>
                                                                <td colspan="6" height="4" align="center">
                                                                    <asp:GridView ID="gvEmployeeHistory" runat="server" BorderWidth="1" BorderColor="#d4d0c8" AutoGenerateColumns="False"
                                                                        ...
                                                                        <asp:BoundField DataField="LOGDATE" HeaderText="Date Time" SortExpression="LOGDATE" >
