<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRSR_ParticipantStatus.aspx.vb" Inherits="Training_TRSR_ParticipantStatus" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
	<link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
	<title>AAMS::Training::Search Participant Status</title>

	<script language="javascript" type="text/javascript">
         
    function Edit(ParticipantStatusId)
			{
				 window.location.href="TRUP_ParticipantStatus.aspx?Action=U&ParticipantStatusId=" +ParticipantStatusId
				 return false;
			}
			
	function Delete(ParticipantStatusId)
	{
		 			 
		 if (confirm("Are you sure you want to delete?")==true)
            {    
               document.getElementById('<%=hdParticipantStatusId.ClientId%>').value = ParticipantStatusId
               return true;        
            }
            return false;
	}
				...
				<tr>
					<td class="top">
						<table width="100%" class="left">
							<tr>
								<td>
									<span class="menu">Training -&gt;</span><span class="sub_menu">Participant Status Search</span></td>
							</tr>
							<tr>
								<td class="heading center">
									Search Participant Status</td>
							</tr>
							<tr>
								<td>
											...
											<td class="redborder center">
												<table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
													...
													<tr>
														...
														<td colspan="3">
															<asp:TextBox ID="txtParticipantStatus" runat="server" CssClass="textbox" MaxLength="50" TabIndex="1"
													...
													<tr>
														...
														<td>
															<asp:HiddenField ID="hdParticipantStatusId" runat="server" />
														</td>
														<td colspan="4">
														</td>
													</tr>
													<tr>
														<td colspan="6">
															<asp:GridView ID="gvDomain" runat="server" AutoGenerateColumns="False" TabIndex="5"  HeaderStyle-ForeColor="white" 
																...
																<Columns>
																	<asp:BoundField HeaderText="Participant Status " DataField="TR_PARTSTATUS_NAME" SortExpression ="TR_PARTSTATUS_NAME" />
																	<asp:TemplateField HeaderText="Action">
																		<ItemTemplate>
																			...
																			<asp:HiddenField ID="hdDomain" runat="server" Value='<%#Eval("TR_PARTSTATUS_ID")%>' />
																		</ItemTemplate>
																		<ItemStyle Width="15%" />
																	</asp:TemplateField>
																</Columns>
                                                      ...
                                                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                      <tr  class ="paddingtop paddingbottom"  >                                                                                                                                                
                                                                          ...
                                                                          <td style="width: 20%" class="center">
                                                                              <span class ="textbold" ><b>Page No</b></span>&nbsp;&nbsp;<asp:DropDownList ID="ddlPageNumber" Width="70px" CssClass="dropdownlist" runat="server" AutoPostBack="True" TabIndex="8" >
                                                                              </asp:DropDownList></td>
                                                                          <td style="width: 25%" class="left">
                                                                              <asp:LinkButton ID="lnkNext" runat="server" CssClass="LinkButtons" CommandName="Next" TabIndex="9">Next >></asp:LinkButton></td>
                                                                      </tr>
                                                                  </table></asp:Panel>
                                                    </td>
                                                </tr>
