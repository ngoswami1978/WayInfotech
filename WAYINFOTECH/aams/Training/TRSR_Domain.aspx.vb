...
Partial Class Training_TRSR_Domain
...
#Region "btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click"
	Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
		Response.Redirect("TRSR_Domain.aspx")
	End Sub
#End Region
...
#Region "BindData()"
    Private Sub BindData(ByVal Operation As Integer)
        ...
        Try
            ...
            objInputXml.DocumentElement.SelectSingleNode("TR_VALTOPICDOM_NAME").InnerText = txtDomain.Text.Trim()
            ...
            If Operation = PageOperation.Search Then
                ...
                If ViewState("SortName") Is Nothing Then
                    ViewState("SortName") = "TR_DOMAIN_ORDER"
                    objInputXml.DocumentElement.SelectSingleNode("SORT_BY").InnerText = "TR_DOMAIN_ORDER" '"LOCATION_CODE"
                Else
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                If ds.Tables("DOMAIN").Rows.Count <> 0 Then
                    gvDomain.DataSource = ds.Tables("DOMAIN")
                    gvDomain.DataBind()
                    ...
                    Else
                        lnkPrev.Visible = True
                    End If
                    hdRecordOnCurrentPage.Value = ds.Tables("DOMAIN").Rows.Count.ToString
...
#Region "DeleteRecords()"
	Private Sub DeleteRecords()
		Try
			...
			Dim objbzDomain As New AAMS.bizTraining.bzDomain
			If hdDomainId.Value <> "" Then
				objInputXml.LoadXml("<TR_DELETE_DOMAIN_INPUT><DOMAIN TR_VALTOPICDOM_ID=''/></TR_DELETE_DOMAIN_INPUT> ")
				objInputXml.DocumentElement.SelectSingleNode("DOMAIN").Attributes("TR_VALTOPICDOM_ID").Value = hdDomainId.Value
				hdDomainId.Value = ""
				objOutputXml = objbzDomain.Delete(objInputXml)
                BindData(PageOperation.Search)
				If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
...
#End Region
    ...
    Sub Export(ByVal objOutputXml As XmlDocument)
        ...
        Dim strArray() As String = {"Order Number", "Domain"}
        Dim intArray() As Integer = {2, 1}
        objExport.ExportDetails(objOutputXml, "DOMAIN", intArray, strArray, ExportExcel.ExportFormat.Excel, "exportDOMAIN.xls")
