...
Partial Class Training_TRSR_CourseLevel
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		Try
			...
			If Not IsPostBack Then
				txtCourseLevel.Focus()
               
			End If
			'   Deleting records.
			If (hdCourseLevelId.Value <> "") Then
				DeleteRecords()
			End If
...
#Region "btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click"
	Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
		Response.Redirect("TRSR_CourseLevel.aspx")
	End Sub
#End Region
...
#Region "BindData(ByVal Operation As Integer)"
    Private Sub BindData(ByVal Operation As Integer)
        ...
        Try
            objInputXml.LoadXml("<TR_SEARCH_COURSELEVEL_INPUT><TR_COURSELEVEL_NAME></TR_COURSELEVEL_NAME><PAGE_NO/> <PAGE_SIZE/><SORT_BY/><DESC/></TR_SEARCH_COURSELEVEL_INPUT>")
            objInputXml.DocumentElement.SelectSingleNode("TR_COURSELEVEL_NAME").InnerText = txtCourseLevel.Text.Trim()
            ...
            If Operation = PageOperation.Search Then
                ...
                If ViewState("SortName") Is Nothing Then
                    ViewState("SortName") = "TR_COURSELEVEL_NAME"
                    objInputXml.DocumentElement.SelectSingleNode("SORT_BY").InnerText = "TR_COURSELEVEL_NAME" '"LOCATION_CODE"
                Else
            ...
            objOutputXml = objbzCourselevel.Search(objInputXml)
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                If ds.Tables("LEVEL").Rows.Count <> 0 Then
                    gvDomain.DataSource = ds.Tables("LEVEL")
                    gvDomain.DataBind()
                    ...
                    Else
                        lnkPrev.Visible = True
                    End If
                    hdRecordOnCurrentPage.Value = ds.Tables("LEVEL").Rows.Count.ToString
...
#Region "DeleteRecords()"
	Private Sub DeleteRecords()
		Try
			...
			Dim objbzCourselevel As New AAMS.bizTraining.bzCourselevel
			If hdCourseLevelId.Value <> "" Then
				objInputXml.LoadXml("<TR_DELETE_COURSELEVEL_INPUT><LEVEL TR_COURSELEVEL_ID='' /></TR_DELETE_COURSELEVEL_INPUT>")
				objInputXml.DocumentElement.SelectSingleNode("LEVEL").Attributes("TR_COURSELEVEL_ID").Value = hdCourseLevelId.Value
				hdCourseLevelId.Value = ""
				objOutputXml = objbzCourselevel.Delete(objInputXml)
                BindData(PageOperation.Search)
				If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
...
#End Region
    ...
    Sub Export(ByVal objOutputXml As XmlDocument)
        ...
        Dim strArray() As String = {"Course Level"}
        Dim intArray() As Integer = {1}

        objExport.ExportDetails(objOutputXml, "LEVEL", intArray, strArray, ExportExcel.ExportFormat.Excel, "exportCOURSELEVEL.xls")
    End Sub
    'End Code For Export
