...
Partial Class Training_TRRPT_TrainingRoomPerformance
...
#Region "btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click"
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        Try
            SearchRecords()
            'Response.Redirect("../RPSR_ReportShow.aspx?Case=TrainingRoomPerformance")
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
    End Sub
...
#Region " SearchRecords()"
    Sub SearchRecords()
        ...
        objInputXml.LoadXml("<TR_RPT_TRAINING_ROOM_PERFORMANCE_INPUT><TR_COURSE_ID/><TR_CLOCATION_NAME/><AOFFICE/><REGION/><EMPLOYEE_ID/><DATE_TYPE_FROM/><DATE_TYPE_TO/><DATE_TYPE/><COURSE_STARTDATE_FROM/><COURSE_STARTDATE_TO/><COURSE_ENDDATE_FROM/><COURSE_ENDDATE_TO/><Limited_To_Region/><Limited_To_Aoffice/><Limited_To_OwnAgency/></TR_RPT_TRAINING_ROOM_PERFORMANCE_INPUT>")
        ...
        'End If
        objOutputXml = objbzTrainingRoom.rptTrainingRoomPerformance(objInputXml)
        If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
            Session("TrainingRoomPerformance") = objInputXml.OuterXml
            Response.Redirect("../RPSR_ReportShow.aspx?Case=TrainingRoomPerformance")
        Else
...
#Region "btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click"
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Response.Redirect("TRRPT_TrainingRoomPerformance.aspx")
    End Sub
#End Region
    ...
    Private Sub CheckSecurity()
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='Room Performance']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='Room Performance']").Attributes("Value").Value)
                End If
