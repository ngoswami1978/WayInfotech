<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRUP_CourseLevel.aspx.vb" Inherits="Training_TRUP_CourseLevel" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
	<title>AAMS::Training::Manage Course Level</title>
...
<body>
					...
					<table width="100%" align="left">
						<tr>
							<td valign="top" align="left">
								<span class="menu">Training-&gt;</span><span class="sub_menu">Manage Course Level</span></td>
						</tr>
						<tr>
											...
											<table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
												...
												<tr>
													...
													<td class="textbold" style="width: 140px">
														Course Level Name<span class="Mandatory">*</span></td>
													<td style="width: 358px">
														<asp:TextBox ID="txtCourseLevelName" runat="server" CssClass="textbox" MaxLength="100"
    ...
    function ValidateForm()
    {
     ...
     if(document.getElementById('<%=txtCourseLevelName.ClientId%>').value =='')
        {
            document.getElementById('<%=lblError.ClientId%>').innerText='Course Level Name is mandatory.'
            document.getElementById('<%=txtCourseLevelName.ClientId%>').focus();
            return false;
        }
    ...
    {
        document.getElementById("txtCourseLevelName").value=""
