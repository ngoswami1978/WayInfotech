                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td class="textbold" style="width:12%;">
                                                            Month</td>
                                                        <td style="width:26%;"><table cellpadding ="0" border ="0" cellspacing="0"  style ="width:100%;">
                                                            <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td class="left" style="width: 28%; height: 24px;" colspan ="2"><asp:CheckBox ID="ChkAirBreak" runat="server" CssClass="textbox" TabIndex="17"  Enabled ="true"  Checked ="false" 
                                                                Text="Show Airline Breakup" Width="145px" AutoPostBack="True" /></td> 
                                                    ...
                                                    <td style ="width:2%;"></td>                                                     
                                                      <td colspan ="7">
                                                        <table cellpadding ="0"  border ="0" cellspacing="0" style="width: 218px" >
