<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MSUP_AG_BCase_Inc_Slab.aspx.vb" Inherits="Setup_MSUP_AG_BCase_Inc_Slab" %>
                                                                                                                    ...
                                                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="680px">
                                                                                                                        ...
                                                                                                                        <tr class="textbold">
                                                                                                                            <td style="height: 13px">
                                                                                                                                Third Slab</td>
                                                                                                                            <td style="height: 13px">
                                                                                                                                <asp:TextBox ID="TextBox14" runat="server" CssClass="textbox"></asp:TextBox></td>
                                                                                                                            <td style="height: 13px">
                                                                                                                        ...
                                                                                                                        <tr class="textbold">
                                                                                                                            <td style="height: 18px">
                                                                                                                                Fifth Slab</td>
                                                                                                                            <td style="height: 18px">
                                                                                                                                <asp:TextBox ID="TextBox15" runat="server" CssClass="textbox"></asp:TextBox></td>
                                                                                                                            <td style="height: 18px">
                                                                                                                        ...
                                                                                                                        <tr class="lightblue">
                                                                                                                            <td style="height: 18px">
                                                                                                                                Sixth Slab</td>
                                                                                                                            <td style="height: 18px">
                                                                                                                                <asp:TextBox ID="TextBox16" runat="server" CssClass="textbox"></asp:TextBox></td>
                                                                                                                            <td style="height: 18px">
