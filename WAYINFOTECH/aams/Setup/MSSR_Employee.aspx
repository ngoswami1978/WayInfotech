<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MSSR_Employee.aspx.vb" Inherits="Setup_MSSR_Employee" EnableEventValidation="false" %>
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="textbold">
                                                                    Aoffice</td>
                                                                <td>
                                                                    <asp:DropDownList ID="drpAoffice" CssClass="dropdownlist" Width="137px" runat="server" TabIndex="2">
                                                                    </asp:DropDownList></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="textbold" nowrap="nowrap">
                                                                    Designation</td>
                                                                <td class="textbold">
                                                                    <asp:DropDownList ID="drplstDeig" CssClass="dropdownlist"  runat="server" Width="136px" TabIndex="2" ></asp:DropDownList>
                                                                    </td>
                                                                <td nowrap="nowrap" class="textbold" style="width: 109px">
                                                                    Permission &nbsp;
                                                                </td>
                                                                <td>
                                                                    <asp:DropDownList ID="drplstPermission" CssClass="dropdownlist" runat="server" Width="136px" TabIndex="2" ></asp:DropDownList></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="textbold" style="width: 109px" >
                                                                    Agreement Signed</td>
                                                                <td>
                                                                <asp:DropDownList ID="drpAgreementSigned" CssClass="dropdownlist" runat="server" Width="136px" TabIndex="2" >
                                                            ...
                                                            <tr>
                                                                <td colspan="6" >
                                                                     <asp:GridView  ID="grdEmployee" runat="server"  AutoGenerateColumns="False" TabIndex="6" Width="100%" EnableViewState="true"   AllowSorting ="true" HeaderStyle-ForeColor ="white"  >
                                                                                <Columns>
                                                                                                        ...
                                                                                                        <asp:BoundField HeaderText="DOJ " DataField="DateStart" SortExpression ="DateStart" ItemStyle-CssClass="displayNone" HeaderStyle-CssClass="displayNone" ControlStyle-CssClass="displayNone" />
                                                                                                        <asp:BoundField HeaderText="Date of Leaving " DataField="DateEnd" SortExpression ="DateEnd" />
                                                                                                        <asp:BoundField HeaderText="City " DataField="City_Name" SortExpression ="City_Name" />
                                                                                                       
                                                                                                        <asp:TemplateField HeaderText="Action">
                                                                                <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkSelect" CssClass="LinkButtons" Text="Select" runat="server" CommandName="SelectX" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "EmployeeID") + "|" + DataBinder.Eval(Container.DataItem, "Employee_Name") + "|" + DataBinder.Eval(Container.DataItem, "Aoffice") + "|" + DataBinder.Eval(Container.DataItem, "BR_ID") %>'></asp:LinkButton>&nbsp;     
                                                                            
                                                                            <asp:LinkButton ID="lnkEdit" CssClass="LinkButtons" Text="Edit" runat="server" CommandName="EditX" CommandArgument='<%#Eval("EmployeeID")%>'></asp:LinkButton>&nbsp;
                                                                            <asp:LinkButton ID="lnkDelete" CssClass="LinkButtons" Text="Delete" runat="server" CommandName="DeleteX" CommandArgument='<%#Eval("EmployeeID")%>'></asp:LinkButton>
