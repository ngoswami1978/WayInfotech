<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MSSR_AG_BCase_Hardware.aspx.vb"
    Inherits="Setup_MSSR_AG_BCase_Hardware" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 860px">
                        <tr>
                            <td style="width: 860px;" valign="top" class="redborder">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 860px">                                   
                                    <tr>
                                        <td class="textbold" colspan="6" style="width:100%; height: 100px;" valign="top">
                                            <asp:GridView ID="GvHardware" runat="server" AutoGenerateColumns="False" TabIndex="6"
                                                ...
                                                <Columns>
                                                    <asp:BoundField HeaderText="Hardware" DataField="HARDWARE" SortExpression="HARDWARE"
