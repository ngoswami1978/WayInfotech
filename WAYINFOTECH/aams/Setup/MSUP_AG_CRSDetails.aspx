<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MSUP_AG_CRSDetails.aspx.vb"
    Inherits="Setup_MSUP_AG_CRSDetails" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>AAMS::Travel Agency::Manage CRS Details</title>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="top left" style="width: 80%">
                                            <span class="menu">Travel Agency->Agency Group-></span><span class="sub_menu">CRS Details</span>
                                        </td>
                        ...
                        <tr>
                            <td class="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="redborder top" colspan="2" style="width: 90%">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td class="center TOP">
                                                ...
                                                <tr>
                                                    <td class="top" style="width: 100%;">
                                                        <asp:GridView ID="grdCRSAgency" runat="server" AutoGenerateColumns="False" TabIndex="6"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="AGENCY" HeaderText="Agency Name" SortExpression="AGENCY" />
                                                                <asp:BoundField DataField="CRS" HeaderText="CRS Code" SortExpression="CRS" />
                                                                <asp:BoundField DataField="OFFICEID" HeaderText="Office ID" SortExpression="OFFICEID" />
                                                                <asp:BoundField DataField="CURRENTID" HeaderText="Current ID" SortExpression="CURRENTID" />
                                                            </Columns>
