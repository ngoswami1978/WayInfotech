...
Partial Class Setup_MSSR_EmployeeR
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Session("PageName") = "Setup/MSSR_EmployeeR.aspx"
        Try
    ...
    Private Sub EmployeeSearch()
        ...
        '@ Added By Abhishek on 17-06-08 ' New Xml Input
        ...
        If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
            ...
            ' Enabling Disabling Action Columns Based On Criteria Start.
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        If Request.QueryString("Dept") IsNot Nothing And Request.QueryString("Popup") IsNot Nothing Then
            Response.Redirect("MSSR_EmployeeR.aspx?" + Request.QueryString.ToString, False)
        Else
            Response.Redirect("MSSR_EmployeeR.aspx", False)
        End If
...
#End Region
    ...
    Private Sub EmployeeExport()
        ...
        If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
            ...
            Dim strArray() As String = {"Employee Name", "Aoffice", "Department", "City "}
            Dim intArray() As Integer = {1, 2, 3, 6}
