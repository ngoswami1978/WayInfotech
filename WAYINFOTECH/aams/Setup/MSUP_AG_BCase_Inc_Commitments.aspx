<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MSUP_AG_BCase_Inc_Commitments.aspx.vb" Inherits="Setup_MSUP_AG_BCase_Inc_Commitments" %>
                                                                                                                ...
                                                                                                                <td valign="top" align ="center"  >
                                                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="680px">
                                                                                                                        <tr class="Gridheading">
                                                                                                                            <td colspan ="3">
                                                                                                                                MANDATORY COMMITMENTS TO AMADEUS</td>
                                                                                                                        ...
                                                                                                                        <tr class="lightblue">
                                                                                                                            <td style="height: 18px">
                                                                                                                                TOTAL SEG. AS PER % CONVERSION</td>
                                                                                                                            <td style="height: 18px">
