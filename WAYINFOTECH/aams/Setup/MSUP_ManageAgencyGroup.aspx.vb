'###########################################################################
'############   Page Name -- Setup/MSUP_ManageAgencyGroup.aspx     #########  
...
Imports System.Xml
#End Region
Partial Class Setup_MSUP_ManageAgencyGroup
...
#Region "Page_Load Event"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            '   txtRegion.Text = Request.Form("txtRegion")
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If (IsValid) Then
            Try
                ...
                objInputXml.LoadXml("<MS_UPDATEGROUP_INPUT><GROUP ACTION='' Chain_Code='' Chain_Name='' ContactPerson='' Affiliation='' Priority_Auto_Update='1' Grouped='0' PK_Bkngs='' PriorityID='' GroupTypeID='' Aoffice='' CityID='' Responsible_Location='1' CQualifier='' CCode='' MainGroup='' Address ='' EmployeeId='' GroupClassificationID='' AccountManager='' /></MS_UPDATEGROUP_INPUT>")
                ...
                If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                    If Request.QueryString("Action").ToUpper = "U" Then
                        Response.Redirect("MSUP_ManageAgencyGroup.aspx?&Msg=U&Action=U&Chain_Code=" & objED.Encrypt(objOutputXml.DocumentElement.SelectSingleNode("GROUP").Attributes("Chain_Code").Value), False)
                    ...
                    Else
                        ...
                        Response.Redirect("MSUP_ManageAgencyGroup.aspx?&Msg=A&Action=U&Chain_Code=" & objED.Encrypt(objOutputXml.DocumentElement.SelectSingleNode("GROUP").Attributes("Chain_Code").Value), False)
                    End If
                Else
...
#Region "BindAgencyGroupData Procedure is called for binding the Agency Group Data to diferent controls"
    Sub BindAgencyGroupData(ByVal objOutputXml As XmlDocument)
        ...
        Try
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("GROUP").Attributes("GroupClassificationID").Value.Trim <> "" Then
                drpGroupClassification.SelectedValue = objOutputXml.DocumentElement.SelectSingleNode("GROUP").Attributes("GroupClassificationID").Value
            End If
