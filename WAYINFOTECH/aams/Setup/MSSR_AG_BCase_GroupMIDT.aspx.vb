...
Partial Class Setup_MSSR_AG_BCase_GroupMIDT
    ...
    Private Sub LoadData(ByVal strChainCode As String)
        ...
        Try
            ...
            If ViewState("SortName") Is Nothing Then
                ViewState("SortName") = "LASTAVAIL"
                objInputXml.DocumentElement.SelectSingleNode("SORT_BY").InnerText = "LASTAVAIL"
            Else
            ...
            If objOutPutxml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                GvBGroupMIDT.DataSource = ds.Tables("BGROUPMIDT")
                ...
                SetImageForSorting(GvBGroupMIDT)
        ...
        'objOutPut.LoadXml("<PR_SEARCH_BGROUPMIDT_OUTPUT><BGROUPMIDT LASTAVAIL='' A='' B='' G='' P='' W='' TOTAL=''  APER='' BPER='' GPER='' PPER='' WPER='' TOTALPER=''></BGROUPMIDT></PR_SEARCH_BGROUPMIDT_OUTPUT>")
...
#Region "Code for Paging And sorting."
    ...
    Protected Sub GvBGroupMIDT_Sorted(ByVal sender As Object, ByVal e As System.EventArgs) Handles GvBGroupMIDT.Sorted
        Try
    ...
    Protected Sub GvBGroupMIDT_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles GvBGroupMIDT.Sorting
        Try
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            If objOutPutxml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                'objReadaer = New XmlNodeReader(objOutPutxml)
                'ds.ReadXml(objReadaer)
                'GvBGroupMIDT.DataSource = ds.Tables("BGROUPAGENCYMIDT")
                'GvBGroupMIDT.DataBind()
