<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MSSR_AG_BCase_GroupMIDT.aspx.vb"
    Inherits="Setup_MSSR_AG_BCase_GroupMIDT" %>
                                    ...
                                    <tr>
                                        <td class="textbold" colspan="6" style="width: 1000px; height: 100px;" valign="top">
                                            <asp:GridView ID="GvBGroupMIDT" runat="server" AutoGenerateColumns="False" TabIndex="6"
                                                Width="1000px" EnableViewState="true" AllowSorting="True">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Total" DataField="TOTAL" SortExpression="TOTAL" HeaderStyle-Width="10%"
                                                        ItemStyle-Wrap="true"></asp:BoundField>
                                                    <asp:BoundField HeaderText="1A %" DataField="APER" SortExpression="APER" HeaderStyle-Width="8%">
                                                    </asp:BoundField>
                                                    <asp:BoundField HeaderText="1B %" DataField="BPER" SortExpression="BPER" HeaderStyle-Width="8%"
                                                        ItemStyle-Wrap="true"></asp:BoundField>
                                                    <asp:BoundField HeaderText="1G %" DataField="GPER" SortExpression="GPER" HeaderStyle-Width="8%">
                                                    </asp:BoundField>
                                                    <asp:BoundField HeaderText="1P %" DataField="PPER" SortExpression="PPER" HeaderStyle-Width="8%">
                                                    </asp:BoundField>
                                                    <asp:BoundField HeaderText="1W %" DataField="WPER" SortExpression="WPER" HeaderStyle-Width="8%"
                                                        ItemStyle-Wrap="true"></asp:BoundField>                                                   
                                                </Columns>
