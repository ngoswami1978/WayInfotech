...
Partial Class Setup_MSSR_AG_BCase_AgencyMIDT
    ...
    Private Sub LoadData(ByVal strChainCode As String)
        ...
        Try
            ...
            objOutPutxml.LoadXml("<PR_SEARCH_BGROUPAGENCYMIDT_OUTPUT><BGROUPAGENCYMIDT NAME='' ADDRESS='' OFFICEID='' A='' B='' G='' P='' W='' TTP=''></BGROUPAGENCYMIDT><BGROUPAGENCYMIDT NAME='' ADDRESS='' OFFICEID='' A='' B='' G='' P='' W='' TTP=''></BGROUPAGENCYMIDT><BGROUPAGENCYMIDT NAME='' ADDRESS='' OFFICEID='' A='' B='' G='' P='' W='' TTP=''></BGROUPAGENCYMIDT><BGROUPAGENCYMIDT NAME='' ADDRESS='' OFFICEID='' A='' B='' G='' P='' W='' TTP=''></BGROUPAGENCYMIDT><BGROUPAGENCYMIDT NAME='' ADDRESS='' OFFICEID='' A='' B='' G='' P='' W='' TTP=''></BGROUPAGENCYMIDT><PAGE PAGE_COUNT='1' TOTAL_ROWS='5'></PAGE><Errors Status='FALSE'><Error Code='' Description='' /></Errors></PR_SEARCH_BGROUPAGENCYMIDT_OUTPUT>")
            ...
            If objOutPutxml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                SetImageForSorting(GvBAgencyMIDT)
    ...
    Protected Sub GvBAgencyMIDT_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GvBAgencyMIDT.RowDataBound
        Try
            If e.Row.RowType = DataControlRowType.Header Then
                ...
                '    e.Row.Cells(4).Text = "2008 Average" + "<br>" + "1A"
                '    e.Row.Cells(5).Text = "" + "<br>" + "1A"
                '    e.Row.Cells(6).Text = "" + "<br>" + "1B"
                '    e.Row.Cells(7).Text = "" + "<br>" + "1G"
                '    e.Row.Cells(8).Text = "" + "<br>" + "1B"
                '    e.Row.Cells(8).Text = "" + "<br>" + "1P"
                '    e.Row.Cells(9).Text = "" + "<br>" + "TTP"
            End If
...
#Region "Code for Paging And sorting."
    ...
    Protected Sub GvBAgencyMIDT_Sorted(ByVal sender As Object, ByVal e As System.EventArgs) Handles GvBAgencyMIDT.Sorted
        Try
    ...
    Protected Sub GvBAgencyMIDT_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles GvBAgencyMIDT.Sorting
        Try
