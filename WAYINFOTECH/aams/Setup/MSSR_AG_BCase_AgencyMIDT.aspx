<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MSSR_AG_BCase_AgencyMIDT.aspx.vb"
    Inherits="Setup_MSSR_AG_BCase_AgencyMIDT" %>
...
<body>
    <form id="form1" runat="server">
        <table width="860px" class="border_rightred left">
            ...
            <tr>
                <td align="center" valign="top" style="width: 1000px; padding-left: 4px;">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 1000px">
                        <tr>
                            <td style="width: 1000px;" valign="top" class="redborder">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 1000px">
                                    <tr>
                                        <td>
                                            <table width="1000px" border="0" cellpadding ="0" cellspacing ="0">
                                                <tr class ="Gridheading">
                                                    <td id="HeaderUpper1" width="450px">
                                                    </td>
                                                    <td id="HeaderUpper2" runat="server" width="550px" align ="left" >
                                                        2008 Average</td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="textbold" colspan="6" style="width: 1000px; height: 100px;" valign="top">
                                            <asp:GridView ID="GvBAgencyMIDT" runat="server" AutoGenerateColumns="False" TabIndex="6"
                                                Width="1000px" EnableViewState="true" AllowSorting="True" ShowFooter ="true" >
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Agency Name" DataField="NAME" SortExpression="NAME" HeaderStyle-Width="130px">
                                                    </asp:BoundField>
                                                    <asp:BoundField HeaderText="Office Id" DataField="OFFICEID" SortExpression="OFFICEID" HeaderStyle-Width="100px"
                                                        ItemStyle-Wrap="true"></asp:BoundField>
                                                    <asp:BoundField HeaderText="Address" DataField="ADDRESS" SortExpression="ADDRESS"
                                                        HeaderStyle-Width="150px"></asp:BoundField>
                                                    <asp:BoundField HeaderText="1A" DataField="A" SortExpression="A" HeaderStyle-Width="100px">
                                                    </asp:BoundField>
                                                    <asp:BoundField HeaderText="1B" DataField="B" SortExpression="B" HeaderStyle-Width="100px">
                                                    </asp:BoundField>
                                                    <asp:BoundField HeaderText="1G" DataField="G" SortExpression="G" HeaderStyle-Width="100px">
                                                    </asp:BoundField>
                                                    <asp:BoundField HeaderText="1P" DataField="P" SortExpression="P" HeaderStyle-Width="100px">
                                                    </asp:BoundField>
                                                    <asp:BoundField HeaderText="1W" DataField="W" SortExpression="W" HeaderStyle-Width="100px"
                                                        ItemStyle-Wrap="true"></asp:BoundField>
                                                    <asp:BoundField HeaderText="TTP" DataField="TTP" SortExpression="TTP" HeaderStyle-Width="100px"
                                                        ItemStyle-Wrap="true"></asp:BoundField>
                                                </Columns>
