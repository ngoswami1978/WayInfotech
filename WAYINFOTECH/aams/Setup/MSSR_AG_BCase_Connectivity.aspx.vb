...
Partial Class Setup_MSSR_AG_BCase_Connectivity
    ...
    Private Sub LoadData(ByVal strChainCode As String)
        ...
        Try
            ...
            If ViewState("SortName") Is Nothing Then
                ViewState("SortName") = "CONNECTIVITY"
                objInputXml.DocumentElement.SelectSingleNode("SORT_BY").InnerText = "CONNECTIVITY"
            Else
            ...
            objOutPutxml.LoadXml("<PR_SEARCH_BGROUPAGENCYMIDT_OUTPUT><BGROUPAGENCYCONNECTIVITY CONNECTIVITY='SARAL' UNITCOST='1750' NUM='0' TOTALCOST='0'></BGROUPAGENCYCONNECTIVITY><BGROUPAGENCYCONNECTIVITY CONNECTIVITY='LL' UNITCOST='150' NUM='0' TOTALCOST='0'></BGROUPAGENCYCONNECTIVITY><BGROUPAGENCYCONNECTIVITY CONNECTIVITY='WLL' UNITCOST='850' NUM='0' TOTALCOST='0'></BGROUPAGENCYCONNECTIVITY><BGROUPAGENCYCONNECTIVITY CONNECTIVITY='VSAT' UNITCOST='850' NUM='0' TOTALCOST='0'></BGROUPAGENCYCONNECTIVITY><PAGE PAGE_COUNT='1' TOTAL_ROWS='4'></PAGE><Errors Status='FALSE'><Error Code='' Description='' /></Errors></PR_SEARCH_BGROUPAGENCYMIDT_OUTPUT>")
            ...
            If objOutPutxml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                GvConnectivity.DataSource = ds.Tables("BGROUPAGENCYCONNECTIVITY")
                ...
                SetImageForSorting(GvConnectivity)
        ...
        'objOutPut.LoadXml("<PR_SEARCH_BGROUPAGENCYCONNECTIVITY_OUTPUT><BGROUPAGENCYCONNECTIVITY CONNECTIVITY='' UNITCOST='' NUM='' TOTALCOST=''></BGROUPAGENCYCONNECTIVITY></PR_SEARCH_BGROUPAGENCYCONNECTIVITY_OUTPUT>")
...
#Region "Code for Paging And sorting."
    ...
    Protected Sub GvConnectivity_Sorted(ByVal sender As Object, ByVal e As System.EventArgs) Handles GvConnectivity.Sorted
        Try
    ...
    Protected Sub GvConnectivity_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles GvConnectivity.Sorting
        Try
