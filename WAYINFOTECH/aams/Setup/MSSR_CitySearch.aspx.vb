...
Partial Class AMS_City_CRS_AAMS_CitySearch
...
#Region "Page_Load Event Declaration"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Session("PageName") = "Setup/MSSR_CitySearch.aspx"
            ...
            btnSearch.Attributes.Add("onclick", "return CityMandatory();")
            btnNew.Attributes.Add("onclick", "return NewMSUPCity();")


            If hdDeleteCityId.Value <> "" Then
                CityDelete(hdDeleteCityId.Value)
            End If
...
#Region "btnSearch_Click"
    ...
    End Sub
#End Region
#Region "Method for search City"
    Private Sub CitySearch()
        ...
        Try
            ...
            objInputXml.LoadXml("<MS_SEARCHCITY_INPUT><City_Name></City_Name><PAGE_NO/> <PAGE_SIZE/><SORT_BY/><DESC/></MS_SEARCHCITY_INPUT>")
            ...
            If ViewState("SortName") Is Nothing Then
                ViewState("SortName") = "City_Name"
                objInputXml.DocumentElement.SelectSingleNode("SORT_BY").InnerText = "City_Name" '"LOCATION_CODE"
            Else
...
#End Region
    Protected Sub gvCity_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvCity.RowCommand
        ...
        '        Response.Redirect("MSUP_City.aspx?Action=U&CityID=" & e.CommandArgument)
        '    End If
        '    'Code for Delete Data
        '    If e.CommandName = "DeleteX" Then
        '        CityDelete(e.CommandArgument)
        '        CitySearch()
        '    End If
        'Catch ex As Exception
        '    lblError.Text = ex.Message
        'End Try
    End Sub
#Region " Sub Procedure Called for deletion of city"
    Sub CityDelete(ByVal strCityID As String)
        Try
            Dim objInputXml, objOutputXml As New XmlDocument
            Dim objbzCity As New AAMS.bizMaster.bzCity
            objInputXml.LoadXml("<MS_DELETECITY_INPUT><CityID></CityID></MS_DELETECITY_INPUT>")
            objInputXml.DocumentElement.SelectSingleNode("CityID").InnerText = strCityID

            hdDeleteCityId.Value = ""
            'Here Back end Method Call
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                'Response.Redirect("MSSR_CitySearch.aspx")
                ' ###################################################################
    ...
    End Sub
#End Region
#Region "gvCity_RowDataBound Event fired on every row creation in  gridview"
    Protected Sub gvCity_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvCity.RowDataBound
        Try
            If e.Row.RowIndex < 0 Then
                Exit Sub
            End If
            Dim hdstrCityID As HiddenField
            ...
            hdstrCityID = e.Row.FindControl("hdCityId")
            'linkEdit.Attributes.Add("onclick", "return EditFunction(" & hdstrCityID.Value & ");")
            'linkDelete.Attributes.Add("onclick", "return DeleteFunction(" & hdstrCityID.Value & ");")
            Dim objSecurityXml As New XmlDocument
            objSecurityXml.LoadXml(Session("Security"))
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='City']").Count <> 0 Then
                    ...
                    Else
                        btnDelete.Attributes.Add("onclick", "return DeleteFunction('" & hdstrCityID.Value & "');")
                    End If
                    'If strBuilder(2) = "0" Then
                    'linkEdit.Disabled = False
                    'Else
                    linkEdit.Attributes.Add("onclick", "return EditFunction('" & objEn.Encrypt(hdstrCityID.Value.Trim) & "');")
                    'End If
                Else
...
#Region "Code for Paging And sorting."
    ...
    Protected Sub gvCity_Sorted(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvCity.Sorted
        Try
    ...
    Protected Sub gvCity_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gvCity.Sorting
        Try
        ...
        End Try
    End Sub
    Protected Sub gvCity_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvCity.RowCreated
        Try
...
#End Region
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Try
            Response.Redirect("MSSR_CitySearch.aspx", False)
        Catch ex As Exception
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                Dim strArray() As String = {"City Name", "Aoffice", "State", "Country"}

                Dim intArray() As Integer = {2, 3, 5, 7}

                objExport.ExportDetails(objOutputXml, "CITY_DETAIL", intArray, strArray, ExportExcel.ExportFormat.Excel, "CityDetails.xls")
