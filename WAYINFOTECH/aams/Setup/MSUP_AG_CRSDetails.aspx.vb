...
Partial Class Setup_MSUP_AG_CRSDetails
    ...
    Sub ViewData(ByVal Operation As Integer)
        ...
        Try
            objInputXml.LoadXml("<UP_GETCRSDETAILS_INPUT><CHAIN_CODE></CHAIN_CODE><ResponsibleStaffID></ResponsibleStaffID><PAGE_NO/> <PAGE_SIZE/><SORT_BY/><DESC/></UP_GETCRSDETAILS_INPUT>")
            ...
            objOutputXml = objAgency.GetAgencyGroupCrsUseDetails(objInputXml)
            ' objOutputXml.Save("C:\Admin\objOutputXmlCrsDetails.xml")
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                If ds.Tables("CRS").Rows.Count <> 0 Then
                    ...
                    Else
                        lnkPrev.Visible = True
                    End If
                    hdRecordOnCurrentPage.Value = ds.Tables("CRS").Rows.Count.ToString
...
#End Region
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            '<CRS RN="13029" LCODE="7200" AGENCY="Heron Travels & Holidays" DATE="0" CURRENTID="N" CRS="1A" OFFICEID="BOMPW3162" Action="" /> 

               
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                objXmlReader = New XmlNodeReader(objOutputXml)
                Dim strArray() As String = {"LCode", "Agency Name", "CRS Code", "Office ID", "Current ID"}
                Dim intArray() As Integer = {1, 2, 5, 6, 4}
                Dim objExport As New ExportExcel
                objExport.ExportDetails(objOutputXml, "CRS", intArray, strArray, ExportExcel.ExportFormat.Excel, "GroupCrsDetails.xls")
            Else
                lblError.Text = objOutputXml.DocumentElement.SelectSingleNode("Errors/Error").Attributes("Description").Value
            End If
        Catch ex As Exception
