<%@ Page Language="vb" AutoEventWireup="false" CodeFile="INCUP_PaymentProcess.aspx.vb"
    ValidateRequest="false" Inherits="Incentive_INCUP_PaymentProcess" %>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="textbold" style="width: 21%" valign="top" align="center">
                                                                                                <asp:Button ID="BtnPaymentHistory" runat="server" AccessKey="B" CssClass="button"
                                                                                                    TabIndex="2" Text="Past Payment History" Width="130px" /></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="textbold" style="width: 15%" valign="top">
                                                                                                Payment Type</td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="textbold" style="width: 15%" valign="top">
                                                                                                Minimum Segment</td>
                                                                                            <td style="width: 23%" valign="top">
                                                                                                <asp:TextBox ID="TxtMinSegment" runat="server" CssClass="textboxgrey" MaxLength="50"
                                                                                                    ReadOnly="True" TabIndex="1" Width="181px"></asp:TextBox></td>
                                                                                            <td class="textbold" style="width: 3%">
                                                                                            </td>
                                                                                            <td class="textbold" style="width: 15%" valign="top">
                                                                                            ...
                                                                                            <td align="center" class="textbold" style="width: 21%" valign="top">
                                                                                                <asp:Button ID="BtnSendForApproval" CssClass="button" runat="server" Text="Generate  Payment Advice"
                                                                                                    TabIndex="2" AccessKey="B" Width="164px" /></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="textbold" style="width: 15%" valign="top">
                                                                                                Signup Adjustable</td>
                                                                                            <td style="width: 23%" valign="top">
                                                                                                <asp:TextBox ID="txtSignupAdjustable" runat="server" CssClass="textboxgrey" MaxLength="50"
                                                                                                    ReadOnly="True" TabIndex="1" Width="181px"></asp:TextBox></td>
                                                                                            <td class="textbold" style="width: 3%">
                                                                                            </td>
                                                                                            <td class="textbold" style="width: 15%" valign="top">
                                                                                            ...
                                                                                            <td align="center" class="textbold" style="width: 21%" valign="top">
                                                                                                <asp:Button AccessKey="B" ID="BtnSkipPayment" TabIndex="2" runat="server" CssClass="button"
                                                                                                    Width="164px" Text="Skip Payment"></asp:Button>
                                                                                            </td>
                                                                                        </tr>
                                                            ...
                                                            <td colspan="6" width="100%">
                                                                <asp:GridView ID="GvProcessPayment" runat="server" AutoGenerateColumns="False" TabIndex="1"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Standard Rate / Revised Rate" HeaderStyle-HorizontalAlign="left">
                                                                            <ItemTemplate>
                                                                            ...
                                                                            <ItemStyle HorizontalAlign="Right" Width="210px" Wrap="true" VerticalAlign="top" />
                                                                        </asp:TemplateField>
                                                                ...
                                                                <table width="990px" cellpadding="0" cellspacing="0" border="0">
                                                                    ...
                                                                    <tr id="trLPlb" runat="server" visible="false">
                                                                        ...
                                                                        <td width="100px">
                                                                            <asp:TextBox ID="txtPLBAmt" ReadOnly="false" runat="server" MaxLength="12" CssClass="textboxbold right"
                                                                                AutoPostBack="False" Width="94%" TabIndex="1" Visible="False" OnTextChanged="txtPLBAmt_TextChanged"></asp:TextBox>
                                                                        </td>
                                                                        <td width="130px">
                                                                            &nbsp;
                                                                        </td>
                                                                    ...
                                                                    <tr runat="server" id="trCBFAmount">
                                                                        ...
                                                                        <td colspan="3" width="300px" class="Gridheading">
                                                                            <asp:Label ID="LblCBFAmount" runat="server" Text="Carries Balance Amount" Visible="False"></asp:Label></td>
                                                                        <td width="100px">
                                                                            <asp:TextBox ID="txtCBForwardAmount" runat="server" CssClass="textboxgrey right"
                                                                                MaxLength="12" ReadOnly="true" TabIndex="1" Visible="False" Width="96%"></asp:TextBox></td>
                                                                        <td width="130px">
                                                                            &nbsp;
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr id="trBalanceUpfrontAmount" runat="server">
                                                                        ...
                                                                        <td width="300px" colspan="3" class="Gridheading">
                                                                            <asp:Label ID="lblBalanceUpfrontAmount" Text="Balance Amount" runat="server" Visible="False"></asp:Label>
                                                                        </td>
                                                                        <td width="100px">
                                                                            <asp:TextBox ID="txtBalanceUpfrontAmount" ReadOnly="true" runat="server" MaxLength="12"
                                                                                CssClass="textboxgrey right" Width="96%" TabIndex="1" Visible="False"></asp:TextBox>
                                                                        </td>
                                                                        <td width="130px">
                                                                            &nbsp;
                                                                        </td>
                                                        ...
                                                        <tr>
                                                            <td colspan="6">
                                                                <input id="hdEnChainCode" runat="server" style="width: 21px" type="hidden" />
                                                                <input id="hdChainCode" runat="server" style="width: 21px" type="hidden" />
                                                                    ...
                                                                    <div id="divBreakupDetails" runat="server" style="height: 410px; overflow: auto;
                                                                        ...
                                                                        <asp:GridView ID="GvBreakup" runat="server" AutoGenerateColumns="False" TabIndex="1"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Revised Segment" Visible="true">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="LblSeg" runat="server" Text='<%# Eval("SEGMENT") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                    <ItemStyle HorizontalAlign="center" Width="120px" />
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="Standard Rate" Visible="true">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="LblStdRate" runat="server" Text='<%# Eval("STANDARDRATE") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                    <ItemStyle HorizontalAlign="center" Width="120px" />
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="Revised Rate" Visible="true">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="LblRate" runat="server" Text='<%# Eval("RATE") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                    <ItemStyle HorizontalAlign="center" Width="120px" />
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="Selected In Plan" Visible="true">
                                                                                    <ItemTemplate>
