<%@ Page Language="VB" AutoEventWireup="false" CodeFile="INCHR_ApprovalQueue.aspx.vb" Inherits="Incentive_INCHR_ApprovalQueue" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>AAMS::Incentive::Approval Queue History</title>
                                                            ...
                                                            <tr>
                                                                <td colspan="6" height="4" align="center">
                                                                    <asp:GridView ID="gvEmployeeHistory" runat="server" BorderWidth="1" BorderColor="#d4d0c8" AutoGenerateColumns="False"
                                                                        ...
                                                                        <asp:BoundField   DataField="HISTORY" HeaderText="Change Data" SortExpression="HISTORY" />                                                                                                                                                      
                                                                        </Columns>                                                                                                                                    
