<%@ Page Language="VB" AutoEventWireup="false" CodeFile="INCSR_ApprovalLevel.aspx.vb" Inherits="Incentive_INCSR_ApprovalLevel" %>
...
<head id="Head1" runat="server">
    ...
    function Edit(ID)
			{
				 window.location.href="INCUP_ApprovalLevel.aspx?Action=U&ID=" +ID
				 return false;
			}
	...
	function History(ID)
			{
			 ...
			 type = "../Popup/PUSR_BC_ApprovalLevelHistory.aspx?Action=U&Aoffice=" +ID
			 window.open(type,"BCApprovalLevelHistory","height=600,width=800,top=30,left=20,scrollbars=1,status=1");                  
		    return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Incentive-&gt;</span><span class="sub_menu">Approval BC Level Search</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Search BC Approval Level</td>
                        </tr>
                        <tr>
                            <td valign="top">
