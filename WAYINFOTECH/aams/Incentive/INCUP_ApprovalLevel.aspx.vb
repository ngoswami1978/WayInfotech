...
Partial Class Incentive_INCUP_ApprovalLevel
...
#Region "ViewDetails()"
    Private Sub ViewDetails()
        ...
        Try
            '<UP_VIEW_INC_APPROVAL_OUTPUT><AOFFICE></AOFFICE><LEVEL></LEVEL ><DETAILS EMPLOYEEID='' EMPLOYEENAME='' ALLOWEDFINAL_APPROVAL='' /><Errors Status=''>
            '<Error Code='' Description='' /></Errors></UP_VIEW_INC_APPROVAL_OUTPUT>

            objInputXml.LoadXml("<UP_VIEW_INC_APPROVAL_INPUT><AOFFICE/></UP_VIEW_INC_APPROVAL_INPUT >")
...
#End Region
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            Dim objApprovalQue As New AAMS.bizIncetive.bzApprovalQue
            ' Load Input Xml.
            'objInputXml.LoadXml("<UP_UPDATE_INC_APPROVAL_INPUT><AOFFICE></AOFFICE><LEVELCOUNT></LEVELCOUNT><DETAILS LEVEL='' EMPLOYEEID='' EMPLOYEENAME='' ALLOWEDFINAL_APPROVAL='' /></UP_UPDATE_INC_APPROVAL_INPUT >")
            objInputXml.LoadXml("<UP_UPDATE_INC_APPROVAL_INPUT><AOFFICE></AOFFICE><LEVELCOUNT></LEVELCOUNT><LOGINEMPLOYEEID></LOGINEMPLOYEEID><DETAILS LEVEL='' EMPLOYEEID='' EMPLOYEENAME='' ALLOWEDFINAL_APPROVAL='' /></UP_UPDATE_INC_APPROVAL_INPUT >")
            ...
            '    lblError.Text = "Final Approver can't be selected more than one."
            '    Exit Sub
            'End If
