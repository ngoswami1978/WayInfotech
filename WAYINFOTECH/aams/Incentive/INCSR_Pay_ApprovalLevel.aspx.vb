...
Partial Class Incentive_INCSR_Pay_ApprovalLevel
...
#Region "BindData()"
    Private Sub BindData(ByVal Operation As Integer)
        ...
        Try
            ...
            objInputXml.LoadXml("<UP_SEARCH_INC_PAYMENT_APPROVAL_INPUT>    <AOFFICE/>      <PAGE_NO></PAGE_NO><PAGE_SIZE></PAGE_SIZE><SORT_BY></SORT_BY><DESC></DESC></UP_SEARCH_INC_PAYMENT_APPROVAL_INPUT >")
