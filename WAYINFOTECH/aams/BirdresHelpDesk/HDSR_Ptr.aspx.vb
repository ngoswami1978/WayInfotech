...
Imports System.Xml
Partial Class BirdresHelpDesk_HDSR_Ptr
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Session("PageName") = "BirdresHelpDesk/HDSR_Ptr.aspx"
    ...
    Private Sub BindDropDowns()
        Try
            objEaams.BindDropDown(drp1aOffice, "BRAOFFICE", True, 3)
            objEaams.BindDropDown(drpFollowup, "BRHDFOLLOWUP", True, 3)
            objEaams.BindDropDown(drpPtrStatus, "BRHDPTRCALLSTATUS", True, 3)
            objEaams.BindDropDown(drpPtrTypCat, "BRHDPTRTYPECAT", True, 3)
            objEaams.BindDropDown(drpPtrType, "BRHDPTRTYPE", True, 3)
            objEaams.BindDropDown(drpSeverity, "BRHDPTRSEVERITY", True, 3)
            objEaams.BindDropDown(drpAssignedTo, "BRHDASSIGNEDTO", True, 3)
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
    End Sub
    ...
    Private Sub GetSearchResult()
        ...
        Try
            ...
            End With
            Dim objHdPtrSearch As New AAMS.bizBRHelpDesk.bzPTR
    ...
    Private Sub HDPtrDelelete(ByVal PtrID As String)
        ...
        Try
            Dim objhdPtrDel As New AAMS.bizBRHelpDesk.bzPTR
