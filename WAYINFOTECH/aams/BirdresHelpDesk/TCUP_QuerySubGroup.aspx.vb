...
Partial Class BirdresHelpDesk_Technical_MSUP_QuerySubGroup
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                If Not Request.QueryString("Action") Is Nothing And Not Request.QueryString("GroupID") Is Nothing Then
...
#Region "btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click"
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            ' Load Input Xml.
            objInputXml.LoadXml("<HD_UPDATECALLSUBGROUP_INPUT><CALL_SUB_GROUP CALL_SUB_GROUP_ID='' CALL_SUB_GROUP_NAME='' HD_QUERY_GROUP_ID='2' /></HD_UPDATECALLSUBGROUP_INPUT>")
            If (hdID.Value <> "") Then
