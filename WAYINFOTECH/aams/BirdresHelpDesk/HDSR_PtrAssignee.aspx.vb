...
Imports System.Xml
Partial Class BirdresHelpDesk_HDSR_PtrAssignee
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Session("PageName") = "BirdresHelpDesk/HDSR_PtrAssignee.aspx"
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR PTR Assignee']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR PTR Assignee']").Attributes("Value").Value)
    ...
    Private Sub HDPtrAssignee_Search()
        ...
        Try
            Dim objbzAssignee As New AAMS.bizBRHelpDesk.bzPTRAssignee
    ...
    Private Sub HDPtrAssignee_Del(ByVal AssingeeID As String)
        Dim objInputXml, objOutputXml As New XmlDocument
        Try
            Dim objhdAssignee As New AAMS.bizBRHelpDesk.bzPTRAssignee
