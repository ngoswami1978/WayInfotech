<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_BDRLetter.aspx.vb" Inherits="BirdresHelpDesk_HDSR_BDRLetter" %>
      ...
      <table width="860px" align="left" class="border_rightred" >
            <tr>
                <td valign="top">
                    <table width="100%" >
                        <tr>
                            <td valign="top"  align="left" ><span class="menu">Birdres HelpDesk-></span><span class="sub_menu">BDR Letter</span></td>
                        </tr>
                        <tr>
