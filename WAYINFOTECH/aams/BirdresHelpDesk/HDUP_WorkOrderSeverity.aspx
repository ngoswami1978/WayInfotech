<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_WorkOrderSeverity.aspx.vb" Inherits="BirdresHelpDesk_HDUP_WorkOrderSeverity" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>AAMS::HelpDesk::Manage Order Type</title>
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Birdres HelpDesk-&gt;</span><span class="sub_menu">Manage &nbsp;Work Order Severity</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage Order Severity</td>
                        </tr>
                        <tr>
                            <td valign="top">
     ...
     if(document.getElementById('<%=txtSeverity.ClientId%>').value =='')
        {
            ...
            document.getElementById('<%=txtSeverity.ClientId%>').focus();
            return false;
        }
//        else
//        {
