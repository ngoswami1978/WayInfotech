<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_helpDeskFeedBack.aspx.vb" Inherits="BirdresHelpDesk_HDUP_helpDeskFeedBack" %>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="top left" style="width:80%">
                                            <span class="menu">Birdres HelpDesk-> FeedBack</span></td>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="top" style="height: 10px">
                                            <asp:Repeater ID="theTabStrip" runat="server" Visible="false">
                                                <ItemTemplate>
                                                                    ...
                                                                    <table width="100%" border="0" class="left" cellpadding="2" cellspacing="1">
                                                                        ...
                                                                        <tr runat="server" id="trHelpDeskHelpDeskAction1">
                                                                            ...
                                                                            <td class="textbold top" colspan="2">
                                                                                <asp:TextBox ID="txtHelpDeskAction" runat="server" Height="70px" TextMode="MultiLine" Width="525px" onkeyup="checkMaxLength(this.id,'1000')"></asp:TextBox></td>
                                                                            <td class="top">
                                                                        ...
                                                                        <tr id="trTechnicalHelpDeskAction1" runat="server">
                                                                            ...
                                                                            <td class="textbold top" colspan="2">
                                                                                <asp:TextBox ID="txtTechnicalHelpDeskAction" runat="server" Height="70px" TextMode="MultiLine" Width="525px" onkeyup="checkMaxLength(this.id,'1000')"></asp:TextBox></td>
                                                                            <td class="top">
                                                                        ...
                                                                        <tr id="trSalesHelpDeskAction1" runat="server">
                                                                            ...
                                                                            <td class="textbold top" colspan="2">
                                                                                <asp:TextBox ID="txtSalesHelpDeskAction" runat="server" Height="70px" TextMode="MultiLine" Width="525px" onkeyup="checkMaxLength(this.id,'1000')"></asp:TextBox></td>
                                                                            <td class="top">
                                                                        ...
                                                                        <tr id="trTrainingHelpDeskAction1" runat="server">
                                                                            ...
                                                                            <td class="textbold top" colspan="2">
                                                                                <asp:TextBox ID="txtTrainingHelpDeskAction" runat="server" Height="70px" TextMode="MultiLine" Width="525px" onkeyup="checkMaxLength(this.id,'1000')"></asp:TextBox></td>
                                                                            <td class="top">
                                                                ...
                                                                <tr id="trProductHelpDeskAction" runat="server">
                                                                    ...
                                                                    <td class="textbold">
                                                                        ...
                                                                        <tr id="trProductHelpDeskAction1" runat="server">
                                                                            ...
                                                                            <td class="textbold top" colspan="2">
                                                                                <asp:TextBox ID="txtProductHelpDeskAction" runat="server" Height="70px" TextMode="MultiLine" Width="525px" onkeyup="checkMaxLength(this.id,'1000')"></asp:TextBox></td>
                                                                            <td class="top">
