<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TCSR_Priority.aspx.vb" Inherits="BirdresHelpDesk_Technical_MSSR_Priority" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
   <title>AAMS::Technical::Search Priority</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(PriorityID)
			{
				 window.location.href="TCUP_Priority.aspx?Action=U&PriorityID=" +PriorityID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Birdres Technical-&gt;</span><span class="sub_menu">Priority Search</span></td>
                        </tr>
                        <tr>
