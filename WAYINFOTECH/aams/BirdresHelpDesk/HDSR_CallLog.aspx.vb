...
Partial Class BirdresHelpDesk_HDSR_CallLog
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                btnSearch.Attributes.Add("onClick", "return ValidateFormBRCallLog();")
                ...
                objeAAMS.BindDropDown(ddlCity, "BRCITY", True, 3)
                objeAAMS.BindDropDown(ddlRegion, "BRREGION", True, 3)
                loadGroup()
                loadSubGroup()
                loadCategory()
                loadSubCategory()
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Response.Redirect("HDSR_CallLog.aspx")
    End Sub
    ...
    Sub SearchRecords(ByVal Operation As Integer)
        Try
            ...
            "<Region /><IsPending /><LTRs /><ASSIGNEDTO /><CONTACT_TYPE_ID/><PAGE_NO/> <PAGE_SIZE/><SORT_BY/><DESC/><TITLE/></HD_SEARCH_CALLREQUEST_INPUT>")
...
#End Region
    ...
    Sub Export(ByVal objOutputXml As XmlDocument)
        ...
        Dim strArray() As String = {"LTR No", "OfficeID", "Agency Name", "Opened Date", "Closed Date", "Call Logged By", "Call Closed By", "Query Group", "Status", "ReptCalls", "Linked LTR", "AOffice"}
        Dim intArray() As Integer = {0, 2, 3, 4, 10, 5, 9, 6, 7, 11, 12, 13}
