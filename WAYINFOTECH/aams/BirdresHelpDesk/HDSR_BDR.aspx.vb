...
Imports System.Data
#End Region
Partial Class BirdresHelpDesk_HDSR_BDR
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                objeAAMS.BindDropDown(drpReqType, "BRListFuntionalCategory", True, 3)
...
#Region "Method for search Bdr"
    Private Sub BdrSearch()
        ...
        Try
            ...
            Dim objbzRequestBDR As New AAMS.bizBRHelpDesk.bzRequestBDR
...
#Region " Sub Procedure Called for deletion of RequestType"
    Sub BdrDelete(ByVal strBdrId As String)
        Try
            Dim objInputXml, objOutputXml As New XmlDocument
            Dim objbbzRequestBDR As New AAMS.bizBRHelpDesk.bzRequestBDR
...
#Region "gvBdr_RowDataBound Event fired on every row creation in  gridview"
    Protected Sub gvBdr_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvBdr.RowDataBound
        Try
            ...
            EnstrQueryStringForHDREBDRID = objED.Encrypt(hdstrHDHDREBDRID.Value)
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR BDRLetter']").Count <> 0 Then
                    ...
                    'End If
                    linkEdit.Attributes.Add("onclick", "return EditFunction('" & EnstrQueryStringForHDREBDRID & "');")
                Else
                    linkEdit.Attributes.Add("onclick", "return EditFunction('" & EnstrQueryStringForHDREBDRID & "');")
                End If
            Else
