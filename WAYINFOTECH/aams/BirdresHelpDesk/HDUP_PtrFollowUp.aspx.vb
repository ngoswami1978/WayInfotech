...
Imports System.Xml
Partial Class BirdresHelpDesk_HDUP_PtrFollowUp
        ...
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR PTR Followup']").Count <> 0 Then
                    strBuilder = eaamsObj.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR PTR Followup']").Attributes("Value").Value)
    ...
    Private Sub ViewFollowUp()
        Try
            ...
            Dim objhFollowup As New AAMS.bizBRHelpDesk.bzPTRFollowUp
