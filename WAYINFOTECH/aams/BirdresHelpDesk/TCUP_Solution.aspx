<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TCUP_Solution.aspx.vb" Inherits="BirdresHelpDesk_HDUP_Solution" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>AAMS::Technical::Solution</title>
                        ...
                        <tr>
                            <td class="top">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="top left">
                                            <span class="menu">Birdres Technical-></span><span class="sub_menu">Solution</span></td>
                                    </tr>
                                    <tr>
