...
Imports System.IO
Imports Excel
Partial Class BirdresHelpDesk_HDRPT_Feedback
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR FeedBackGraph']").Count <> 0 Then
                    strBuilder = objEaams.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR FeedBackGraph']").Attributes("Value").Value)
    ...
    Private Sub FeedbakReport()
        ...
        Try
            objInputXml.LoadXml("<HD_RPTFEEDBACK_INPUT><MONTH></MONTH><YEAR></YEAR><EmployeeID /> <LIMITED_TO_OWNAAGENCY></LIMITED_TO_OWNAAGENCY> <LIMITED_TO_AOFFICE></LIMITED_TO_AOFFICE> <LIMITED_TO_REGION></LIMITED_TO_REGION></HD_RPTFEEDBACK_INPUT>")
            ...
            Session("eBRFeedback") = objInputXml.OuterXml
            Response.Redirect("../RPSR_ReportShow.aspx?Case=BRFeedback&Action=" + drpRptType.SelectedValue.Trim, False)
        Catch ex As Exception
            lblError.Text = ex.Message.ToString
        Finally
            objInputXml = Nothing
