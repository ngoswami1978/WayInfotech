...
Imports System.Xml
Partial Class BirdresHelpDesk_HDUP_PtrSeverity
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR PTR Severity']").Count <> 0 Then
                    strBuilder = eaamsObj.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR PTR Severity']").Attributes("Value").Value)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim objtPtrSeverityId As New AAMS.bizBRHelpDesk.bzPTRSeverity
        ...
        Try
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                Else
                    lblError.Text = objeAAMSMessage.messInsert
                    Response.Redirect("HDUP_PTRSeverity.aspx?Action=US&PTRSeverityID=" + objED.Encrypt(CheckBoxOb))
    ...
    Private Sub ViewPTRSeverity()
        Try
            ...
            Dim objbzPTRSeverity As New AAMS.bizBRHelpDesk.bzPTRSeverity
