<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_PtrSeverity.aspx.vb" Inherits="BirdresHelpDesk_HDSR_PtrSeverity" %>
...
<script language="javascript" type="text/javascript">
    ...
    {  
        window.location.href="HDUP_PTRSeverity.aspx?Action=I";      
        return false;
    }  
      function EditFunction(PTRSeverityID)
    {    
        window.location.href="HDUP_PTRSeverity.aspx?Action=U&PTRSeverityID="+PTRSeverityID;      
        return false;
     }
                        ...
                        <table width="100%" align="left">
                            <tr>
                                <td valign="top" align="left">
                                    <span class="menu">Birdres HelpDesk-><span class="sub_menu">PTR Severity</span><span style="font-size: 12pt"><span
