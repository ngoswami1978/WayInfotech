...
Partial Class BirdresHelpDesk_MSUP_QueryCategory
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                objeAAMS.BindDropDown(drpSubGroup, "BRQuerySubGroup", True, 1)
                If Request.QueryString("Action") IsNot Nothing And Request.QueryString("QueryCategoryID") IsNot Nothing Then
...
#Region "btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click"
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            ' Load Input Xml.
            objInputXml.LoadXml("<HD_UPDATECALLCATEGORY_INPUT><CALL_CATEGORY CALL_CATEGORY_ID='' CALL_CATEGORY_NAME='' CALL_SUB_GROUP_ID='' HD_QUERY_GROUP_ID='1' /></HD_UPDATECALLCATEGORY_INPUT>")
...
#Region "btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click"
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Try
            Response.Redirect("HDUP_QueryCategory.aspx?Action=I")
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
    End Sub
    ...
    Private Sub CheckSecurity()
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR Call Query Category']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR Call Query Category']").Attributes("Value").Value)
                End If
