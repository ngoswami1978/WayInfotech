<%@ Page Language="VB" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="HDSR_BDR.aspx.vb" Inherits="BirdresHelpDesk_HDSR_BDR" %>
  ...
  function EmployeePage()
{
     ...
     function  NewHDUPBDR()
       {    
           window.location="HDUP_BDR.aspx?Action=I";
           return false;
       }  
    function  BDRReset()
    {       
...
//        }
    ...
    {                
          window.location ="HDUP_BDR.aspx?Action=U&HD_RE_BDR_ID=" + CheckBoxObj; 
          return false;
    } 
    ...
    { 
        //alert("abhi");
         ...
         var type="../Popup/PUSR_BDRHistory.aspx?BDRId=" + BDRValue; 
...
<body>
    <form id="form1" runat="server" defaultbutton ="btnSearch" defaultfocus ="txtAgencyName">
      <table style="width:840px" align="left" class="border_rightred" >
            <tr>
                        ...
                        <tr>
                            <td valign="top" align="LEFT">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td  align ="left" class="redborder" style="width:840px" >                                 
...
<input type="hidden" id="hdEmployeePageName" style="width:1px" runat='server' />
            ...
            <table width="1200px" border="0" cellspacing="0" cellpadding="0" align="left" > 
                                                          <tr>
                                                              <td style="width: 1200px;" class="redborder" valign="top">
                                                                  <asp:GridView ID="gvBdr" runat="server" AutoGenerateColumns="False" TabIndex="18"
                                                                      Width="1200px" EnableViewState="False" RowStyle-VerticalAlign="Top" AllowSorting="true"
                                                                      HeaderStyle-ForeColor="white">
                                                                      <Columns>
                                                                          <asp:TemplateField HeaderText="LTR No" HeaderStyle-Wrap="false" ItemStyle-Wrap="false"
                                                                              SortExpression="LTRNO">
                                                                              <ItemTemplate>
                                                                                  <%#Eval("LTRNO")%>
                                                                          ...
                                                                          <asp:BoundField DataField="AGENCYNAME" HeaderText="Agency Name" HeaderStyle-Wrap="false"
                                                                              ItemStyle-Width="100px" SortExpression="AGENCYNAME" />
                                                                          <asp:BoundField DataField="ADDRESS" HeaderText="Agency Address" HeaderStyle-Wrap="false"
                                                                              SortExpression="ADDRESS" />
                                                                          <asp:BoundField DataField="QUERYTYPE" HeaderText="Requested Type" HeaderStyle-Wrap="false"
                                                                              SortExpression="QUERYTYPE">
                                                                              <ItemStyle Wrap="False" />
                                                                          </asp:BoundField>
                                                                          <asp:BoundField DataField="HD_RE_BDR_TICKETS" HeaderText="BDR Tickets" HeaderStyle-Wrap="false"
                                                                              SortExpression="HD_RE_BDR_TICKETS">
                                                                              <ItemStyle Wrap="False" />
                                                                              <HeaderStyle Wrap="False" />
                                                                          </asp:BoundField>
                                                                          <asp:BoundField DataField="HD_RE_BDR_DATESEND" HeaderText="Date Sent" HeaderStyle-Wrap="false"
                                                                              SortExpression="HD_RE_BDR_DATESEND">
                                                                              <ItemStyle Wrap="False" />
                                                                              <HeaderStyle Wrap="False" />
                                                                          </asp:BoundField>
                                                                          ...
                                                                          <asp:BoundField DataField="AIRLINEOFFICEADDRESS" HeaderText="Airline Aoffice Address"
                                                                              SortExpression="AIRLINEOFFICEADDRESS" />
                                                                          ...
                                                                          <asp:TemplateField>
                                                                              ...
                                                                              <ItemTemplate>
                                                                                  <asp:LinkButton ID="lnkSelect" CssClass="LinkButtons" Text="Select" runat="server"
                                                                                      CommandName="SelectX" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "HD_RE_BDR_ID") %>'></asp:LinkButton>&nbsp;&nbsp;<a
                                                                                          href="#" class="LinkButtons" id="linkEdit" runat="server">Edit</a>&nbsp;&nbsp;<asp:LinkButton
                                                                                              ID="btnDelete" runat="server" CommandName="DeleteX" Text="Delete" CssClass="LinkButtons"></asp:LinkButton>
