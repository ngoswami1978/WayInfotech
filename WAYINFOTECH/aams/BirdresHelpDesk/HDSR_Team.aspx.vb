...
Partial Class BirdresHelpDesk_MSSR_Team
    ...
    Protected Sub gvTeam_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvTeam.RowDataBound
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR Team']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR Team']").Attributes("Value").Value)
                End If
...
#Region "BindData()"
    Private Sub BindData(ByVal Operation As Integer)
        ...
        Dim objTeam As New AAMS.bizBRHelpDesk.bzTeam
        Try
