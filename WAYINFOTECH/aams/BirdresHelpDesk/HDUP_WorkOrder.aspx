<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_WorkOrder.aspx.vb"
    Inherits="BirdresHelpDesk_HDUP_WorkOrder" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AAMS::HelpDesk::Manage Work Order</title>
...
//  var hdPtrsID=document.getElementById("hdOrderID").value.trim();
   ...
   var type="../BirdresHelpDeskPopup/PUSR_AssigneeHistory.aspx?WO_Number="+hdPtrsID
  ...
  var ptrsID=document.getElementById("hdHistoryOrderID").value.trim();
   ...
   var type="../BirdresHelpDeskPopup/PUSR_EmployeeHistory.aspx?WO_Number="+ptrsID
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">Birdres HelpDesk-&gt;</span><span class="sub_menu">Manage Work Order</span></td>
                            <td class="right">
                                            ...
                                            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3" style="height: 25px">
                                                        <asp:TextBox ID="txtAgencyName" CssClass="textboxgrey" MaxLength="50" runat="server"
                                                            Width="464px" ReadOnly="True" TabIndex="20"></asp:TextBox>
                                                    </td>
                                                    <td style="height: 25px">
                                                        &nbsp;
                                                        <asp:Button ID="btnSave" runat="server" CssClass="button" TabIndex="4" Text="Save"
                                                            Width="106px" AccessKey="s" /></td>
                                                </tr>
                                                <tr>
                                                    <td class="textbold" style="width: 40px; height: 25px">
                                                    </td>
                                                    ...
                                                    <td colspan="3" rowspan="2" valign="middle">
                                                        <asp:TextBox ID="txtAddress" runat="server" CssClass="textboxgrey" Height="37px"
                                                            MaxLength="300" ReadOnly="True" TextMode="MultiLine" Width="464px" TabIndex="20"></asp:TextBox><br />
                                                    </td>
                                                    <td style="height: 25px">
                                                        &nbsp;
                                                        <asp:Button ID="btnReset" CssClass="button" runat="server" Text="Reset" TabIndex="4"
                                                            Width="106px" AccessKey="r" /></td>
                                                </tr>
                                                <tr>
                                                    <td class="textbold" style="width: 40px; height: 25px">
                                                    </td>
                                                    ...
                                                    <td style="height: 25px">
                                                        &nbsp;
                                                        <asp:Button ID="btnHistory" CssClass="button" runat="server" Text="History" TabIndex="4"
                                                            Width="106px" OnClientClick="return ShowWorkOrderHistory();" AccessKey="h" /></td>
                                                </tr>
                                                <tr>
                                                    <td class="textbold" style="width: 40px; height: 25px">
                                                    </td>
                                                    ...
                                                    <td style="height: 25px">
                                                        &nbsp;
                                                        <asp:Button ID="btnAssigneeHistory" CssClass="button" runat="server" Text="Assignee History"
                                                            TabIndex="4" Width="106px" OnClientClick="return ShowAssigneeHis();" /></td>
                                                </tr>
                                                <tr>
                                                    <td class="textbold" style="width: 40px; height: 25px">
                                                    </td>
                                                    <td class="textbold" style="width: 119px; height: 25px">
                                                        Phone</td>
                                                    <td style="width: 214px; height: 25px">
                                                        <asp:TextBox ID="txtPhone" runat="server" CssClass="textboxgrey" MaxLength="40" ReadOnly="True"
                                                            TabIndex="20"></asp:TextBox></td>
                                                    <td class="textbold" style="width: 116px; height: 25px">
                                                        Fax</td>
                                                    <td style="width: 200px; height: 25px">
                                                        <asp:TextBox ID="txtFax" runat="server" CssClass="textboxgrey" MaxLength="40" ReadOnly="True"
                                                            TabIndex="20"></asp:TextBox></td>
                                                    <td style="height: 25px">
                                                        &nbsp;
                                                        <asp:Button ID="btnLTR" CssClass="button" runat="server" Text="LTR" TabIndex="4"
                                                            Width="106px" /></td>
                                                </tr>
                                                <tr>
                                                    <td class="textbold" style="width: 40px; height: 25px">
                                                    ...
                                                    <td class="textbold" style="width: 119px; height: 25px">
                                                        OfficeID</td>
                                                    <td style="width: 214px; height: 25px">
                                                        <asp:TextBox ID="txtOfficeID" runat="server" CssClass="textboxgrey" MaxLength="40"
                                                            ReadOnly="True" TabIndex="20"></asp:TextBox></td>
                                                    <td class="textbold" style="width: 116px; height: 25px">
                                                        Online Status</td>
                                                    <td style="width: 200px; height: 25px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="textbold" style="width: 119px; height: 25px">
                                                        Work Order Number<span class="Mandatory">*</span></td>
                                                    <td style="width: 214px; height: 25px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 13px; width: 214px;">
                                                        <asp:TextBox ID="txtOpenDate" runat="server" CssClass="textboxgrey" MaxLength="40"
                                                    ...
                                                    <td style="height: 13px; width: 200px;">
                                                        <asp:TextBox ID="txtCloseDate" runat="server" CssClass="textboxgrey" MaxLength="40"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 214px; height: 13px">
                                                        <asp:DropDownList ID="drpAssigned" runat="server" CssClass="dropdownlist" TabIndex="3"
                                                            Width="137px" onkeyup="gotop(this.id)">
                                                        </asp:DropDownList>
                                                    </td>
                                                    ...
                                                    <td style="width: 200px; height: 13px">
                                                        <asp:TextBox ID="txtAssignedDate" runat="server" CssClass="textboxgrey" MaxLength="40"
                                                            ReadOnly="True" TabIndex="20"></asp:TextBox>
                                                    </td>
                                                    <td style="height: 13px">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 214px; height: 13px">
                                                        <asp:HiddenField ID="hdAssignedTo" runat="server" />
                                                    </td>
                                                    <td class="textbold" style="width: 116px; height: 13px">
                                                    ...
                                                    <td style="width: 200px; height: 13px">
                                                        <asp:HiddenField ID="hdAssignedDate" runat="server" />
                                                    </td>
                                                    <td style="height: 13px">
