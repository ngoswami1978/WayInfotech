...
Imports System
Imports Excel
Partial Class BirdresHelpDesk_HDRPT_TechnicalReport
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                    If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR Technical Report']").Count <> 0 Then
                        strBuilderTechnical = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR Technical Report']").Attributes("Value").Value)
                    End If
    ...
    Private Sub printTechReport()
        ...
        If Session("LoginSession") IsNot Nothing Then
            ...
            objOutputXml = objbzDMReportConfiguration.TechnicalReport(objInputXml)
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                Session("BRTechReport") = objOutputXml.OuterXml
                Response.Redirect("../RPSR_ReportShow.aspx?Case=BRTechReport", False)
            Else
                lblError.Text = objOutputXml.DocumentElement.SelectSingleNode("Errors/Error").Attributes("Description").Value
            End If
