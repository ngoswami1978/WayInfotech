<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDSR_CallLog.aspx.vb" Inherits="BirdresHelpDesk_HDSR_CallLog"
                            ...
                            <tr>
                                <td class="top">
                                    <table width="100%" class="left">
                                        <tr>
                                            <td>
                                                <span class="menu">Birdres HelpDesk -&gt;</span><span class="sub_menu">Call Log Search</span></td>
                                        </tr>
                                        <tr>
                                                            ...
                                                            <table border="0" cellpadding="2" cellspacing="1" style="width: 100%" class="left">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3">
                                                                        ...
                                                                        <img id="Img2" runat="server" alt="Select & Add Agency Name" onclick="PopupPageBRCallLog(2)"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <img id="img1" runat="server" alt="Select & Add Logged By" onclick="PopupPageBRCallLog(1)"
                                                                            src="../Images/lookup.gif" style="cursor: pointer" /></td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <img id="Img3" runat="server" alt="Select & Add Caller Name" onclick="PopupPageBRCallLog(3);"
                                                                            src="../Images/lookup.gif" style="cursor: pointer" visible="false" /></td>
                                                 ...
                                                 //align          :    "Tl",
                                                  ...
                                                  showsTime      : true
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:CheckBox ID="chkDisplayLastCall" runat="server" CssClass="textbold" onClick="fillDateCallLog(1)"
                                                                            TabIndex="2" /></td>
                                                                    <td class="textbold">
                                                                        Contact Type</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="textbold">
                                                                        <span id="SpnState" runat ="server" visible ="false"  >State</span></td>
                                                                    <td>
                                                                        <asp:DropDownList onkeyup="gotop(this.id)" ID="ddlState" runat="server" CssClass="dropdownlist"
                                                                            Width="176px" TabIndex="2"  style="display :none;" >
                                                                        </asp:DropDownList></td>
                                                                    <td class="textbold">
                                                                    </td>
                                                                    <td>
                ...
                <tr>
                    <td class="redborder">
                        <asp:Button ID="btnSelect" runat="server" CssClass="button bottomMargin displayNone"
                            Text="Select" OnClientClick="return ReturnDataBRCallLog()" Visible="False" />
                        <asp:GridView ID="gvCallLog" runat="server" AutoGenerateColumns="False" TabIndex="6"
                            Width="1150px" EnableViewState="False" AllowSorting="True">
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <input type="checkbox" id="chkAllSelect" name="chkAllSelect" onclick="SelectAllBRCallLog();" />
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:BoundField HeaderText="LTR No" DataField="HD_RE_ID" SortExpression="HD_RE_ID" HeaderStyle-Width="6%">
                                </asp:BoundField>
                                <asp:BoundField HeaderText="OfficeID" DataField="OfficeID" SortExpression="OfficeID" HeaderStyle-Width="7%">
                                         </asp:BoundField>
                                <asp:BoundField HeaderText="Agency Name" DataField="AgencyName" SortExpression="AgencyName" HeaderStyle-Width="15%" ItemStyle-Wrap="true">
                                    
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Opened Date" DataField="HD_RE_OPEN_DATE" SortExpression="HD_RE_OPEN_DATE" HeaderStyle-Width="10%">
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Closed Date" DataField="HD_RE_CLOSED_DATE" SortExpression="HD_RE_CLOSED_DATE" HeaderStyle-Width="10%">
                                
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Call Logged By" DataField="LoggedBy" SortExpression="LoggedBy" HeaderStyle-Width="8%" ItemStyle-Wrap="true">
                                
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Call Closed By" DataField="AssignedTo" SortExpression="AssignedTo" HeaderStyle-Width="8%" ItemStyle-Wrap="true">
                                
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Query Group" DataField="HD_QUERY_GROUP_NAME" SortExpression="HD_QUERY_GROUP_NAME" HeaderStyle-Width="8%" ItemStyle-Wrap="true">
                                  
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Status" DataField="HD_STATUS_NAME" SortExpression="HD_STATUS_NAME" HeaderStyle-Width="8%" ItemStyle-Wrap="true">
                                
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Rept Calls" DataField="RepeatCalls" SortExpression="RepeatCalls" HeaderStyle-Width="5%" />
                                <asp:BoundField HeaderText="Linked LTR" DataField="HD_RE_ID_CHILD" SortExpression="HD_RE_ID_CHILD" HeaderStyle-Width="6%" />
                                 <asp:BoundField HeaderText="AOffice" DataField="AOffice" SortExpression="AOffice" HeaderStyle-Width="6%" />
