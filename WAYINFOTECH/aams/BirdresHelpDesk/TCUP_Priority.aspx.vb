...
Partial Class BirdresHelpDesk_Technical_MSUP_Priority
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                If Not Request.QueryString("Action") Is Nothing And Not Request.QueryString("PriorityID") Is Nothing Then
...
#Region "btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click"
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            ' Load Input Xml.
            objInputXml.LoadXml("<HD_UPDATESEVERITIES_INPUT><SEVERITIES HD_SEVERITY_ID='' HD_SEVERITY_NAME='' HD_QUERY_GROUP_ID='2' COLOR_CODE='' /></HD_UPDATESEVERITIES_INPUT>")
            If (hdID.Value <> "") Then
            ...
            objInputXml.DocumentElement.SelectSingleNode("SEVERITIES").Attributes("COLOR_CODE").Value = hdColor.Value
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                If (Request.QueryString("Action").ToString().ToUpper() = "U" Or hdID.Value <> "") Then
                    ...
                    hdColor.Value = objOutputXml.DocumentElement.SelectSingleNode("SEVERITIES").Attributes("COLOR_CODE").Value.Trim()
...
#Region "btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click"
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Try
            Response.Redirect("TCUP_Priority.aspx?Action=I")
        Catch ex As Exception
            lblError.Text = ex.Message
        End Try
    End Sub
    ...
    Private Sub ViewDetails()
        ...
        Try
            ...
            If objOutputXml.DocumentElement.SelectSingleNode("Errors").Attributes("Status").Value.ToUpper = "FALSE" Then
                ...
                hdColor.Value = objOutputXml.DocumentElement.SelectSingleNode("SEVERITIES").Attributes("COLOR_CODE").Value
                txtColor.Attributes.Add("style", "background-color:" + hdColor.Value)
            Else
                lblError.Text = objOutputXml.DocumentElement.SelectSingleNode("Errors/Error").Attributes("Description").Value
            End If
    ...
    Private Sub CheckSecurity()
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR Tech Query Priority']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR Tech Query Priority']").Attributes("Value").Value)
                End If
