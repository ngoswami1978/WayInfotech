<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_RequestType.aspx.vb" Inherits="BirdresHelpDesk_HDUP_RequestType" %>
      ...
      <table width="860px" align="left" class="border_rightred" >
            <tr>
                <td valign="top">
                    <table width="100%" >
                        <tr>
                            <td valign="top"  align="left" ><span class="menu">Birdres Help Desk-></span><span class="sub_menu">Request Type</span></td>
                        </tr>
                        <tr>
