...
Imports System.Data
#End Region
Partial Class BirdresHelpDesk_HDSR_BDRLetter
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                objeAAMS.BindDropDown(drpReqType, "BRREQUESTTYPE", True)
...
#Region " Sub Procedure Called for deletion of RequestType"
    Sub BdrLetterDelete(ByVal strBdrLetterId As String)
        Try
            'Dim objInputXml, objOutputXml As New XmlDocument
            'Dim objbzbzRequestType As New AAMS.bizBRHelpDesk.bzRequestType
