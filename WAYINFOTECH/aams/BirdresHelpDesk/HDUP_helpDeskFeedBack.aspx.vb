...
Partial Class BirdresHelpDesk_HDUP_helpDeskFeedBack
    ...
    Sub FillDropDownList()
        Try
            ...
            objeAAMS.BindDropDown(ddlHelpDeskAction, "BRFEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlTechnicalHelpDeskAction, "BRFEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlSalesHelpDeskAction, "BRFEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlTrainingHelpDeskAction, "BRFEEDBACKSTATUS", True, 1)
            objeAAMS.BindDropDown(ddlProductHelpDeskAction, "BRFEEDBACKSTATUS", True, 1)
    ...
    Protected Sub theTabStrip_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles theTabStrip.ItemDataBound
        ...
        If Session("Security") IsNot Nothing Then
            ...
            Select Case strButtonText
                Case "Call"
                    If hdPageStatus.Value.ToUpper <> "TECHNICAL" Then
                        If objeAAMS.ReturnViewPermission(Session("Security"), "BR Log HD Call") = "0" Then
