<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TCSR_QueryCategory.aspx.vb" Inherits="BirdresHelpDesk_Technical_MSSR_QueryCategory" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
   <title>AAMS::Technical::Search Query Category</title>
 ...
 <script src="../JavaScript/AAMS.js" type="text/javascript"></script>
    ...
    function Edit(CategoryID)
			{
				 window.location.href="TCUP_QueryCategory.aspx?Action=U&QueryCategoryID=" +CategoryID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Birdres Technical-&gt;</span><span class="sub_menu">Query Category Search</span></td>
                        </tr>
                        <tr>
