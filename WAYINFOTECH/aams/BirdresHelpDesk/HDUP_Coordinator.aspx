<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_Coordinator.aspx.vb" Inherits="BirdresHelpDesk_MSUP_Coordinator" ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title>AAMS::HelpDesk::Manage Coordinator</title>
    ...
    function PopupAgencyPage()
         ...
         if (AofficeVar != "")
         {
            ...
            if (strEmployeePageName!="")
            {
                ...
                {
                    strEmployeePageName="HDSR_Employee.aspx";
                }
                else
                {
                    strEmployeePageName="HDSR_EmployeeR.aspx";
                }
                document.getElementById("hdAOffice").value = AofficeVar
                  type = "../BirdresHelpDesk/" + strEmployeePageName+ "?Popup=T&Aoffice="+AofficeVar ;
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Birdres HelpDesk-&gt;</span><span class="sub_menu">Manage Coordinator</span></td>
                        </tr>
                        <tr>
