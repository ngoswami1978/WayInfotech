...
Partial Class BirdresHelpDesk_HDSR_QuestionSet
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Session("PageName") = "BirdresHelpDesk/HDSR_QuestionSet.aspx"
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR Feedback Questionset']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR Feedback Questionset']").Attributes("Value").Value)
    ...
    Private Sub QuestionSearch()
        ...
        Dim objbzQ As New AAMS.bizBRHelpDesk.bzFeedbackSet
    ...
    Private Sub QuestionDelete(ByVal QID As String)
        Dim objInputXml, objOutputXml As New XmlDocument
        Dim objbzDq As New AAMS.bizBRHelpDesk.bzFeedbackSet
        Try
