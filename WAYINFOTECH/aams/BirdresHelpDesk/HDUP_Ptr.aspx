<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HDUP_Ptr.aspx.vb" Inherits="BirdresHelpDesk_HDUP_Ptr" %>
...
//                    
  ...
  if (hdPtrsID !="")
  {
       ...
       var type="../BirdresHelpDeskPopup/PUSR_PtrAssigneeHistory.aspx?AssigneeID="+hdPtrsID
...
if (ptrsID !="")
  {
       var type="../BirdresHelpDeskPopup/PUSR_PtrHistory.aspx?PTRID="+ptrsID
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td valign="top" align="left">
                                            <span class="menu">Birdres HelpDesk-></span><span class="sub_menu">PTR</span>
                                        </td>
