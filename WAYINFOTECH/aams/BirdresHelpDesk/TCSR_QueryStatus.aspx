<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TCSR_QueryStatus.aspx.vb" Inherits="BirdresHelpDesk_Technical_MSSR_QueryStatus" %>
...
<link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <title>AAMS::Technical::Search Query Status</title>
    <link href="../CSS/AAMS.css" rel="stylesheet" type="text/css" />
    <script language="javascript" type="text/javascript">
    
    function Edit(StatusID)
			{
				 window.location.href="TCUP_QueryStatus.aspx?Action=U&QueryStatusID=" +StatusID
				 return false;
			}
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">Birdres Technical-&gt;</span><span class="sub_menu">Query Status Search</span></td>
                        </tr>
                        <tr>
