...
Partial Class BirdresHelpDesk_Technical_MSUP_QuerySubCategory
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            objInputXml.LoadXml("<HD_UPDATECALLSUBCATEGORY_INPUT><CALL_SUB_CATEGORY CALL_SUB_CATEGORY_ID='' CALL_SUB_CATEGORY_NAME='' CALL_CATEGORY_ID='' /></HD_UPDATECALLSUBCATEGORY_INPUT>")
    ...
    Private Sub CheckSecurity()
        Try
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR Tech Query SubCategory']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR Tech Query SubCategory']").Attributes("Value").Value)
                End If
