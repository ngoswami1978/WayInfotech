...
Imports System.Xml
Partial Class BirdresHelpDesk_HDSR_PtrTypeCategory
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Session("PageName") = "BirdresHelpDesk/HDSR_PtrTypeCategory.aspx"
            ...
            If (objSecurityXml.DocumentElement.SelectSingleNode("Administrator").InnerText = "0") Then
                If objSecurityXml.DocumentElement.SelectNodes("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR PTR Type Category']").Count <> 0 Then
                    strBuilder = objeAAMS.SecurityCheck(objSecurityXml.DocumentElement.SelectSingleNode("SECURITY_OPTIONS/SECURITY_OPTION[@SecurityOptionSubName='BR PTR Type Category']").Attributes("Value").Value)
    ...
    Private Sub HDPtrTypeSearch()
        ...
        Try
            Dim objhdPtrCat As New AAMS.bizBRHelpDesk.bzPTRTypeCategory
