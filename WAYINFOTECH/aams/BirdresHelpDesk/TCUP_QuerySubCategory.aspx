<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TCUP_QuerySubCategory.aspx.vb" Inherits="BirdresHelpDesk_Technical_MSUP_QuerySubCategory" EnableEventValidation="false" %>
            ...
            <tr>
                <td class="top">
                    <table width="100%"  class="left">
                        <tr>
                            <td  >
                            <span class="menu">Birdres Technical-&gt;</span><span class="sub_menu">Query Sub Category </span></td>
                        </tr>
                        <tr>
