<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ISP_OrderSendMail.aspx.vb" Inherits="ISP_ISP_OrderSendMail" %>
       ...
       function PopSendMail()
        {
	     ...
	     // alert(hdFileno);
          ...
          var type;
          type = "../Popup/PUUP_ProductMailSend.aspx?Lcode=" + hdLcode + "&ISPOrderId="  + hdOrderId ;
             
//          if (window.showModalDialog)
//          {
//        //     window.showModalDialog(type,null,'dialogWidth:720px;dialogHeight:535px;status:yes;help:no;'); 
//              window.showModalDialog(type,null,'dialogWidth:785px;dialogHeight:600px;status:yes;help:no;');       
//          }
//          else
//          {
//            // window.open(type,null,'height=545px,width=720px,top=100,left=100,status=1,scrollbars=0'); 
//            window.showModalDialog(type,null,'dialogWidth:785px;dialogHeight:600px;status:yes;help:no;');               
//          }	
...
<body>
    <form id="frmMailingList" runat="server">
            ...
            <tr>
                <td valign="top" style="height: 516px">
                    <table width="100%" align="left">
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td valign="top" align="left">
                                            <span class="menu">ISP-&gt;</span><span class="sub_menu">ISP Order Send Mail</span>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td valign="top" style="height: 435px">
                                                              ...
                                                              <tr> 
                                                                 <td>
                                                                   <table> 
                                                                          ...
                                                                          <tr >
                                                                            ...
                                                                            <td class="textbold"  ></td>
                                                                             ...
                                                                             <td class="textbold"  rowspan ="2">
                                                                              ...
                                                                              <td class="textbold"  ></td>
                                                                              <td class="textbold" valign ="top"  style="height:100%;"> 
                                                                               <table cellpadding ="0" cellspacing ="0" style="height:100%;">
                                                                                  <tr>
                                                                                   <td><asp:Button ID="btnRemove_Click" CssClass="button" runat="server" Text="Remove" Width="98px" TabIndex="3" /></td>
                                                                                  </tr>
                                                                                     <tr>
                                                                                   <td valign ="bottom" ></td>
                                                                                  </tr>
                                                                        ...
                                                                        <tr >
                                                                           <td colspan ="3"></td> <td></td> <td colspan ="3" valign ="bottom"> <input type="button" class="button"  tabindex="8"  value="Send Mail" onclick="javascript:PopSendMail();" style="width:98px" id="btnSendMail" runat="server"  size="" /></td>
                                                                        </tr>
                                                                         <tr>
                                                                            <td  class="textbold" colspan="6" align="center" valign="TOP" style="height: 7px">   </td><td> </td>
                                                                        </tr>
                                                                         <tr>                                                              
