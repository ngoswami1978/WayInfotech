<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ISPUP_POP.aspx.vb" Inherits="ISP_ISPUP_POP" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
<title>AAMS::Search Pop</title>
...
<body   >
    <form id="frmPopup" runat="server"  defaultfocus="txtISPProvider">
                ...
                <td valign="top">
                    <table width="100%" align="left">
                        <tr>
                            ...
                            <span class="menu">ISP-&gt;</span><span class="sub_menu">Manage POP</span></td>
                        </tr>
                        <tr>
                                            ...
                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="textbold" style="width: 100px">
                                                                                PoP Name<span class="Mandatory" >*</span></td>
                                                                            <td style="width: 308px">
                                                                                <asp:TextBox ID="txtISPProvider" runat="server" CssClass="textbold" MaxLength="100"
