<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ISPUP_OrderStatus.aspx.vb" Inherits="ISP_ISPUP_OrderStatus" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
     ...
     function InsertISPOrderStatus()
        ...
        {
         if(document.getElementById("txtIspOrderStatusName").value=='')
        {
        document.getElementById("txtIspOrderStatusName").focus();
        document.getElementById("lblError").innerHTML ="Order Status Name is Mandatory";
        return false;
        }
                    ...
                    <table width="100%" align="left">
                        <tr>
                            <td valign="top" align="left">
                                <span class="menu">ISP-&gt;</span><span class="sub_menu">ISP Order Status</span></td>
                        </tr>
                        <tr>
                            <td class="heading" align="center" valign="top">
                                Manage ISP Order Status</td>
                        </tr>
                        <tr>
                                                        ...
                                                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 22px; width: 149px;" class="textbold" nowrap="nowrap" >
                                                                    ISP Order Status Name<span class="Mandatory">* </span>
                                                                </td>
                                                                <td height="22px" style="width: 195px" class="textbold" nowrap="nowrap" >
                                                                    &nbsp;<asp:TextBox ID="txtIspOrderStatusName" runat="server" CssClass="textbold" TabIndex="1" MaxLength="25" Width="176px" ></asp:TextBox>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="textbold" >
                                                                    <asp:RadioButtonList ID="rdBtnAppCanc" runat="server" RepeatDirection="Horizontal">
