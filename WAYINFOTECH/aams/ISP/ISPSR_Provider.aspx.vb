...
Partial Class ISP_ISP_Provider
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            objInputXml.LoadXml("<IS_SEARCHPROVIDER_INPUT><ProviderName/><Reserved/><PAGE_NO/><PAGE_SIZE/>	<SORT_BY/><DESC/></IS_SEARCHPROVIDER_INPUT>")
            objInputXml.DocumentElement.SelectSingleNode("ProviderName").InnerText = txtISPProvider.Text

            '</Reserved>
            If chkReserved.Checked = True Then
                objInputXml.DocumentElement.SelectSingleNode("Reserved").InnerText = "TRUE"
            Else
                objInputXml.DocumentElement.SelectSingleNode("Reserved").InnerText = "FALSE"
            End If
